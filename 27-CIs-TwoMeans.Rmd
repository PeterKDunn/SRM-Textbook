...
> The difference between the mean *reductions* in TG is $45.74$\ mg.dl^$-1$^, greater for the tea-drinking group, with the approximate $95$%\ CI from $28.64$ to $62.84$\ mg.dl^$-1$^.
...
[*Dataset*: `Dental`]
@data:woodward:dental recorded the sugar consumption in industrialised countries (mean: $41.8$\ kg/person/year) and non-industrialised countries (mean: $24.6$\ kg/person/year).
