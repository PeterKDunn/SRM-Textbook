...
```{r TurbinesOutputCI, echo=FALSE, fig.show="hold", fig.cap="jamovi output for the turbine data: output", fig.align="center", out.width="50%"}
knitr::include_graphics( "jamovi/Turbines/TurbinesCI-jamovi.png" )
```

```{r TurbinesOutputExpected, echo=FALSE, fig.show="hold", fig.cap="jamovi output for the turbine data: expected counts", fig.align="center", out.width="45%"}
