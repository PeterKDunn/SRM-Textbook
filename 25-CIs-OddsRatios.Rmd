...
```{r EatingGraphs, fig.cap="A plot of the uni-student eating data: A side-by-side bar chart", fig.align="center", fig.height=4, fig.width=7.7, out.width="80%"}
par( xpd = TRUE,
...
```{r UniMealsTestOutputjamovi, fig.show="hold", fig.cap="The jamovi output (left) and SPSS output (right) for computing a CI", fig.align="center", out.width="49%"}
...
```{r PetBirdsCIjamovi, fig.show="hold", fig.cap="jamovi output (left) and SPSS output (right) for the pet-birds data", fig.align="center", out.width="49%"}
...
```{r B12SPSSOutputCIjamovi, fig.show="hold", fig.cap="jamovi output (left) and SPSS output (right) for the B12 data", fig.align="center", out.width="55%"}
...
```{r EarInfPSSOutputCI, fig.show="hold", fig.cap="SPSS output for the ear-infection data", fig.align="center", out.width="60%"}
...
```{r SunglassesSPSSOutputCI, fig.show="hold", fig.cap="SPSS output for the hats data", fig.align="center", out.width="60%"}
