...
As noted, we rely on software to find the CI for the odds ratio, such as jamovi (Fig.&nbsp;\@ref(fig:UniMealsTestOutputjamovi)) and the *second table* of the SPSS output (labelled, obscurely, **Risk Estimate**; Fig.&nbsp;\@ref(fig:UniMealsTestOutputSPSS)).
