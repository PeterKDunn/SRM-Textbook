...
"There are various biotic factors affecting the hatching success of loggerhead sea turtles (Caretta caretta) nesting on Mediterranean beaches. Eggs contaminated by fungi and bacteria are adversely affected in terms of hatching success. This study aims to identify Fusarium species that cause infection by sampling eggs and nest sands that failed to hatch during the 2015–2016 nesting season. 

A sand sample was taken using gloves from the base of the nest opened by an adult female before the laying egg. Sand samples were taken into sterile containers. The samples were brought to the laboratory with a cold transport chain as soon as possible. Sampled nests having a risk of tidal inundation were relocated to safe areas. This way, a comparison can be made between the relocated and non-relocated nests."
