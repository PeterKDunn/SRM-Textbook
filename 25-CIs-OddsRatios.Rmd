...
* Odds are Row 1 divided by Row 2; then odds ratio is computed as Column 1 odds divided by Columns 2 odds (i.e., *comparing* Column 1 odds to Column 2 odds); or
* Odds are Column 1 divided by Column 2; then the odds ratio is computed as Row 1 odds divided by Row 2 odds (i.e., *comparing* Row 1 odds to Row 2 odds).
