...
The two-tailed $P$-value for the test is less than $0.001$, so *very strong evidence* exists to support $H_1$ (that the correlation in the population is not zero).
We write:
