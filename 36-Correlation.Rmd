...
```{r NHANESBPPlot, echo=FALSE, fig.cap="Two scatterplot from the NHANES data: diastolic blood pressure against age (left panel); of the systolic blood pressure against age (right panel)", fig.align="center", fig.width=8, fig.height=3.5, out.width='90%'}
par(mfrow = c(1, 2))
