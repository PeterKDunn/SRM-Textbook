...
```{r NHANESBPdiaPlot, fig.cap="A scatterplot of the diastolic blood pressure against age for the NHANES data", fig.align="center", fig.width=5, fig.height=3.5}
...
```{r NHANESBPPlot, fig.cap="Two scatterplots from the NHANES data: diastolic blood pressure against age (left panel); of the systolic blood pressure against age (right panel)", fig.align="center", fig.width=8, fig.height=3.5, out.width='90%'}
par(mfrow = c(1, 2))
...
`
the relationship is approximately linear, and the jamovi output (Fig. \@ref(fig:RedDeerCorrelationjamovi)) and SPSS output (Fig. \@ref(fig:RedDeerCorrelationSPSS)) show that $r = -0.584$.
...
```{r RedDeerCorrelationjamovi, fig.cap="jamovi correlation output for the red deer data", fig.align="center", out.width="45%"}
knitr::include_graphics("jamovi/RedDeer/RedDeer-Correlation.png")
```


```{r RedDeerCorrelationSPSS, fig.cap="SPSS correlation output for the red deer data", fig.align="center", out.width="75%"}
...
```{r LimeScatter, fig.cap="Foliage biomass plotted against diameter for small-leaved lime trees", fig.align="center", fig.width=5, fig.height=3.5}
...
```{r DogsScatter, fig.align = "center", fig.cap = "Scatterplot of the body height vs body length for Phu Quoc ridgeback dogs", fig.width=5, fig.height=3.5}
...
```{r RemovalEfficiencyjamovi, fig.cap="jamovi output for the removal-efficiency data", fig.align="center", out.width="45%"}
knitr::include_graphics("jamovi/Removal/RemovalCorrelation.png")
```

```{r RemovalEfficiencySPSS, fig.cap="SPSS output for the removal-efficiency data", fig.align="center", out.width="65%"}
...
\centering%
```{r PuntPlotCor2, results='hide', fig.width=4.5, out.width='90%'}
...
```{r SoftdrinkPlots2, fig.cap="The time taken to deliver soft drinks to vending machines", fig.align="center", fig.width=5, fig.height=3.5}
data(sdrink)
...
```{r BitumenPlotCor, fig.cap="Air voids in bitumen samples", fig.align="center", fig.width=5, fig.height=3.5}
...
- Sect. \ref{thinkBox:MeaningOfR2}: $R^2 = (0.532)^2 = 0.283$: about 28.3% of the variation in systolic BP is due to age; extraneous variable (weight, gender, amount of exercise, genetics, etc.) explain the remaining 71.7% of the variation in SBP values.
