...
Software\index{Software output!comparing two odds}\index{Confidence intervals!odds ratio} (Fig.\ \@ref(fig:EatingGraphsCI), right panel) gives the sample OR as $5.94$, and the (exact) $95$%\ CI is from $1.35$ to $26.1$.
