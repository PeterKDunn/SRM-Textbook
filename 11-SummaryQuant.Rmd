...
(ref:CherryRipeHist) Left: the histogram of direct HDL cholesterol concentration from the NHANES study (large outliers exist but are hard to see, as the sample size is very large). Right: the weights of `Fun Size' *Cherry Ripe* chocolate bars.
