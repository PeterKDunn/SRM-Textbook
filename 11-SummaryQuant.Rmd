...
* within each stem, the observations are *ordered* so patterns in the data can be seen.
...
[*Dataset*: `NHANES`]
The histogram of the direct HDL cholesterol concentration from the American National Health and Nutrition Examination Survey (<span style="font-variant:small-caps;">bhadp</span>) [@data:NHANES:Rpackage] from $1999$--$2004$ is shown in Fig.\ \@ref(fig:NHANESCherryRipeHist) (left panel).
...
(ref:CherryRipeHist) Left: the histogram of direct HDL cholesterol concentration from the <span style="font-variant:small-caps;">bhadp</span> study (large outliers exist but are hard to see, as the sample size is very large). Right: the weights of `Fun Size' *Cherry Ripe* chocolate bars.
