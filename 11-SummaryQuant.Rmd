...
### This next line is just to flag the datafile when the data file chapter is made:
data(faithful)
```
...
@wright2021chest recorded the chest-beating rate by gorillas.
The stemplot 
`r if (knitr::is_latex_output()) {
...
* *Left* (or *negatively*) skewed: most data are larger, with some smaller values.\index{Shape!left skewed}\index{Shape!negatively skewed}
