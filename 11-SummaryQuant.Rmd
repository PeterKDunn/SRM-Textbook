...
4. Any *outliers* (unusually large or small observations) or unusual features.\index{Quantitative data!outliers}
...
The streamflow data are *very* highly right skewed, which is important for choosin between the mean and the median:
...
*The median is the better measure of average for these data*, though these data may be better described using percentiles (Sect.\ \@ref(VariationPercentiles))
...
However, the mean is not always appropriate; the median *is not* influenced by outliers\index{Outliers} and skewness.
...
The sample standard deviation is usually calculated using software (such as jamovi)\index{jamovi output!quantitative data} for large amounts of data, or a calculator (in *Statistics Mode*) for small amounts of data.
...
The bat data given in Table\ \@ref(tab:BatData)) has $n = 11$.
The smaller and larger halves of the data, *without* the median of $45$, are:

* Smaller half:\ \ $23$\ \ $27$\ \ $34$\ \ $40$\ \ $42$ 
* Larger half:\ \ \ $52$\ \ $56$\ \ $62$\ \ $68$\ \ $83$ 

The median of the smaller half is $Q_1 = 34$; the median of the larger half is $Q_3 = 62$.
