...
Thus, the sample median, an estimate of the *population* median\index{Median!population}, is between\ $1.7$ (ordered observation\ $7$) and\ $1.7$ (ordered observation\ $8$).
