...
A dot chart of the daily streamflow (Fig.\ \@ref(fig:DailyStreamflow); jittering)\index{Overplotting!jittering} shows that the data are *very* highly right-skewed, with many *very* large outliers\index{Outliers} (presumably during flood events); the extreme outliers are seen in the frequency table too (Table\ \@ref(tab:DailyStreamflowTab)).
...
The streamflow data are *very* highly right skewed, which is important:
