...
* The second quartile $Q_2$ is a value separating the smallest\ $50$% of observations from the largest\ $50$%.
  (This is the also the *median*.)\index{Median}
...
*  $Q_2$, the *second quartile* or *median*, is\ $1.7$.
   $50$% of observations are smaller than\ $1.7$.
...
When $n$\ is odd, the median *may* or *may not* be included in each of these halveswhen computing $Q_1$ and\ $Q_3$; we decide *not* to include the median in each half.
