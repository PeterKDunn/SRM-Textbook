...
Often, discrete data with very few recorded values are better displayed using the graphs designed for qualitative data (Sect.\ \@ref(QualitativeGraphs)).
...
Notice that the different bins change the appearance of the distribution.
:::
...
```{r BBHistTwo, fig.align="center", fig.width=6.5, fig.height=2.15, out.width='100%', fig.cap="Histograms can be constructed in different ways to manage observations on the boundary of bins. Left: boundary values counted in the higher box. Centre: boundary values counted in the lower box. Right: defining boundaries with one more decimal places than the data may be clearer." }
par( mfrow = c(1, 3))
...
::: {style="display: flex;"}
The Greek letter $\mu$ is pronounced 'mew' (rhymes with 'pew').
