...
The plot looks non-linear for larger gestational ages; $n \ge 25$; variation not constant.
:::
`r if( !includeEvenAnswers) "-->"`
...
**4.** Approx. linear; variation approx. constant; $n \ge 25$: statistically valid.
:::
