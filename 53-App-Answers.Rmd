...
**1.** Amount of DMFT greater in non-industrialised countries, based on upper table having negatiove mean.
...
**6.** $H_0$: $\mu_D - \mu_N = 0$ (*no* diff.\ in the pop.\ mean BHADP scores).
...
**2.** $t = 4.92$; $P < 0.001$; strong evidenc eof relationship.
