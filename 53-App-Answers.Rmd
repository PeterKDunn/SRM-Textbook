...
**1.** Table not shown.
**2.** Graph no shown.
**3.** No evidence ($P = 0.414$) odds/proportions having a smooth scar is different for women and men (chi-square: $0.667$/$z = 0.817$).
**4.** Stat.\ valid.
:::
...
**6.** $0.1331$ to $1.1366$.
**7.** (Not answer.)
**8.** $P = 0.077$; slight evidence of a difference. 
**9.** 
**10.** $42\times 16/115 = 5.84$; yes.
:::
`r if( !includeEvenAnswers) "-->"`
...
**7.** (No answer.)
**8.** Table not shown.
**9.** One option: $H_0$: The pop.\ OR is one; $H_1$: The pop.\ OR not one.
       $\chi^2 = 3.845$; $P = 0.050$; moderate evidence ($P = 0.05$) odds of having no rainfall is different for non-positive SOI Augusts and negative-SOI Augusts (chi-square: $3.845$).
**10.** $54\times 21/114 = 9.94$; yes.
:::
...
**5.** RQ could be worded in terms of odds, odds ratios, proportions or associations.
**6.** $H_0$: $\text{pop.\ odds, veg.} = \text{pop.\ odds non-veg.}$;
       $H_1$:  $\text{pop.\ odds, veg.} \ne \text{pop.\ odds non-veg.}$.
**7.** $\chi^2 = 22.374$, so $z = 4.730$.
**8.** Equivalent to $z = 4.73$; very large; small $P$-value.
**9.** $199\times 139/668 = 41.1$; yes.
:::
`r if( !includeEvenAnswers) "-->"`
...
**3.** $1.08$ to $9.24$.
**4.** $-0.0078$ to $0.3006$.
**5.** The pop.\ OR, comparing the odds of being B12 deficient, for veg. to non-vegs.
**6.**  $\chi^2 = 4.707$; $P = 0.030$
**7.** $z = 2.17$.
**8.** Moderate evidence of difference.
**6.** $34\times 16/124 = 4.39$; *just* less than five; shouldn't be too concerned (it should be noted).
:::
