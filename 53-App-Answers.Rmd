...
<!-- ::: {.answer data-latex=""}
<!-- **Answer to Exercise\ \@ref(exr:RQsOutcomeResponse2).** -->
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:RQsDogs).**
**1.** Correlational.
...
<!-- ::: {.answer data-latex=""} -->
<!-- **Answer to Exercise\ \@ref(exr:RQsTypingCor).** -->
<!-- **1.** Correlational. -->
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:RQsTypesZinc).**
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:RQsComparisonConnectionCaloric).**
...
<!-- ::: {.answer data-latex=""} -->
<!-- **Answer to Exercise\ \@ref(exr:InterventionalRQBetween).** -->
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:UnitsAnalysis2).**
...
## Answers: Types of study designs {#ResearchDesignAnswer}
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:TypesOfDesignsAcuteOtitis).**
...
<!-- ::: {.answer data-latex=""} -->
<!-- **Answer to Exercise\ \@ref(exr:TypesOfDesignsWorms).* -->
<!-- **1.** Between-individuals. -->
<!-- **2.** Relational if the C is between individuals. -->
<!-- **3.** Yes. -->
<!-- **4.** Decision-making. -->
...
<!-- ::: {.answer data-latex=""} -->
<!-- **Answer to Exercise\ \@ref(exr:DesignExpImproveIV} -->
...
<!-- ::: {.answer data-latex=""} -->
<!-- **Answer to Exercise\ \@ref(exr:MeansIndSamplesExercisesCarpalTunnelSyndromeHT).** -->
<!-- No answer (yet). -->
<!-- ::: -->
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:GraphsTypingCor).**
...
::: {.answer data-latex=""}
**Answer to Exercise\ \@ref(exr:ReadExerciseSoftDrinks).**
No answer (yet).
:::
