...
To be a *confounding variable*, the variable should be related to *both* the response *and* explanatory variables.
...
Older children would probably be more likely to be smokers, and would be larger in general: age is a confounding variable.
...
```{r CPalsyPlots, fig.align="center", fig.cap="Some graphs from the cerebral palsy data", fig.width=7, fig.height=2.75, out.width='100%'}
NumP <- 15
Gender <- rep("M", 
              NumP)
