...
::: {.answer data-latex=""}
**Answer to Exercise \@ref(exr:AboutCIsInterpretationKoalas).**
The correct interpretation: If we took many similar samples, about $95$% of these would contain the population proportion

We might also say: There is a $95$% chance that this CI we computed straddles the population proportion.
