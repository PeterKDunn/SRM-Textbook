...
<!-- **5.** $\text{s.e.}(\bar{x}) = 3.08/\sqrt{745} = 0.1128$; CI is $19.8 \pm 0.26$. -->
<!-- **6.** $\text{se}(\bar{x}_Y - \bar{x}_N) = $; $t = 3.90$; very large so $P$ very small.
<!-- ::: -->
...
**3.** Two-sample $t$-test.
**4.** $0.0261$.
**5.** Evidence of a difference in mean birth weight.
**6.** $t = 2.68$; yes, as the given standard errors are rounded.
**7.** Conceptual.
**8.** $\chi^2$.
**9.** Very strong evidence that percentage LBW different between groups.
**10.** Observational, so not cause-and-effect; no confounders noted; very restricted population.
:::
...
**4.** Two-sample $t$-test.
**5.** Yes.
**6.** For *Cx.*, evidence that the mean sizes at the two temperatures were different; for *Ae.*, no evidence that the mean sizes at the two temperatures were different.
**7.** Two-sample $t$-tests.
**8.** Intercept: $-55.40$ to $16.28$; slope: $3.88$ to $59.40$.
**9.** $t = 2.28$; expect small $P$-value; evidence of a linear association.
**10.** Need scatterplot to be sure, but $n > 25$.
**11.** When the predator--size ratio increase by one, predation efficiency increases by $31.64$.
**12.** About $8.7$% of the variation in predation efficient can be explained by the value of the predator--size ratio.
**13.** $r = 0.294$.
:::
...
<!-- **3.** Slope: Each extra $10$\ cm of height associated with $3.6$\ mm greater MMO, on average. -->
<!-- **4.** $\hat{y} = 54.29$. -->
<!-- **5.** Two-sample $t$-test. -->
<!-- **6.** Extremely small. -->
<!-- **7.** Need to see graph; $n > 25$. -->
<!-- **8.** Very strong evidence males have larger mean MMO than females. -->
<!-- **9.** Yes; relationship between height and MMO may be because males are taller on average. -->
<!-- **10.** Population is quite restricted. -->
...
**2.** Experimental.
**3.** Objective measures, no aid with managing placebo effect.
**4.** To ensure the two comparison groups included women of similar age (to help manage confounding).
**5.** No evidence of a difference in mean age.
**6.** Yes.
**7.** To ensure the two comparison groups included women in similar rooms (to help manage confounding).
**8.** Not shown.
**9.** No evidence of a difference in percentage of room with air-con.
**10.** Yes; all expected counts will exceed $5$.
**11.** Paired $t = 8.93$; very small $P$.
**12.** Very strong evidence of a mean increase.
**13.** Paired $t = 5.33$; small $P$.
**14.** Very strong evidence of a mean increase.
**15.** Hawthorne effect.
**16.** $\text{s.e.}( \bar{x}_T - \bar{x}_T) = 4.377976$.
**17.** $-2.16$ to $15.36$\ mins, greater for treatment group.
**18.** $t = 1.51$; one-tailed $P$ not very small; no difference between mean increase in sleep times.
**19.** Yes.
:::
