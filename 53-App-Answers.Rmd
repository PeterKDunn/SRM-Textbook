...
**1.** Crop yield: the response variable.
**2.** Soil quality: possible confounder.
**3.** Certain climate needed to grow wheat; possible confounder?
**4.** Irrelevant.
**5.** Farm size: possible confounder (larger farms may produce better yield, be more difficult to operate as organic?).
**6.** Hours of sunlight: extraneous perhaps?
...
**1.** Age; possible confounder.
**2.** Sex: possible confounder.
**3.** Irrelevant. 
**4.** Health conscious: very likely confounder.
**5.** Children: very likely confounder.
**6.** Health teacher: very likely confounder.

Control: perhaps and and/or sex.
:::
`r if( !includeEvenAnswers) "-->"`
...
Average around $1.5$\ mmol/L.\spacex
Most between $4$ and $3$\ mmol/L.\spacex
...
**2.** Hard to tell: DB: $2$\ cm; DBB: $3$\ cm
**3.** Hard to tell: DB: $2$\ cm; DBB: $3$\ cm. 
:::
...
**4.** $77.4$ to $92.4$\ kg.
**5.** Approx. $95$% confident the *population mean* weight of male American black bears between $77.4$ and $92.4$\ kg.
...
**6.** We *know* $\bar{x} = 1.3649$\ mmol/L.\spacex
...
**4.** Table not shown.
**5.** $-0.25$\ m to $0.13$\ m. 
'The population difference between the mean lengths of female and male gray whales at birth has a $95$% chance of being between $0.13$\ m, longer for male whales to $0.25$\ m longer for female whales.'
**6.** Stat. valid.
:::
...
**5.** From jamovi, *exact* $95$%\ CI: $0.05438$ to $0.11501$ (bottom row).
       Exact $95$%\ CI for the diff. between the mean direct HDL cholesterol concentrations: $0.054$ to $0.115$\ mm\ Hg, higher for non-smokers.
:::
`r if( !includeEvenAnswers) "-->"`
...
**7.** No evidence ($t = -0.205$; two-tailed $P = 0.839$) of a mean increase in the weight of squash from dry to normal years (mean change: $2.230$\ g ($95$%\ CI from $-24.8$ to $20.3$\ g), heavier in normal year).
**8.* $n = 24$; probably.
:::
...
**8.** Very strong evidence ($P = 0.0005$) that the drug reduces the average systolic blood pressure (mean reduction: $8.6$\ mm\ Hg) in the population.
**9.** $n = 14$; maybe not.
:::
`r if( !includeEvenAnswers) "-->"`
