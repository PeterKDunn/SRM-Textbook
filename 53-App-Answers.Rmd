...
```{r PanelsBoxplot, fig.align="center", fig.cap="The boxplot for the productivity data", fig.width=5, fig.height=4}
Panels <- array(NA, 
                dim = c(7, 3))
...
```{r, fig.cap="The sampling distribution of the proportion of males in samples of 864 people with hiccups", fig.width=6, fig.height=3.5, fig.align="center"}
z <- seq(-3.5, 3.5, 
         length = 100)
mn <-  0.8194444
sdev <- 0.01308604
...
```{r WhalesErrorbar, fig.cap="Error bar chart comparing the lengths of female and male gray whales", fig.align="center", fig.width=4.5, fig.height=3.5}
...
```{r FerritinGraph, fig.align="center", fig.cap="A histogram of the change in ferritin concentration", fig.width=5, height=2}
