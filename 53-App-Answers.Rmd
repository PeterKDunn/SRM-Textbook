...
Brand allocated to car; each car gets one brand of tyre.
Tyres on one car exposed to same day-to-day use, drivers, distances, conditions, etc.
...
*Explanatory*: 'whether the participants drank green tea at least three times a week'.
...
Reasoning assumes three outcomes (HH, TT, HT) *equally likely*; untrue.
...
About $z = 2.05$.
IQ: $130.75$.
IQ greater than $130$ required to join Mensa.
:::
...
$t$-score: $-23.13$, which is *huge*; $P$-value *very* small.

*Very* strong evidence ($P < 0.001$) that children do not spend $2$\mins (on average) brushing their teeth (mean: $60.3$\secs; std\ dev.: $23.8$\secs).
Stat.\ valid.
:::
`r if( !includeEvenAnswers) "-->"`
...
**12.** No evidence ($t = -0.205$; two-tailed $P = 0.839$) of a mean increase in the weight of squash from dry to normal years (mean change: $2.230$\gs ($95$%\ CI from $-24.8$ to $20.3$\gs), heavier in normal year).
:::
...
**1.** Because it means blood pressure *reduction*; reduction is what the drug is meant to produce.
**2.** Pairs have same sex, diet, age, etc.
**3.** The mean reduction in blood pressure.
**4.** Histogram of *diffs* not shown.
**5.** $H_0$: $\mu_d = 0$ and $H_1$: $\mu_d > 0$ (because the diffs are *reductions*).
**6.** Sketch not shown.
**7.** $t = 8.12$.
...
**12.** Very strong evidence ($P = 0.0005$) that the drug reduces the average systolic blood pressure (mean reduction: $8.6$\mms\ Hg; $95$% CI: $13.934$ to $23.93$\mms\ Hg) in the population.
**13.** $n = 14$; maybe not.
:::
`r if( !includeEvenAnswers) "-->"`
...
**3.** $t = 1.699$; *approx.* one-tailed $P$-value between $16$% and $2.5$%; not sure if $P$ is larger than $0.05$... but likely to be ($t$-score quite a distance from $z = 1$).
...
**2.** $t = 1.78$; $P$-value larger than $0.05$: the evidence doesn't support the alternative hypothesis.
...
Test may not be stat.\ valid; histogram of data suggests population *might* have normal distribution); $P$-value so large it probably makes little difference.
:::
...
CI from $0.0042$% to\ $0.0522$%.
Stromg evidence of mean difference.
:::
`r if( !includeEvenAnswers) "-->"`
...
**8.** No evidence ($t = 0.65$; two-tailed $P > 0.10$) in the sample that the mean length of adult gray whales is different in the population for females (mean: $12.70$\ms; standard deviation: $0.611$\ms) and males (mean: $12.07$\ms; standard deviation: $0.705$\ms; $95$%\ CI for the difference: $-1.26$\ms to $0.246$\ms).
**9.** Stat.\ valid.
:::
...
**1.** $\mu_P - \mu_E$, the reduction in mean duration for those using echinacea. 
...
**10.** Slight evidence of a difference.
**11.** Not given.
**12.** Stat.\ valid.
**13.** Probably not practically important (difference of $0.53$ days).
:::
...
No answer (yet).
**1.** Splinting *minus* exercise: the diffs are how much greater pain is with splinting.
**2.**
...
**10.** No evidence of a difference.
**11.** Sample sizes small; probably not be stat.\ valid and roughly correct only.
:::
`r if( !includeEvenAnswers) "-->"`
...
**4.** Very strong evidence in the sample ($P < 0.001$) that the mean annual sugar consumption per person is different for industrialised (mean: $41.8$\kgs/person/year) and non-industrialised (mean: $24.6$\kgs/person/year) countries ($95$%\ CI for the difference $11.95$ to $22.54$).
**5.** Yes.
:::
...
$t = -0.175$; very large $P$-value; no evidence of an increase.
:::
`r if( !includeEvenAnswers) "-->"`
...
**1.** $\mu_Y - \mu_O$: the mean amount younger women can lean further forward than older.
**2.** Boxplot.
**3.** Table not shown.
...
::: {.answer data-latex=""}
**Ex.\ \@ref(exr:BHADP).**
**1.**  Mean <span style="font-variant:small-caps;">bhadp</span> for those with disability, minus those without disability.
**2.** Plot not shown.
**3.** $0.78794$.
**4** Table not shown.
**5.** $5.18$ to $8.34$, larger for those with disability.
**6.** $H_0$: $\mu_D - \mu_N = 0$ (*no* diff.\ in the pop.\ mean <span style="font-variant:small-caps;">bhadp</span> scores).
       $H_1$: $\mu_D - \mu_N \ne 0$ (diff.\ in the pop.\ mean <span style="font-variant:small-caps;">bhadp</span> scores).
**7.** $t = \frac{6.76 - 0}{0.78794} = 8.58$.
**8.** $P$ will be *very* small.
**9.** Strong evidence exists in the sample ($t = 8.58$; two-tailed $P < 0.001$) that people with a disability (mean: $31.83$; $n = 132$; standard deviation: $7.73$) and people without a disability (mean: $25.07$; $n = 137$; standard deviation: $4.80$) have different population mean access to health promotion services ($95$%\ CI for the difference: $5.18$ to $8.34$), as measured by <span style="font-variant:small-caps;">bhadp</span> scores.
**10.** Yes.
:::
`r if( !includeEvenAnswers) "-->"`
...
**1.**: *Grip*: $1.886$ and $2.714$; *Push-ups*: $2.357$ and $3.317$.
**2.** $t = 1.51$; $P$ large; no evidence of a difference.
**3.** $t = 2.70$; $P$-=small; evidence of a difference.
...
::: {.answer data-latex=""}
**Ex.\ \@ref(exr:Coeliac).**
**1.** Researchers used exact $95$%CI; we used approx. $95$%\ CI.\spacex
**2.** True.
**3.** False.
...
$t = 2.631$; one-tailed $P = 0.0055$; evidence of a difference
:::
...
**3.** $z = 1.31$; $P = 0.253$; no evidence of difference.
...
**7.** $\chi^2 = 1.31$; $P = 0.253$; no evidence of a difference.
...
**2.** $0.3000$; $0.3033$.
**3.** $-0.0033$.
**4.** $\text{s.e.}(\hat{p}_1) = 0.06480741$; $\text{s.e.}(\hat{p}_2) = 0.04161698$; s.e. for difference: $0.0770193$.
...
**10.** $0.480$ to\ $2.02$.
**11.** Not shown
**12.** $p = 0.4333$; s.e. for difference: $0.0832097$.
**13.** $z = (-0.0033 - 0)/0.0832097 = -0.040$; very small $P$-value; no evidence of difference.
**14.** $\chi^2 = 0.002$ (output); $P = 0.966$; no evidence of difference.
:::
...
**2.** $0.653$; $0.615$.
**3.** $0.0377$.
**4.** $\text{s.e.}(\hat{p}_1) = 0.02617$; $\text{s.e.}(\hat{p}_2) = 0.03835$; s.e. for difference: $0.04643$.
...
**10.** $0.80$ to\ $1.73$.
**11.** Not shown
**12.** $p = 0.640$; s.e. for difference: $0.04611$.
**13.** $z = (0.0377 - 0)/0.04611 = 0.818$; very small $P$-value; no evidence of difference.
**14.** $\chi^2 = 0.667$ (output); $P = 0.414$; no evidence of difference.
...
**6.** $-0.273$ to\ $-0.111$.
**7.** Not given.
**8.** $z = (-0.1918 - 0)/0.04202 = -4.56$; small $P$; evidence of difference.
**9.** $0.443$.
**10.** $0.315$ to\ $0.623$.
**11.** $P < 0.0001$; small $P$; evidence of difference.
**12.** Yes.
**13.** Observational.
:::
...
**6.** $0.000$ to\ $0.285$.
**7.** Not given.
**8.** $z = (0.1426 - 0)/0.072715 = 1.96$; marginal\ $P$; slight evidence of difference.
**9.** $2.65$.
**10.** $0.979$ to\ $7.17$.
**11.** $P = 0.050$; small $P$; slight evidence of difference.
**12.** Yes.
:::
`r if( !includeEvenAnswers) "-->"`
...
**1.** Table not shown.
**2.** Diff: $-0.1184$; individual standard errors: $0.03446$ and $0.063315$; for difference: $0.07208575$.
**3.** $0.389$.
**4.** $-0.263$ to\ $0.026$.
**5.** $-0.260$ to\ $0.023$.
**6.** Not given.
**7.** $0.133$ to\ $1.14$.
**8.** $P = 0/077$; slight evidence of difference.
**9.** Yes.
:::
`r if( !includeEvenAnswers) "-->"`
...
**5.** $2.17$; small $P$.
**6.** Some evidence of difference.
**7.** $34\times 16/124 = 4.39$; *just* less than five; minor concerned (should be noted).
:::
`r if( !includeEvenAnswers) "-->"`
...
**2.** $0.290$, $0.495$.
**3.** $47.7$%, $61.0$%, $75.9$%.
**4.** $H_0$: No association; $H_1$ An association.
...
**14.** Same, reflected left-to-right.
        ...
        (d)\ Intercept will change a lot: the predicted value of the price if line is extended to year\ $0$; meaningless.
:::
`r if( !includeEvenAnswers) "-->"`
...
**5.** Paired $t$-test.
**6.** Null: No mean difference between counts on phone, manually counted; alternative: a difference.
**7.** $P$ small; evidence mean difference in step-count between two methods cannot be explained by chance: likely a difference.
**8.** Valid.
:::
...
**2.** Observational.
**3.** A random method used:  results should be generalisable to population (students at that university).
**4.** Double-barrelled.
...
**9.** $t = -2.61$; expect small $P$; evidence mean different for females, males.
...
**7.** Yes.
**8.** Yes.
**9.** For *Cx.*, evidence mean sizes at the temperatures different; for *Ae.*, no evidence mean sizes at the temperatures different.
