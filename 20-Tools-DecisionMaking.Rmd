...
1. *No difference exists between the population parameters*: the difference between the statistics is simply due to *sampling variation*. 
   This is the *null hypothesis*, or $H_0$.\index{Parameters}\index{Hypotheses!null}
...
Using this idea, a reasonable assumption can be made about the *population* parameter.\index{Parameters}
...
\index{Decision making!obserrvations}
