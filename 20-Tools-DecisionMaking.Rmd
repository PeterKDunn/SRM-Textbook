...
In the observed sample, the odds of an incidence of diarrhoea in children in households *without* livestock was $0.176$ (Table\ \@ref(tab:WaterAccessCompareQuantTabs)).
However, the odds in households *with* livestock was $0.548$.
In other words, the odds of an incidence of diarrhoea in young children was over three times greater in households with livestock than without (i.e., $0.548/0.176 = 3.11$).
...
If a different sample was chosen, different values for the odds of an incident of diarrhoea in the two groups (with livestock; without livestock) would have been produced.
