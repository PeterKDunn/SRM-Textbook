...
If a different sample was chosen, different values for the two sample percentages would have been produced.
...
We observe just one of the many possible samples, and hence observe just one of the many possible percentages of children with diarrhea in households *with* livestock.
Similarly, we observe just one of the many possible percentages of children with diarrhea in households *without* livestock.
So what does this difference between the two *sample* percentages imply about the difference between the two *population* percentages?
Two reasons could explain why the *sample* percentages are different:

1. The two *population* percentages are the *same*; the difference between the *sample* percentages is due to *sampling variation*.
   That is, we just happen to have---by chance---one of those samples where the difference between the two percentages is quite noticeable.
   The *sample* percentages are different only because we have data from one of the many possible samples, and every sample is likely to be different.
2. Alternatively, the two *population* percentages are *different*, and the *sample* percentages reflect this.
