...
Limitations generally can be discussed through four components:

* *Study type* (Sect.\ \@ref(StudyDesignsLimitations)):\index{Limitations}
  Discuss any limitations due to the type of study used (Chap.\ \@ref(ResearchDesign)).
...
Some of these limitations are imposed by the type of study.
...
## Limitations related to the study type {#StudyDesignsLimitations}
\index{Limitations!research design (effectiveness)}

Different studies have limitations.
...
If the population is Iowans, then the study is externally valid if the sample is representative of Iowans.
The results *do not* have to apply to people in the rest of the United States (though this can be commented on, too).
The intended population is *Iowans*.
:::
...
The study was still useful however!
:::
...
* *study type*: different studies have different limitations.
...
A student project asked if 'the percentage of word retention higher in male students than female students?'
...
Suppose a student group was studying this RQ: 
...
Discuss this quote using the language of this chapter.
:::
