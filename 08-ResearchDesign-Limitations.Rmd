...
A discussion of the limitations of internal validity should cover, as appropriate: possible confounding and lurking variables; the impact of the Hawthorne, observer, placebo and carry-over effects; the impact of any other design decisions.
...
Furthermore, results from approximately representative samples (Sect.\ \@ref(Representative-samples)) may generalise to the population and be externally valid if those *in* the study are not obviously different from those *not in* the study.
