...
```{r AnimateRiseRun, echo=FALSE, animation.hook="gifski", cache=FALSE, interval=0.75}
...
the number of sleep disruptions per hour increasse (on average) by about 1.36.
