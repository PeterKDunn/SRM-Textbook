...
```{r PropOdds, fig.align="center", out.width='90%', fig.width=9, fig.height=3.75, fig.cap="Proportions (left) are the number of interest divided by the total number; odds (right) are the number of interest divided by the rest."}
