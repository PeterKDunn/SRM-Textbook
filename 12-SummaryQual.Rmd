...
The rows (or the columns) should list the *levels* of the variable, and these should be *exhaustive* (cover all levels) and *exclusive* (observations belong to only one level).
