...
In Sect.\ \@ref(MeanDiffCI), a CI is computed for the difference between the distances walked in $6$\ mins (the six-minute walk test, 6MWT), using a $20$\ m and $30$\ m walkway [@saiphoklang2022comparison], for $50$ Thai patients.
The *approximate* $95$%\ CI is from $15.80$\ m to $28.26$\ m, further for a $30$\ m walkway (i.e., the margin of error is $6.234$\ m).
...
Also, suppose we wanted a precision of give-or-take $4$\ m.
