...
She runs the program at one university only, then compared the average amount of drinking per person at two universities (A and B).
...
All 25 cases were gardeners, with hanging baskets of ferns.\label{thinkBox:GardenersDirection}
\smallskip
...
Researchers find individuals with specific values of the response variable (the cases and the controls), and determine values of possible the explanatory variable from the past.
...
A review of programs that used double-fortified salt programs to manage iodine and iron deficiencies examined numerous existing studies.
...
A study is *externally valid* if the results of the study are likely to generalised to the rest of the *population*, beyond just those studied in the sample.
...
**Externally validity** refers to the ability to generalise the results to teh rest of the population, beyond just those in the sample studied.
...
The data may be already available (called *secondary data*), or may need to be collecting (called *primary data*).
