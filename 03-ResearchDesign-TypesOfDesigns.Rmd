...
Descriptive studies *are used to answer descriptive RQs* (Fig. \@ref(fig:POCIDescriptive)).


::: {.definition #DescriptiveStudy name="Descriptive study"}
In a *descriptive study*,\index{descriptive study}
researchers only focus on collecting, measuring, assessing or describing an outcome in the population.
:::
...
The *response variable* is the *increase* in heart rate for the individual men.

The increase in heart rate would need to be found by measuring each man's heart rate *before* the walk, then their heart rate *after* the walk, and finding the difference between them.
...
No *comparison* being made: every man in the study is treated in the same way.
...
In an **experimental study**, the [unit of analysis](def:UnitOfAnalysis) is the smallest collection of units of observations that can be randomly allocated to separate treatments.
:::
