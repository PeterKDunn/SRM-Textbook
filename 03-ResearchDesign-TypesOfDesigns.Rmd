...
`r if( knitr::is_html_output(exclude = "epub") ) {
   longmcq( c(
      ...
      anwser = "In a true experiment, the researchers apply treatments to groups that they have determined. In a quasi-experiment, the researchers apply treatments to groups that they have not determined",
