...
```{r ObsStudiesImage, echo=FALSE, warnings=FALSE, message=FALSE, fig.cap="Observational studies. The dashed lines indicate steps that are not under the control of the researchers", fig.align="center", fig.width=7, fig.height=3, out.width='75%'}
...
```{r TrueExpStudiesImage, echo=FALSE, fig.cap="True experimental studies", fig.align="center", fig.width=7, fig.height=3, out.width='75%'}
...
::: {.thinkBox .think data-latex="{iconmonstr-light-bulb-2-240.png}"}
A researcher wants to examine the effect of an alcohol awareness program [@macdonald2008enough] on the amount of alcohol consumed in a university Orientation Week.
...
```{r QuasiExpStudiesImage, echo=FALSE, fig.cap="Quasi-experimental studies. The dashed lines indicate steps that are not under the control of the researchers", fig.align="center", fig.width=7, fig.height=3, out.width='75%'}
...
The advantages and disadvantages of each study type are discussed later (Sect. \@ref(InterpretStudyDesign)), after other issues are examined in the following chapters. 
...
Both experimental studies and cohort studies can be expensive and tricky: tracking a gfroup of individuals (a *cohort*) into the future is not always easy, and individuals may be lost to follow-up (*drop-outs*).
