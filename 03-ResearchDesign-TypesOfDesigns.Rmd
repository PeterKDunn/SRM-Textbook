...
```{r ObsStudiesImage, fig.cap="Observational studies. The dashed lines indicate steps that are not under the control of the researchers", fig.align="center", fig.width=7, fig.height=3, out.width='75%', cache=FALSE}
