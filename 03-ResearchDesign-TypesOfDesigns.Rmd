...
(The answer is here^[*Retrospective*: people were identified with an infection, and then the researchers looked *back* at past activities.].)
:::
...
(The answer is here^[It is *neither*. The researcher did not determine the groups: the students (not the researcher) would have chosen University A or University B for many reasons. The researcher *did* decide how to allocate the program to University A or University B.].)
:::
...
<!-- ####################### REVIEW QUESTIONS ##################################### -->
```{r, child = if (knitr::is_html_output(exclude = "epub")) './children/ReviewQuestions/ReviewQuestions-TypesOfDesigns.Rmd'}
```
