...
# Types of study designs {#ResearchDesign}\index{Study design|()}
...
* *Observational* studies (Sect.\ \@ref(ObservationalStudies)) answer relational RQs; and 
...
## Descriptive studies {#DescriptiveStudies}\index{Research question!descriptive}\index{Study types!descriptive}
...
## Observational studies {#ObservationalStudies}\index{Research question!relational}\index{Study types!relational}
...
::: {.definition #Conditions name="Condition"}\index{Conditions}
...
Consider again this one-tailed RQ:
...
This RQ has a between-individuals comparison, and is interventional if the researchers do not impose the taking of echinacea (that is, the individuals make this decision themselves).
...
The *within-individuals comparison* is before and after walking $400$\ m.

Alternatively, the outcome could be given as the average *increase* in heart rate (*after* heart rate minus the *before* heart rate).
Some differences might be positive numbers (heart rate *increased*), and some may be negative numbers (heart rate *decreased*).
:::


## Experimental studies {#ExperimentalStudies}\index{Research question!interventional}\index{Study types!experimental}
...
::: {.definition #Treatments name="Treatments"}\index{Treatments}
...
### True experimental studies {#TrueExperiments}\index{Study types!experimental!true}
...
```{r TrueExpStudiesImage, fig.cap="True experimental studies: researchers allocate individuals to groups, and treatments to groups", fig.align="center", fig.width=7, fig.height=3, out.width='75%'}
...
### Quasi-experimental studies {#QuasiExperiments}\index{Study types!experimental!quasi}
...
## Comparing study types {#CompareStudyTypes}\index{Study types!compared}
...
## Directionality {#Directionality}\index{Study types!directionality}
...
### Forward-directional studies {#Forward}\index{Study types!directionality!forward}
...
Both experimental studies and cohort studies can be expensive and tricky: tracking a group of individuals (a *cohort*) into the future is not always easy, and the ability to track some individuals into the future may be lost (*drop-outs*) as (for example) plants or animals die, or people move or decide to no longer participate, etc.
...
### Backward-directional studies {#Backward}\index{Study types!directionality!backward}
...
### Non-directional studies {#NonDirectional}\index{Study types!directionality!non-directional}
...
## Internal validity {#IntroInternalValidity}\index{Internal validity}
...
Ideally, all studies should be designed to be *internally valid* (Chaps.\ \@ref(DesignExperiment) and \@ref(DesignObservational)) as far as possible.
...
## External validity {#IntroExternalValidity}\index{External validity}
