...
*Observational studies* (Fig. \@ref(fig:POCIObservational)) answer *relational RQs*.
...
Broadly speaking, three types of observational studies exist (Table \@ref(tab:TypesOfObsStudies)):   

* [Retrospective](#RetrospectiveStudies): 
  The comparison/connection is *known*, and the study looks into the past for the outcome.
* [Prospective](#ProspectiveStudies): 
  The comparison/connection is known, and the study looks to the future for the outcome.
* [Cross-sectional](#CrosssectionalStudies): 
  The comparison/connection is *unknown*, and the study looks into the past for the outcome.

Many specific types of observational studies exist (case-control studies; cohort studies; etc.), but we will not delve into these.

**I've mixed up case-control and cross-sectional!!!**


```{r echo=FALSE, TypesOfObsStudies}
ObsStudies <- array( dim = c(3, 5) )
...
In *retrospective studies*, the values of the explanatory variable are known.
The values of the response variable are established (cannot be changed or impacted) but are unknown when the study begins, and need to be obtained.
...
In *prospective studies*, the values of explanatory variable are known when the study begins.
The values of the response variable are unknown when the study begins, but will be obtained in the future.
...
A study [@data:Choi2008:GoutSoftdrinks] measured the softdrink consumption of men, and determined who experienced gout in the following 12 years.

The response (whether or not the individuals experience gout) is determined in the future.
The explanatory variable (the amount of softdrink consumed) is measured now.
...
In *cross-sectional studies*, the values of the response variable are known when the study begins.
The values of the explanatory variable are unknown when the study begins, and can be found by looking into the past.
...
*Experimental studies* (Fig. \@ref(fig:POCIExperiment)), or *experiments*, are commonly-used study designs.
