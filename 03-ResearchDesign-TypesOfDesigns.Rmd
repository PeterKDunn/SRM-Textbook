...
Different types of studies are used to answer different types of RQs (Table\ \@ref(tab:studyTypes)):

* *Descriptive* studies (Sect.\ \@ref(DescriptiveStudies)) answer descriptive RQs;
* *Observational* studies (Sect.\ \@ref(ObservationalStudies)) answer RQs with a comparison or connection, that *do not have* an intervention; and 
* *Experimental* studies (Sect.\ \@ref(ExperimentalStudies)) answer RQs with a comparison or connection that *do have* an intervention.
...
*Descriptive studies* answer descriptive RQs (Fig.\ \@ref(fig:POCIDescriptive)), with a population and outcome.
...
*Observational studies* (Fig.\ \@ref(fig:POCIObservational)) answer *analytical RQs* without an intervention.
...
*Observational studies* answer research questions with a comparison or connection, but *without* an intervention.
:::
...
Consider again this one-tailed, decision-making RQ:
...
```{r ObsStudiesImageBetween, fig.cap="Observational between-individuals studies. The dashed lines indicate steps not under the control of the researchers", fig.align="center", fig.show="hold", fig.width=6, fig.height=3, out.width='65%', cache=FALSE}
...
```{r ObsStudiesImageWithin, fig.cap="Observational within-individuals studies. The dashed lines indicate steps not under the control of the researchers", fig.align="center", fig.show="hold", fig.width=6, fig.height=3, out.width='65%', cache=FALSE}
...
Experimental studies are almost always used to answer relational and repeated-measures RQs, but rarely for correlational RQs.


::: {.definition #Experiment name="Experiment"}
*Experimental studies* (or *experiments*) answer RQs with an intervention.
:::
...
::: {.example #ResearchDesignWeightLoss name="Within-individuals experimental study"}
...
```{r ExpStudiesImageWithin, fig.cap="Experimental within-individuals studies. The dashed lines indicate steps not under the control of the researchers", fig.align="center", fig.show="hold", fig.width=6, fig.height=3, out.width='65%', cache=FALSE}
source("R/showRepeatedMStudyDesign.R")
...
colnames(ExpStudies) <- c("Study type",
                          "Individuals allocated to receive the comparison/connection?", 
...
if( knitr::is_latex_output() ) {
   ...
   kable(ExpStudies[ c(3, 1, 2), ], # Change order
        ...
        caption = "Comparing analytical designs with a between-individuals comparison (descriptive studies do not have any comparison or connection (C))",
        align = c("r", "c", "c", "l"))   %>%
   kable_styling(full_width = FALSE, 
                 font_size = 8) %>%
...
*True experiments* are commonly used in studies with a between-individuals comparison, but are not always possible.
...
Quasi-experiments are similar to true experiments, but treatments are *allocated* to groups that *already exist* (e.g., may be naturally occurring).
...
Three types of research studies are: *Descriptive studies* (for descriptive RQs), *observational studies* (for RQs with a comparison or connection, but *without* an intervention), and *experimental* (for RQs with a comparison or connection, *with* an intervention).
