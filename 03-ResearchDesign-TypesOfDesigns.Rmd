...
::: {.example #ResearchDesignWeightLoss name="Correlational study"}
...
For this reason, internal validity is studied in more detail in Chaps.\ \@ref(DesignExperiment) (for experimental studies) and \@ref(DesignObservational) (for observational studies).
...
Using a *random sample* helps ensure external validity.\index{Sampling\index{Limitations!study design (effectiveness)}
!random}
In addition, the use of *inclusion* and *exclusion criteria* (Sect.\ \@ref(Population)) helps clarify to whom or what the results may apply.
