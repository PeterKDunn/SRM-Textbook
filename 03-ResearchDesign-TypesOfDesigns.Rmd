...
*Descriptive studies* are used to answer descriptive RQs (Fig. \@ref(fig:POCIDescriptive)), which only specify a population and outcome.

::: {.definition #DescriptiveStudy name="Descriptive study"}
*Descriptive studies* are used to answer descriptive research questions.
:::
...
*Observational studies* are used to answer relational research questions.
:::
...
Experimental studies have an [*intervention*](Intervention), and so *experimental studies are used to answer interventional RQs*.
