...
This study is a *quasi-experiment* since the researcher did not (can can not) determine the groups: the students (not the researcher) would have chosen University A or University B for many reasons.
However, the researcher *did* decide how to allocate the program to University A or University B.
:::
