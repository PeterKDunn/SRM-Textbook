...
`r if( knitr::is_html_output(exclude = "epub") ) {
   longmcq( c(
      ...
      answer = "In a true experiment, the RQ has a comparison; in a quasi-experiment, the RQ has a connection"))}` 
2. A research study compared the use of two different education programs to reduce the percentage of patients experiencing ventilator-associated pneumonia (VAP).  
