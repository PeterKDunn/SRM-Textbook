...
`r if( knitr::is_html_output() ) {torf( answer = TRUE)}`
   b. Inclusion and exclusion criteria can be used to clarify the internal validity.  
`r if( knitr::is_html_output() ) {torf( answer = FALSE)}`
   c. Observational studies generally have a higher external validity than quasi-experimental studies.  
`r if( knitr::is_html_output() ) {torf( answer = FALSE)}`
:::
...
A nursing study compared 'the effectiveness of alternating pressure air mattresses vs. overlays, to prevent pressure ulcers' (@data:Manzano2013:Matresses, p.\ 2099).
