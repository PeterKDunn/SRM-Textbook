...
As demonstrated in Sect.\ \@ref(TestpObsDecisionPvalues), $P$-values can be *approximated* (using the $68$--$95$--$99.7$ rule or tables) when the sampling distribution has an approximate normal distribution.
