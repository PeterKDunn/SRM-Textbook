...
```{r RedDeerRegressionjamoviSPSSraw, fig.cap="Output for the red-deer data", fig.align="center", out.width=c("45%", "54%"), fig.show="hold"}
...
```{r CyclonesRegressionjamoviSPSS, fig.cap="Output for the cyclone data", fig.align="center", out.width=c("43%", "55%"), fig.show="hold"}
...
```{r RedDeerRegressionjamoviSPSSCI, fig.cap="Output for the red-deer data, including the CIs for the regression parameters", fig.align="center", out.width=c("75%", "90%"), fig.show="hold"}
