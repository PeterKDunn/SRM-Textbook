...
```{r OSADT, echo=FALSE, fig.cap="The obstructive sleep apnoea dataset", fig.align="center"}
...
if( knitr::is_html_output() & knitr::pandoc_to("epub")) {
  knitr::kable( head(useOSA, 10),
               ...
               col.names = c("Age",
                            ...
                            "REI"),
              caption = "Part of the Obstructive sleep apnoea dataset") 
}
```
...
```{r ruminantDT, echo=FALSE, fig.cap="The digestibility dataset", fig.align="center"}
if( knitr::is_html_output(exclude = "epub") ) {
