...
```{r RedDeerSlopeSampDist, echo=FALSE, fig.cap="The distribution of sample slopes for the red deer data, if the population slope is 0", fig.align="center", fig.height=3.0, fig.width=8, out.width='85%'}
mn <- 0
se <- 0.0289
