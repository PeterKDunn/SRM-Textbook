...
(Sect. \@ref(MakingDecisionsInResearch)) used in research:
...
This is called the *Central Limit Theorem*.\index{Central Limit Theorem}
...
```{r SpinningWheel, echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.05, progress=TRUE, dev=if (is_latex_output()){"pdf"}else{"png"}}
...
```{r RouletteWheel, echo=FALSE, fig.cap="A European roulette wheel", cache=FALSE, out.width = "40%", fig.align="center"}
...
\begin{wrapfigure}{R}{.25\textwidth}
  \begin{center}
    \includegraphics[width=.20\textwidth]{Illustrations/luck-839037_640.jpg}
  \end{center}
\end{wrapfigure}
`r if (knitr::is_html_output()) '-->'`
...
The value of the sample statistic can vary for every possible sample that we could select,
so the actual value of the sample statistic that we observe depends on which sample we have.
