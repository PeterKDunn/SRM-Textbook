...
`r if (knitr::is_latex_output()) {
   'These are provided in the online version of this book (App. \\@ref(AppendixDataSets)),'
} else {
   'These are listed in App. \\@ref(AppendixDataSets),'
}`
and are available in the **R** package [**SRMData**](https://CRAN.R-project.org/package=SRMData).
