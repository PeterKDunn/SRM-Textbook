...
modify_latex <- function(latex_code) {
  # Your modification logic here
  # For example, to add a custom preamble:
  
  
  latex_code <- readLines(latex_code)
  
  cat("PPPPPPPPPPPPP \n" )
  
  latex_code <- gsub(pattern = "RQ", 
...
knitr::opts_hooks$set(before_output = function(x, options) {
  ...
  if (options$output_format == "latex") {
    x <- modify_latex(x)
  }
  x
})
