...
However, sometimes jamovi [@Software:jamovi] and/or SPSS [@Software:SPSS] output are shown.
...
`r if (knitr::is_html_output()) {'* The images used in the online book are free (and used according to their guidelines), as listed in Appendix \\@ref(Image-Credits).'}`
