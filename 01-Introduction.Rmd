...
Spontaneous generation was consistent with *observations*: the above recipe *did* produce mice.
However, this hypothesis\index{Hypotheses} ('possible explanation') was rejected when later evidence, in better-designed research studies, contradicted the hypothesis.
...
Research involves designing studies to collect data, and analysing data; this book covers both.
...
:::{.example #MixedMethodsInfections name="Ttpes of research"}
