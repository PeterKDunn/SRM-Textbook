...
* The formula for a hypothesis test uses the **population proportion** $p$ from the null hypothesis (see Eq. \@ref(eq:stderrorphat)), since hypothesis testing *assumes that the null hypothesis is true*, and hence the value of $p$ is known.
