...
```{r, RollsSixesSD, fig.height=3.00, out.width='60%', fig.align="center", fig.cap="The sampling distribution, showing the distribution of the sample proportion of 1s when the population proportion is 0.1666..., in 50 die rolls"}
p <- 1/6
n <- 100
...
```{r, OnePropTestP, fig.cap="The two-tailed P-value is the combined area in the two tails of the distribution; left panel: when $z = 1$; right panel: when $z = 2$", fig.width=10, fig.height=2.75, out.width='90%', fig.align="center"}
par(mfrow = c(1, 2), 
    mar = c(4, 1, 4, 1) + 0.1)
