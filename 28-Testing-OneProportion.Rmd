...
If $p$ is defined a the population proportion of ones, then the hypotheses above are:
...
::: {.definition #DEFSamplingDistributionPhatHT name="Sampling distribution of a sample proportion when $p$ is unknown"}
