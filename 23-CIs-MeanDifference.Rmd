...
# Confidence intervals for mean differences (paired data) {#PairedCI}
...
Consider a study to
estimate the average energy savings made 
by using a new type of house insulation.
...
Data are *paired* when two observations about the same variable are recorded
...
```{lemma PairedSituations, name="Paired situations"}
...
<iframe src="https://h5p.org/h5p/embed/488115" width="1090" height="401" frameborder="0" allowfullscreen="allowfullscreen"></iframe><script src="https://h5p.org/sites/all/modules/h5p/library/js/h5p-resizer.js" charset="UTF-8"></script>





## Mean differences: Notation {#PairedNotationCI}
...
colnames(DiffNotation) <- c(	"One sample mean", "Mean of paired data")
...
if( knitr::is_latex_output() ) {
  DiffNotation[1, ] <- c(	"Values: $x$", 	"Differences: $d$")
  DiffNotation[2, ] <- c(	"$\\bar{x}$",		"$\\bar{d}$")
  DiffNotation[3, ] <- c(	"$s$", 			"$s_d$")
...
# 	method="jitter",
# 	xlab="Energy cost difference (MWh)",
# 	main="A dotplot of energy savings",
# 	las=1,
# 	pch=19,
# 	col="blue")
# box()
...
(While a mean or a median may be appropriate for describing the *data*,
the CI is about the *mean*,
since the sampling distribution for the sample mean
(under certain conditions)
has a *normal distribution* which is best described using a mean.)
...
#   DT::datatable( round(Insulation.DataSummary, 2),
#                 fillContainer=FALSE, # Make more room, so we don't just have ten values
#                 colnames=c("Mean", "Median", "Std dev", "IQR"),
#                 filter="none",
#                 options = list(searching = FALSE), # Remove searching: See: https://stackoverflow.com/questions/35624413/remove-search-option-but-leave-search-columns-option
#                 caption="The mean, median, standard deviation and IQR for the energy consumption data (in MWh)")
kable(Insulation.DataSummary,
...
## Mean differences: Statistical validity conditions {#ValidityPaired}
...
<!-- ```{r BloodPressureDescriptives, echo=FALSE, fig.cap="SPSS output for the blood pressure data", fig.align="center", out.width="80%"} -->
...
```{lemma UnderstandingSamples, name="Understanding samples"}	
Is there a mean difference in DBP
*in the population*?
```
...
<!-- <iframe src="https://h5p.org/h5p/embed/190466" width="1090" height="329" frameborder="0" allowfullscreen="allowfullscreen"></iframe><script src="https://h5p.org/sites/all/modules/h5p/library/js/h5p-resizer.js" charset="UTF-8"></script> -->
