...
::: {.thinkBox .think data-latex="{iconmonstr-light-bulb-2-240.png}"}
For this situation, what graphs would be suitable for displaying these data?\label{thinkBox:WhichGraph}
`r if (knitr::is_latex_output()) '<!--'`
* Boxplot  
...
\]
Using an approximate multiplier of 2, the margin of error is $2 \times 0.073837 = 0.147674$, so an approximate 95% CI for the difference in support is $0.77\pm 0.147674$, or from $0.62$ to $0.92$.
We write:
