...
*Paired data* refers to situations where every observation in one group is related to, or can be matched sensibly to, one observation in another group.
...
Paired data can arise in many ways; consider these examples:
...
* Recording the species richness of numerous natural waterways before and after restoration projects.
  Each waterway has the species richness recorded twice, and the change in species richness is recorded for each waterway
