...
Here, we decide to use weight *gain* since it is explicitly mentioned in the RQ.
:::
...
```{r WeightGainHistogram, echo=FALSE, fig.cap="A plot of weight changes. Left panel: A histogram (the vertical grey line represents no weight gain). Right panel: Case-profile plot (a dashed line represents a weight gain!!!!!!!!!!!!!!!!!)", fig.align="center", out.width='100%', fig.width=9.5, fig.height = 3.0}
par( mfrow = c(1, 2))
...
=======
* centred around a $sampling mean$ of $\mu_{\bar{d}}$, whose value is $\mu_d$ (the population mean *difference*),
...
From the jamovi or SPSS output (Fig.&nbsp;\@ref(fig:InsulationTestOutput)) we can write:

> Based on the sample, a 95% CI is for the population mean weight gain between Weeks 1 and 12 is between $0.63$ to $1.09$kg


```{r InsulationTestOutput, echo=FALSE, fig.cap="The weight-gain data: jamovi output (top) and SPSS output(bottom)", fig.align="center", out.width=c("95%","85%"), fig.show="hold"}
