...
```{r WeightGainHistogram, fig.cap="A histogram of weight changes (the vertical grey line represents no weight gain)", fig.align="center", out.width='70%', fig.width=8.5, fig.height = 3.0}
par( mfrow = c(1, 2))
