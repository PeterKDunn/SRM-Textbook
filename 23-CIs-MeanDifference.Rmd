...
For the home insulation data, the variation in the sample mean differences $\bar{d}$ is described by (see Table \@ref(tab:NotationOneDiffCI)):
...
OneDiffNotation[4, ] <- c("all possible samples",
                          "with mean $\\mu_{\\bar{d}}$ and standard deviation $\\text{s.e.}(\\bar{d})$")
...
if( knitr::is_latex_output() ) {
  ...
  OneDiffNotation[3, 2] <- paste(OneDiffNotation[3, 2], 
                                 OneDiffNotation[4, 2])
  OneDiffNotation[3, 3] <- paste(OneDiffNotation[3, 3], 
                                 OneDiffNotation[4, 3])
  OneDiffNotation[3, 4] <- paste(OneDiffNotation[3, 4], 
                                 OneDiffNotation[4, 4])
