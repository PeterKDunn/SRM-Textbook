...
The data are not available, so a graphical summary cannot be produced; however, a data summary is given in the article (motivating Table\ \@ref(tab:TGsummaryTable)).
...
\[
  7.12\pm (2\times 6.48), \text{or from $-5.84$ to $20.08$ mg.dl$^{-1}$}.
\]
The chamomile tea appears to reduce TG; this is studied further in Sect.\ \@ref(CoffeeExtractHT).
...
> An approx.\ $95$% CI for the mean *reduction* in TG is between $27.88$ to $49.36$ mg.dl$^{-1}$ for those drinking chamomile tea, and between $-5.84$ to $20.08$ mg.dl$^{-1}$ for the control group.
