...
WtGain.DataSummary[1, 4] <- IQR(StudentWt$Week1)
WtGain.DataSummary[2, 4] <- IQR(StudentWt$Week12)
WtGain.DataSummary[3, 4] <- IQR(StudentWt$GainWt)
...
dDiabetesiab$Diff <- Diabetes$SBPfirst - Diabetes$SBPsecond
