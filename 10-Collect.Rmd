...
## Protocols {#Protocols}
\index{Protocols}\index{Data collection}
...
\index{Survey questions}\index{Questionnaires}
...
* *Avoid leading questions*, which may lead respondents to answer a certain way.
  Question wording is the usual reason for leading questions.\index{Leading questions}
* *Avoid ambiguity*:
...
* *Ensure options are mutually exhaustive*, so that answers fit into only one category.\index{Mutually exclusive}
* *Ensure options are exhaustive*, so that the categories cover *all* options.\index{Exhaustive}
...
Question *wording* can be important [@PovertyWording].
...
* *Question order*: The order of he questions can influence the responses.\index{Bias!question order}
* *Interpretation*: Phrases and words such as "Sometimes" and "Somewhat disagree" may means different things to different people.\index{Bias!interpretation}
