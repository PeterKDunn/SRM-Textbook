...
It is better is to ask the two questions separately:
one about *students*, and one about *young professionals*. 
...
1. Are the following survey questions likely to be *leading* questions?
   ...
   * Do you, or do you not, believe that permeable pavements are viable alternative to traditional pavements?
`r if( knitr::is_html_output(exclude = "epub") ) {torf( answer = FALSE )}`
