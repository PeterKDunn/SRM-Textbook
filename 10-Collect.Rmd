...
However, data collection is often time-consuming, tedious and expensive, so getting the data collection correct first time is important.
...
The final **protocol**, or at least parts of it, should appear in the final report.
...
However, the researchers report that (p. 4):
