...
A protocol usually has at least two specific components:

1. How are the individuals chosen from the population (the external validity); and
2. How is the information collected from the individuals (the internal validity).
...
Some of the issues to keep in mind when framing survey questions are:
...
Consider this survey question:\label{thinkBox:QuestionProblem}
...
This separates the two components of the original survey question.
