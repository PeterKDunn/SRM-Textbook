...
* How long do you usually stay in the sun between 11am and 3pm, during a typical day-off in the
summer (June--August)?  
  (possible answers: <30 min, 30 min--1 h, 1--2 h, 2--3 h, >3 h).

1. Critique these questions.
2. What type of variables would be recorded: quantitative (discrete, or continuous) or qualitative (nominal, or ordinal)?
:::
