...
::: {.example #OpenClosedQuestions name="Opena nd closed questions"}
...
2. In which ecosystems are microplastics in Germany? Tick the answer (multiple ticks are possible).  
   Answer options: (a) sea; (b) rivers; (c) lakes; (d) groundwater.
3. Assess the potential danger posed by microplastics.  
   Answer options: (a) very dangerous; (b) dangerous; (c) hardly dangerous; (d) not dangerous.

The first question is an *open question*, where respondents could...
...
1. What type of data would be recorded from each question?
