...
* In the *chemical sciences*, $331$ retractions were reported in 2017 and 2018 due to ethical issues, such as falsification of data and plagiarism [@coudert2019correcting].\index{Plagiarism}
:::
...
For research to be reproducible, the methods, data, analysis methods and relevant computer code must be available [@laine2007reproducible].
...
Statistical software packages, such as python, R, SAS, SPSS and Stata, are recommended.\index{Computers and software!statistical}
