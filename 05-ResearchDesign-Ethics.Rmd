...
*Deception*\index{Deception} is used in some disciplines, and may be approved by ethics committees under certain circumstances (such as the potential benefits of the study, and whether the deception is likely to cause physical or psychological discomfort to the participants).
