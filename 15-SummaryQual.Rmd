...
## Summaring qualitative data {#QualitativeNumbers}
...
::: {.example #AVOdds name="Odds males"}
...
if( knitr::is_latex_output() ) {
  T1 <- kable(surroundMaths(WaterAccessTable2A, 
                      decDigits = c(0, 1, 3)),
        format = "latex",
        longtable = FALSE,
        escape = FALSE,
  ...
  T2 <- kable(surroundMaths(WaterAccessTable2B, 
                      decDigits = c(0, 1, 3)),
        format = "latex",
        longtable = FALSE,
        escape = FALSE,
...
```{r WaterAcessQual, fig.align="center", fig.cap="The age of the women, the number of people in the household, and the number of children in the household for the water-access study. (Some data are missing.)", out.width='100%', fig.width=7.75, fig.height=1.75}
...
dotchart( as.numeric(table(WaterAccess$SourceQueueTime)),
     ...
     xlab = "Number",
     ylab = "",
     main = "Queue wait at water source",
     xlim = c(0, 55),
     las = 1,
     pch = 19)
