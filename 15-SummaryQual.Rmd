...
For qualitative data, a graph shows the *distribution* of the data: the values taken by the variable, and how often they appear.
...
#  for (i in 1:length(tab)){
    ...
    #                    surroundMaths = TRUE ) 
    # )
    out <- cbind( pad2( t(t(tab)),
                       targetLength = 2,
                       digits = 0,
                       surroundMaths = TRUE),
                  pad2( t( t( tab ) / sum(tab) * 100), 
                       targetLength = 4,
                       digits = 1,
                       surroundMaths = TRUE),
                  pad2( t( t(findOdds(x)) ),
