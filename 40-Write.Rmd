...
This is ethical practice (Sect.\ \@ref(Ethics))\index{Ethics}, and includes (based on @brand2015beyond) those who helped with:
...
> Diabetes (odds ratio${} = 3.04$,\index{Odds} confidence interval ${} = 1.25$--$7.40$, $p = 0.014$)...\smallskip
>
