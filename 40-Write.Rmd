...
Counts are usually written in words (i.e., 'three') when less than ten (or sometimes twelve), and otherwise presented using digits ('2\,041').
However, number are written in full when starting a sentence ('Thirty-seven people volunteered').
...
@oyerinde2019investigation reports (p. 1):
