...
The comparison is *within* individuals (Sect.\ \@ref(Intervention)), the RQ is a *repeated-measures* RQ.
...
Paired data arises in studies using a *within-individuals* comparison:
...
Consider the student weight-change study described above.
...
Since this study uses a *within*individuals comparison, an appropriate graph is *a histogram* of the weight *gains* (Chap.\ \@ref(SummariseWithin)).
...
The *histogram* of the weight *gains* makes the change in weight much easier to see and detect (Fig.\ \@ref(fig:ComparePairedBoxplotsHistogram), right panel).
...
(Likewise for the standard error and the median.)
...
Using the jamovi output (Fig.\ \@ref(fig:WeightGainTestOutput)), we can write:
