...
## Sampling distribution for $\bar{d}$ {#SamplingDistMeanDifferencesCI}
...
```{r CaptoriljamoviCI, fig.cap="jamovi output for the Captopril data", fig.align="center", out.width="80%", fig.show="hold"}
...
**Answers to *Qucik Revision* questions:**
