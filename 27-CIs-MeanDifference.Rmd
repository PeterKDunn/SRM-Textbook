...
```{r, child = if (knitr::is_html_output()) {'./introductions/27-CIs-MeanDifference-HTML.Rmd'} else {'./introductions/27-CIs-MeanDifference-LaTeX.Rmd'}}
```
...
Pairing is a form of blocking (Sect.\ \@ref(ExpManagingConfounding)), and is a good design strategy when the individuals in the pair are similar for many extraneous variables.
