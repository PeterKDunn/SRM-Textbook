...
This condition ensures that the *distribution of the sample means has an approximate normal distribution* (so the [$68$--$95$--$99.7$ rule](#def:EmpiricalRule) can be used).
