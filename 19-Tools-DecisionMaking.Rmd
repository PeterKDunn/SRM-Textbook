...
4. You were expecting $\hat{p} = 0.5$ approximately, but instead observed $\hat{p} = 1$.
   What you observed ('all red cards') was not at all like what you were expecting ('about half red cards'); the sample *contradicts* what you were expecting if the pack was fair.
...
`r if (knitr::is_latex_output()) {
   ...
   '(remember the animation above),'
}`
so the statistic is $\hat{p} = 1$ (i.e., $15$\ red cards out of $15$\ cards).
...
That is, there seems to be compelling evidence that the pack of cards is not a fair pack.
...
A student researcher takes a sample of $n = 40$\ students from the School of Arts to determine if students in the School of Arts are somehow different than the general university population in terms of age.

1. What is the null hypothesis?
1. If the student researcher finds $13$\ students in the sample aged over\ $30$, does this present compelling evidence to change your mind?
   Explain.
1. If the student researcher finds $3$\ students in the sample aged over\ $30$, does this present compelling evidence to change your mind?
   Explain.
:::
