...
```{r, child = if (knitr::is_html_output()) {'./introductions/19-Tools-DecisionMaking-HTML.Rmd'} else {'./introductions/19-Tools-DecisionMaking-LaTeX.Rmd'}}
```
...
2. The claim is based on a sample of $125$ pizzas, for which the sample mean pizza diameter was $\bar{x} = 11.48$ inches. 
   (See Sect.\ \@ref(ToolsDecisionMakingIntro).)
