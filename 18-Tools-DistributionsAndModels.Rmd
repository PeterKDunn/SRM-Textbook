...
The rule can even be used for values not exactly align with $1$, $2$ or $3$ standard deviations from the mean.
...
More accurate probabilities of 'areas under the normal curve' are found using tables compiled for this very purpose: see
...
* *Compute* the $z$-score using Eq. \@ref(eq:zscores):
  $\displaystyle z = (5 - 8.8)/2.7 = -2.8/2.7 = -1.41$ to two decimal places.
* *Use* tables:
...
(The online tables are a little more precise: $z = -0.385$.)
