...
From a picture of the situation (Fig.\ \@ref(fig:HtsExer1), left panel), $162 + 7 = 169$c\ m is one standard deviation *above* the mean.
...
More accurate probabilities of 'areas under the normal curve' are found using tables compiled for this very purpose
...
work with $z$-scores to two decimal places, so consider the $z$-score as $z = -2.43$ from Sect.\ \@ref(ApproxProbs).
...
The hard-copy or online tables gives an answer of $0.75$%.
...
* *Shade* the region corresponding to 'greater than $5$\ inches' (Fig.\ \@ref(fig:ZDBH1), centre panel).
...
* *Compute* the answer (Fig.\ \@ref(fig:ZDBH1), right panel):
...
* For $6$ inches: $\quad  z = (5 - 8.8)/2.7 = -1.41$.
...
But this is not the area to that we seek either...
