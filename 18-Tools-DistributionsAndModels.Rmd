...
As seen in Chap.\ \@ref(SamplingVariation), often these sampling distributions are bell-shaped, or *normal distributions*.
The challenge is that only one of these countless possible samples observed.

The normal distributions are a *model* used to describe the *sampling distribution*.
...
We now study normal distributions, as they appear as the sampling distribution for many (but not all) statistics.


## Distributions: an example {#DistributionsExample}
