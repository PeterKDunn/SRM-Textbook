...
The tables (Appendices \@ref(ZTablesNEG) and \@ref(ZTablesPOS)) work with $z$-scores to two decimal places, so consider the $z$-score as $z = -2.43$ from Sect.\ \@ref(ApproxProbs).
...
A retention time of $40$\ hours corresponds to a $z$-score of (Fig.\ \@ref(fig:RetentionPlots), top left panel):  
\[
