...
```{r BagsNormal, echo=FALSE, fig.cap="The sampling distribution is a normal distribution; it shows how the sample mean bag weight varies in samples of size $n = 586$", fig.align="center", fig.width=8.5, fig.height = 3, out.width='90%'}
mn <- 2.8
n <- 586
stdd <- 0.94
