...
**In this chapter**, you will learn about *confidence intervals* for one mean.
You will learn to:
...
Of course, many sample are possible, and every sample is likely to be different, and is likely to produce a different sample mean $\bar{x}$.
