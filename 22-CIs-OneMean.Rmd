...
Since we don't know the *population* standard deviation, and use the *sample* standard deviation instead, the multiplier is a $t$-score.\smallskip
...
```{r BagsNormal, echo=FALSE, fig.cap="The normal distribution, showing how the sample mean bag weight varies in samples of size $n = 586$", fig.align="center", fig.width=8.5, fig.height=2.5, out.width='90%'}
mn <- 2.8
n <- 586
stdd <- 0.94
