...
Our estimate of $\bar{x} = 3.2$ may be a bit smaller than the value of $\mu$, or a bit larger than the value of $\mu$.
...
As the sample size is 'small' (less than $25$), the *population data* must have a normal distribution for a CI to be statistically valid.
