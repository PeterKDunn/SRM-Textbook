...
```{r RollDiceMeanHTML, animation.hook="gifski", cache=TRUE, echo=FALSE, interval=0.5, dev=if (is_latex_output()){"png"}else{"pdf"}}
...
```{r RollDiceHistMeanHTML, cache=TRUE, echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.005, dev=if (is_latex_output()){"png"}else{"pdf"}}
if (knitr::is_html_output()){
  set.seed(123456789)
    num.sims <- 1000
    num.rolls <- 25
