...
* centred around a sampling mean of $\mu_{\bar{x}}$, whose value is $\mu$,
...
<<<<<<< HEAD
```{r BagsNormal, echo=FALSE, fig.cap="The sampling distribution is a normal distribution; it shows how the sample mean bag weight varies in samples of size $n = 586$", fig.align="center", fig.width=9.5, fig.height=2.75, out.width='95%'}
=======
```{r BagsNormal, echo=FALSE, fig.cap="The sampling distribution is a normal distribution; it shows how the sample mean bag weight varies in samples of size $n = 586$", fig.align="center", fig.width=8.5, fig.height = 2.5, out.width='90%'}
