...
```{r RollDiceHistMeanFig, echo=FALSE, fig.align="center", cache=FALSE, fig.width=5, fig.height=3.5, fig.cap="Rolling dice: The mean of 25 rolls, for 1000 repetitions" }
if (knitr::is_latex_output()){
  set.seed(123456789)
    num.sims <- 1000
    num.rolls <- 25
...
```{r BagsNormal, echo=FALSE, fig.cap="The normal distribution, showing how the sample mean bag weight varies in samples of size $n = 586$", fig.align="center", fig.width=7, fig.height=2.5, out.width='80%'}
mn <- 2.8
n <- 586
stdd <- 0.94
...
The article gives the *exact* CI as 77.4 to 99.5&nbsp;kg, agreeing with the approximate CI we calculated.
:::
...
`r if (knitr::is_html_output()) '<!--'`
\begin{wrapfigure}[4]{R}{.25\textwidth}
  \begin{center}
