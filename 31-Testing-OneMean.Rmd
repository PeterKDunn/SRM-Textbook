...
A *sample* of people can be taken to determine whether or not there is evidence that the *population* mean internal body temperature is $37.0$^o^C.
...
* the *sample* mean is $\bar{x} = 36.8052$^o^C,
