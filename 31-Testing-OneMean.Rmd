...
We define the parameter as $\mu$, the population mean internal body temperature (in ${}^\circ\text{C}$).
...
For example, if $\mu$ really is $37.0$, the value of $\bar{x}$ will be *larger* than $37.0357^\circ$C about $16$% of the time (using the $68$--$95$--$99.7$ rule).
...
The value $\bar{x} = 36.8052^\circ\text{C}$ is *extremely* small: a sample mean this low is very unlikely to occur in any sample of $n = 130$ when $\mu = 37.0$.
...
That is, there is compelling evidence that the *population* mean body temperature is *not* $37.0^\circ\text{C}$.
...
@alary1991risk studied $n = 178$ Quebec homes with electric water heaters to see if the mean water temperature was less than $60^\circ$C (i.e., at risk).
