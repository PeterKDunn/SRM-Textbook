...
*Assume* that $\mu = 37.0$ (the accepted value), and the evidence is examined to determine if the evidence supports this claim or not.
The RQ is:
...
This CI is narrow, implying $\mu$ has been estimated with precision, so detecting even small deviations of $\mu$ from $37.0^\circ$C should be possible.
...
@saxvig2021sleep studied the length of sleep for a 'large and representative sample of Norwegian adolescents' aged $16$ and $17$ years of age.
The recommendation is for adolescents to have at least $8$\ hrs of sleep.
