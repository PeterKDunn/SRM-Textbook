...
1. Use the output (Fig.\ \@ref(fig:CarCrashjamovi)) to write down a CI for the difference between the proportions.
...
1. Compute the *proportion* of having a smooth scar (that is, height is $0$\ mm) for women.
1. Compute the *proportion* of having a smooth scar (that is, height is $0$\ mm) for men.
1. Compute the *difference between the proportion* of having a smooth scar, comparing men to women.
1. Write down the CI for the difference between the proportion.
...
Use the jamovi output (Fig.\ \@ref(fig:EarInfPSSOutputCI)) to carefully explain the meaning of both CIs.
:::
...
1. Use the jamovi output (Fig.\ \@ref(fig:TurbinesOutputCI)) to construct a $95$%\ CI for the difference between the proportions.
