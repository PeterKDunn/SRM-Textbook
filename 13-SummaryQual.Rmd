...
\index{Qualitative data!frequency tables}
...
\index{Dot charts!one qualitative variable}\index{Graphs!dot charts}
...
\index{Bar charts}\index{Graphs!bar charts}
...
\index{Pie charts}\index{Graphs!pie charts}
...
\index{Bar charts!compared to other graphs}\index{Pie charts!compared to other graphs}\index{Dot charts!compared to other graphs}
...
A pie chart often makes the message hard to see [@siegrist1996use].\index{Pie charts!warnings}
