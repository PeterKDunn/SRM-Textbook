...
```{r PropOdds, fig.align="center", out.width='90%', fig.width=9, fig.height=4, fig.cap="Proportions (left) are the number of interest divided by the total number; odds (right) are the number of interest divided by the rest."}
...
2. Compute the mode for each qualitative variable, and the percentage and odds of that level occurin in the data.
:::
