...
The distribution of qualitative data can be summarised numerically by computing proportions, percentages (Sect.\ \@ref({#QualitativeProportionsPercentages})), odds (Sect.\ \@ref(QualOdds)), or modes (Sect.\ \@ref({#Modes})); ordinal qualitative data can be also summarised numerically using medians.
...
## Summaries: proportions and percentages {#QualitativeProportionsPercentages}
...
## Summaries: modes and medians {#Modes}
\index{Mode}
