...
The distribution of qualitative data can be summarised numerically (Sect.\ \@ref(QualitativeNumbers)) by computing proportions (or percentages) or odds, modes; ordinal qualitative data can be also summarised numerically using medians.
...
Ordinal qualitative variables maybe numerically summarised using a *median*.
