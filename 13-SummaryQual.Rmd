...
Most quantitative research studies involve qualitative variables
...
### Medians for ordinal data {#QualitativeMedianMeans}
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
Means can very occasionally be used to summarise *qualitative ordinal* data, in rare and very special circumstances.
...
In studies with qualitative variables, these variables should be summarised in a table.
The table should include, as a minimum, numbers and percentages.
While useful in other contexts (see Chap.\ \@ref(CompareQualData)), odds are usually not given in such a summary.
