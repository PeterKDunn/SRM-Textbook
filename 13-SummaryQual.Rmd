...
The levels (Sect.\ \@ref(def:QualData)) should be *exhaustive* (cover all values) and *exclusive* (observations belong to only one category).
...
Instead, the *population* median and mean (the parameter) are estimated by a *sample* median or mean (a statistic). 
