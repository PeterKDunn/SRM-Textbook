...
```{r, child = if (knitr::is_html_output()) {'./introductions/28-Testing-OddsRatios-HTML.Rmd'} else {'./introductions/28-Testing-OddsRatios-LaTeX.Rmd'}}
```
...
ENS[3, ] <- c( paste0("\\text{\\llap{OR:\ }$\\phantom{-}", ENS[3, 1], "}$}"),
               paste0("\\text{\\llap{Difference:\ }$\\phantom{-}", ENS[3, 2], "}$}"),
               NA)
