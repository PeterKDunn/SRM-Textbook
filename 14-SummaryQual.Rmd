...
Some demographic information was collected (Table\ \@ref(tab:AVtable1)), as well as respondents opinions of AVs (Table\ \@ref(tab:AVtable2)).

The gender of the respondent is *nominal*, while the age group is *ordinal*.
The questions about safety (Table\ \@ref(tab:AVtable2)) all yield *ordinal* responses. 
:::
...
## Graphing qualitive data {#QualitativeGraphs}
...
For the AVstudy in Example\ \@ref(exm:AVstudy), a dot chart of the age group of respondents is shown in Fig.\ \@ref(fig:AVDotBarPie) (top left panel).
:::
...
For the AVstudy in Example\ \@ref(exm:AVstudy), a bar chart of the age group of respondents is shown in Fig. \@ref(fig:AVDotBarPie) (top right panel).
:::
...
::: {.example #DotPlotsQual name="Dot plots"}
For the AVstudy in Example\ \@ref(exm:AVstudy), a pie chart of the age group of respondents is shown in Fig. \@ref(fig:AVDotBarPie) (bottom left panel).
:::
...
Qualitative data, as in Tables\ \@ref(tab:AVtable1) and\ \@ref(tab:AVtable1), can be summarised using *proportions* or *percentages*.
These can be given instead of, or with, the counts (as in these tables).
...
This value of $1.04$ is called the *odds* that a respondent is female.
...
The *odds* that a respondents is female is $204\div(400 - 196) = 1.04$%.
...
The responses to the scenarios are *ordinal*.
The mode could be used to summarise each variable:

* The *mode* for gender is 'Female' (with $204$ respondents each).
...
Since $n = 400$, the median response will be halfway between the location of the $200$th and $200$st response when ordered:
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
Means can be used to summarise *quantitative ordinal* data, but only in very special circumstances.
...
::: {.exercise #DotPlotsQual}
A study of spider monkeys [@data:Chapman1990:SpiderMonkeys] examined the types of social groups present (Table\ \@ref(tab:SpiderMonkeys)).
