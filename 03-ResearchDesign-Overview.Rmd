...
Different research studies (Chap.\ \@ref(ResearchDesign)) differ in the extent to which they achieve internal validity.
...
However, the values of the response variable can be influenced by more than just the explanatory variable, such as
