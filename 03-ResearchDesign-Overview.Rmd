...
```{r Influences, fig.cap="Other factors can influence the values of the response variable, besides the explanatory variable.", fig.width=7, fig.align="center", fig.height=2.5, fig.width=7.5, out.width='95%'}
