...
if( knitr::is_latex_output() ) {
  ...
  kable(extraneousTable,
      format = "latex",
      escape = FALSE,
      caption = "The relationships between extraneous, confounding and lurking variables.  Cells with a grey background indicate different types of extraneous variables.",
      longtable = FALSE,
      booktabs = TRUE,
      align = "c") %>%
  add_header_above(c("",
...
if( knitr::is_html_output() ) {
  kable(extraneousTable,
      format = "html",
      caption = "The relationships between extraneous, confounding and lurking variables.",
      longtable = FALSE,
      booktabs = TRUE,
      align = "r") %>%
  add_header_above(c("",
