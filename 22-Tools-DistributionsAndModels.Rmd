...
More formally, bell-shaped distributions are called *normal distributions* or *normal models*.\index{Distributions}\index{Normal distributions}
...
\index{Normal distributions!examples for data}
...
Figure\ \@ref(fig:HistogramDBPPossums) (left panel0 shows the diastolic blood pressure of $398$ Americans [@data:Willems1997:CHD; @data:Schorling1997:smoking].
