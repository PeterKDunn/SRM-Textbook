...
As seen in Chap.\ \@ref(SamplingVariation), sampling distributions often have a *normal distributions* (or bell-shaped distribution).\index{Distributions}\index{Normal distribution}
