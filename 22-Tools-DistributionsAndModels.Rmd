...
The normal distributions are a *model* used to describe the *sampling distribution*:\index{Sampling distribution} how the statistic varies.
...
Normal distributions represent the theoretical distributions of unknown population distributions, not the distribution of data in a sample.
...
For example, every America has a diastolic blood pressure and so is represented in Fig.\ \@ref(fig:HistogramDBPPossums) (left panel); every male Leadbeater's possum has a weight and so is represented in Fig.\ \@ref(fig:HistogramDBPPossums) (right panel). 
...
So the percentages females shorter than $145$\ cm (that is, even further into the tail of the distribution), will be *less* than $2.5$%.
