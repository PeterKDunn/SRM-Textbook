...
The comparison in Fig.\ \@ref(fig:WaterAcessQualCompare) include some categories with small sample sizes, do the percentages shown may not be precise.
...
```{r WaterAcessQualCompare, fig.align="center", fig.cap="Percentage of children with and without diarrhea in the last two weeks, by water source (left) and how often the water vessel was cleaned (right).", out.width='100%', fig.width=9, fig.height = 3}
par(mfrow = c(1, 2),
    mar = c(5, 7, 4, 6) )
