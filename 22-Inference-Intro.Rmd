...
* *Confidence intervals* answer estimation RQ, where the interest is in how precisely a *statistic* estimates a *parameter* (Chaps.\ \@ref(CIOneProportion) to\ \@ref(OddsRatiosCI)).\index{Confidence intervals}
* *Hypothesis tests* answer decision-making RQs, where *decisions* are required. (Chaps.\ \@ref(TestOneProportion) to\ \@ref(TestsOddsRatio))\index{Hypothesis testing}
