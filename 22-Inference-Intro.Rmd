...
* *Hypothesis tests* answer decision-making RQs, where *decisions* are required about a *parameter* based on the value of the *statistic* (Chaps.\ \@ref(TestOneProportion) to\ \@ref(TestsOddsRatio))\index{Hypothesis testing}
