...
if( knitr::is_latex_output()){
  knitr::kable( pad( head(DogsLife[, c(1, 2, 5)]),
         ...
         align = c("r", "c", "c"),
         linesep = "",
         caption = "Information about various dog breeds (using at least $50$\ individuals from each breed were used). The first five breeds only are shown.",
         col.names = c( "Breed", 
	                      "Breed weight (in kg)",
...
Furthermore, the relationship seems somewhat *linear*.
The *correlation coefficient* (from Fig.\ \@ref(fig:DogsLifeScatterjamovi2), right panel)\index{Correlation coefficient (Pearson)} is $r = -0.712$, and $R^2 = (-0.712) ^2 = 50.7$%.
...
```{r CorrelationRemovalEfficiency, fig.cap="The relationship between removal efficiency and inlet temperature. Left: scatterplot. Right: software output.", fig.align="center", fig.width=5, fig.height=5, out.width=c("49%", "45%", "55%", "49%"), fig.show="hold"}
data(Removal)
