...
## Correlation: CIs and tests for $\rho$ {#CorrelationTesting}

### Correlation: CIs for $\rho$ {#CorrelationTesting}
...
```{r ONIcyclones, out.width="70%", fig.align="center", fig.cap="The number of cyclones in the Australian region each year from 1969 to 2005, and the ONI averaged over October, November, December. The cross is located on the line where $x = 0$.", fig.width=6, fig.height=4}
data(Cyclones)
