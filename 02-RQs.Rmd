...
* What is the cost of using PPs in various urban settins?
...
* The **P**opulation (Sects.\ \@ref(Population) and\ \@ref(UnitsObsAnalysis));
...
A study of a certain bird species may only include sites with a confirmed sighting within the last two years.
...
* A *conceptual definition* explains *what* a word or a term *means* in the study.
