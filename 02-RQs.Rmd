...
* *average* amount of wear after $1000$\hs of use.
...
PopInd3[2, ] <- c("Between $3$\\kgs/ha, $4$\\kgs/ha fertilizer rates", 
                  "", 
...
1. Between taking zero, one or two $7$\mgs iron tablet per day.
:::
...
For each emu, they recorded the length of the left and right leg, resulting in $54$ measurements..
