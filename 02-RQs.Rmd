...
```{r RQLeadsTo, echo=FALSE, fig.cap="The RQ drives all aspects of the study", fig.align="center", fig.height=4, fig.width=5.5, out.width = '80%'}
par( mar = c(0.05, 0.15, 0.05, 0.15))
openplotmat()
...
```{r PermPavements, echo=FALSE, fig.cap="A study of permeable pavements (PPs) may have many sub-questions", fig.align="center", fig.height=4.5, fig.width=7, out.width = '100%'}
par( mar = c(0.15, 0.15, 0.15, 0.15))
openplotmat()

pos <- array(NA, 
             dim = c(4, 2))
pos[1, ] <- c(0.50, 0.55) # RQ
pos[2, ] <- c(0.15, 0.65) # sub1
pos[3, ] <- c(0.85, 0.65) # sub2
pos[4, ] <- c(0.50, 0.85) # sub3
...
Because the RQ concerns a large population, the outcome must describe the outcome across many individuals.
...
That is, the comparison is between different groups of individuals, or a **between-individuals comparison**.
...
* Average amount of wear in floor boards (O) could be compared between two groups in the population: standard wooden flooring materials and bamboo flooring.
...
<iframe src="https://learningapps.org/watch?v=pmy2wjmun22" style="border:0px;width:100%;height:850px" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
