...
This is a decision-type RQ, with two possible answers (Fig. \@ref(fig:EchinaceaRQ)): 
Either echinacea *does* result in shorter average cold durations, or it *doesn't*.
...
evidence rarely *proves* a hypothesis (at least, without any other support, such as theortical support).
...
it is reasonable to ask if there is evidence that echinacea helps with a cold in any way.
...
The P, O, C and I do not have to be comprehensively described in the RQ;
some information could be provided later as operational definitions (e.g., dose).
...
That is: The *response* variable is 'the weight of each individual carrot 8 weeks after planting',
and the *explanatory* variable is 'whether or not Thrive was used on each carrot'.
