...
Most statistical software packages use the same approach for organising the data (though exceptions exist for some types of analyses, and in some software).
...
```{r DataPrepjamovi, fig.show="hold", out.width=c('37%', '5%', '53%'), fig.align="center", fig.cap="Software prepared for the data, with some data entered, and the variable names as the column headers. Left: a between-individuals comparison. Right: a within-individuals comparison (including a column of identifying information).", fig.align="center", fig.width=3, fig.height=4}
