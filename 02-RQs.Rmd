...
Examples of variables include: the duration of cold symptoms; sex; tree girth; response to a survey question (Yes, Maybe, No); city of birth; or hair colour.
:::
...
In repeated-measures studies, the variables of interest change over repeated measurements from the same individuals; these are called *within*-individuals variables.
...
PopInd3[1, ] <- c("Before and after", 
                  "", 
                  "When measured on \\emph{each} individual tree")
