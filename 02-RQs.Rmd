...
They also studied the relationship between the DBH for each tree at various times after the planting date (a repeated-measure RQs). 
...
However, the left and right arms for each patient are *not* independent: the left and right arm measurements for each person are likely to be very similar.
