...
PopInd3[1, ] <- c("With number hours of sunlight", 
                  "", 
                  "The number of hours of sunlight received by each \\emph{individual} plant")
...
PopInd3[4, ] <- c("With the percentage aggregate", 
                  "", 
                  "The percentage aggregrate in each \\emph{individual} batch of concrete")
...
if( knitr::is_latex_output() ) {
  kable(PopInd3,
    ...
    kable_styling(full_width = FALSE, 
                  font_size = 10) %>%
    row_spec(0, bold = TRUE) %>% # Columns headings in bold
    column_spec(column = 1, width = "52mm") %>% 
    column_spec(column = 3, width = "91mm")
}
