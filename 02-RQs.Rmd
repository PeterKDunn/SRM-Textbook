...
The groups being compared are either treated differently, or are naturally different.
```
...
that are either *treated differently* (for example, one group is given one dose of fertilizer per day, and another given two doses of fertilizer per day)
or are *naturally different* (for example, one group of people aged under 30, and another group of people aged 30 or over).

If all individuals are treated in the same way, there is no *comparison*.
```
...
between peoiple aged under 40 and people aged 40 or over *does* have a comparison:
