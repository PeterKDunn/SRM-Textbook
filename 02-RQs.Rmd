...
The values of the comparison or connection may be *imposed* on the individuals by the researchers (e.g., dose of a drug), or not be imposed (e.g., age).
...
* *Decision-making*: Among {*the population*}, is {*the outcome*} equal to {*some given value*}?
...
::: {.thinkBox .think data-latex="{iconmonstr-light-bulb-2-240.png}"}
Consider this RQ (based on @data:Maron:eucthreshold):\label{thinkBox:POCIMiners}
...
However, the data to answer this RQ come from a sample of *individuals* in the population.
...
A *response variable* is a variable that records the outcome on individuals in the population.
:::
...
PopInd3[2, ] <- c("Between white oak, beech and bamboo floor boards", 
                  "", 
...
* The number of *columns* is two:
  ...
  There may be a column recording the name ore ID of each individual.  
...
longmcq( c(
   "Descriptive", 
   answer = "Relational",
   "Interventional") )} else {(a) Descriptive; (b) Relational; (c) Intyerventional'}`
6. In what *form* is this RQ?
`r if( knitr::is_html_output()) {
longmcq( c(
   answer = "Decision-making",
   "Estimation") )} else {'(a) Decision-making; (b) Estimation'}`
:::
