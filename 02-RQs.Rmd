...
Repeated-measures RQs with only two comparisons are often called *paired*.\index{Data!paired}\index{Study types!paired}
...
The control group is like a benchmark for detecting changes in the outcome (Sect.\ \@ref(PlaceboEffect)).
