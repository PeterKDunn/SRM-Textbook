...
Repeated-measures RQs with only two comparisons are often called *paired*.\index{Data!paired}\index{Study!paired}
...
The outcome could be *compared* between groups (between those taking echinacea and those who do not).
...
If the study *did have an intervention*, the use of echinacea would be imposed by the reserchers.
...
For this RQ, the *variables* are 'Duration of cold symptoms' (response), and 'Type of treatment' (explanatory).
