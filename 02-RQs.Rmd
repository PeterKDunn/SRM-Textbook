...
Answering estimation RQs is discussed in Chaps.\ \@ref(CIOneProportion) to\ \@ref(OneMeanConfInterval), Chaps.\ \@ref(AnalysisPaired) to\ \@ref(AnalysisOddsRatio), and Sect.\ \@ref(RegressionCI).

*Decisions-making RQs* require a decision to be made about the population, and are answered using *hypothesis tests*.
Answering decision-making RQs is discussed in Chaps.\ \@ref(TestOneProportion) to\ \@ref(TestOneMean), , Chaps.\ \@ref(AnalysisPaired) to\ \@ref(AnalysisOddsRatio), plus Sects.\ \@ref(CorrelationTesting) and\ \@ref(RegressionHT).
