...
```{r PermPavements, fig.cap="A study of permeable pavements (PPs) may have many sub-questions", fig.align="center", fig.height=2, fig.width=7, out.width = '80%'}
par( mar = c(0.10, 0.15, 0.10, 0.15))
openplotmat()
...
```{r EchinaceaRQ, fig.align="center", fig.cap="Two possible answers to the RQ about echinacea", out.width='95%', fig.width=8.25, fig.height=4}
