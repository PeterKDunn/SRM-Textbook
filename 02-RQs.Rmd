...
\index{Conditions}
The *conditions* are the values of the explanatory variable that those in the study experience, but are not manipulated or imposed by the researchers.
:::
...
*Estimation RQs* ask how precisely a *value* in the *population* is estimated by the *sample*.
...
*Decisions-making RQs* require a decision to be made about the population.
...
The units of *observation* are the 'slices': the type of bread (explanatory variable) and the amount of fibre (response variable) are taken from the slice.
...
This means the slices are not independent of each other: they share the same baker and bakery; they were made with the same ingredients, in the same oven, baked at the same temperature, etc.
:::
