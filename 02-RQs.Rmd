...
* *average* amount of wear after $1000$\ h of use.
...
*Relational RQs* compare the outcome for groups of different individuals in the population.
...
The *between-individuals comparison* in a RQ identifies the small number of  groups of different individuals for which the outcome is compared.
:::
...
Similarly, the values of the explanatory variable measured on the individuals distinguish between the values of the *comparison* (Table\ \@ref(tab:RQsPopulationIndividualsExamplesComparison) and\  \@ref(tab:RQsPopulationIndividualsExamplesComparisonWithin)) being made.\index{POCI}
...
The *outcome* is the 'average iron status' (which would need an *operational definition*.) 
The *comparison* is between two groups of individuals: highly active and sedentary women (i.e., between individuals). 
These terms would also need operational definitions!
There is probably no *intervention*: an intervention would mean the *researchers* tell each individual woman to be highly active or sedentary, which seems unlikely.
:::
...
Together, the **P**opulation, **O**utcome, **C**omparison and **I**ntervention form the POCI acronym\index{POCI} (sometimes written as the PICO acronym) to aid remembering the elements of RQs.
...
The *Janka hardness*^[The force required to embed an $11.28$\ mm steel ball into wood to half the diameter of the ball.] of bamboo flooring provided by Bamboo Flooring Australia Pty Ltd was measured by the Queensland Department of Primary Industries [@data:Gerber:BambooFlooring].
...
1. Is the amount of salt the same for homebrand as for non-homebrand beans?
1. Among zoo animals, is the weight of adult elephants greater than that of juvenile kangaroos (joeys)?
