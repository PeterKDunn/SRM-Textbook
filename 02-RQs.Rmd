...
* comparing the average heart rate *across* three groups of people: those who received no dose of a drug, those who received a weekly dose of the drug, and those who received a daily dose of the drug.
...
```{r DataPrepNormaljamovi, fig.show="hold", out.width='55%', fig.align="center", fig.cap="Software prepared for data with no within-individuals variable. Each row represents an individual; each column represents a between-individuals variable.", fig.align="center"}
knitr::include_graphics( "DataPrep/Echinacea/DataPrep.png" )
```
...
```{r DataPrepWithinjamovi, fig.show="hold", out.width=c('51%', '1%', '45%'), fig.align="center", fig.cap="(ref:WideLong)", fig.align="center", fig.width=3, fig.height=4}
knitr::include_graphics( "DataPrep/Students/WideFormat.png" )
knitr::include_graphics( "OtherImages/SPACER.png" )
knitr::include_graphics( "DataPrep/Students/LongFormat.png" )
```
