...
## Comparing quantitative variables: between-individuals {#GraphOneQualOneQuant}
...
`r if (knitr::is_latex_output()) {
   '(Fig.\\ \\@ref(fig:BoxplotGorillasExplain), left panel):'
} else {
   '(Fig.\\ \\@ref(BoxplotGorillasExplain)):'
}`
...
Data to answer this RQ is available from the American NHANES study (see Sect.\ \@ref(NHANESSummaryTable) for more information).
