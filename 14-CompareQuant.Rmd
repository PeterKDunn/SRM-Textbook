...
\index{Quantitative data!to compare \textit{between} individuals}
...
If more than two groups are being compared, the *differences* between one of the group means/medians (the first, or the benchmark, or the initial situation) and the other group means/medians are also usually computed.
...
\index{Dot chart!comparing quantitative data}\index{Graphs!dot chart!two-dimensional}
...
```{r WaterAccessCompareQuantFigs, fig.align="center", fig.cap="Three plots for the water access data in 85 households ($59$ household reported no diarrhoea in children under\\ $5$ years of age; $26$ reported diarrhoea in children under\\ $5$ years of age).", out.width = '100%', fig.width=6, fig.height=2.25}
data(WaterAccess)
par( mfrow = c(1, 3),
