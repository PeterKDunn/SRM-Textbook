...
```{r WaterAccessCompareQuantFigs, fig.align="center", fig.cap="Some plots for the water access data", out.width = '100%', fig.width=7, fig.height=2.25}
data(WaterAccess)
par( mfrow = c(1, 3),
...
boxplot(Age ~ Diarrhea,
     ...
     las = 1,
     names = c( expression(No*":"~italic(n)==59),
                expression(Yes*":"~italic(n)==26))
     )
...
if( knitr::is_latex_output() ) {
    kable(surroundMaths(WACompareQual,
