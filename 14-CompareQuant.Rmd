...
\index{Quantitative data!compare \textit{between} individuals!summary tables}\index{Summary table!compare two means}\index{Mean!difference between}\index{Difference between means}
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
Boxplots summarise data with only five numbers (and are sometimes called the five-number summary)\index{Five-number summary}, so details of the distributions are lost.
