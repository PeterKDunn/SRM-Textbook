...
Whether the mean speed reduction of $5.68$\kms.h^$-1$^ has *practical importance* is a different issue.
...
as the vehicle left the $120$\ km.h^$-1$^ speed zone and approached the $80$\kms.h^$-1$^ speed zone. 
