...
```{r Dentaljamovi, fig.cap="Software output for the sugar-consumption data", fig.align="center", out.width="85%"}
...
```{r BodyTempGenderjamoviHT, fig.cap="Software output for the body-temperature data", fig.align="center", out.width="85%"}
