...
```{r SixSteps, fig.align="center", fig.width=10, fig.height=3.5, out.width="65%", fig.cap="The six basic steps in research"}
...
This book sometimes shows output from the statistical software package jamovi [@Software:jamovi], but using jamovi is *not* essential.\index{Software!jamovi}
:::
...
1. What percentage of the population have side-effects from a medication?\tightlist
