...
This idea was called 'spontaneous generation' (or abiogenesis).
We now know this idea is not correct... but how did the idea emerge?
...
So, a new hypothesis was proposed to explain the appearance of the mice.
This hypothesis was tested against the evidence... and so on.
...
The decision to use qualitative, quantitative or mixed methods approaches should depend on the aim of the research, not the skills or knowledge of the researchers conducting the research.
...
* *Reporting* the results (Chaps.\ \@ref(Reading) and\ \@ref(WritingResearch)).
  Communicating the results appropriately, accurately and ethically is important, including reporting any limitations of the study.
...
* is specifically designed for performing statistical analyses and working with data.


::: {.softwareBox .software data-latex="{iconmonstr-laptop-4-240.png}"} 
In this book, output from the statistical software packages jamovi [@Software:jamovi] is sometimes shown, but using jamovi is not essential.
:::
...
Which of the following are likely to be answered using *quantitative* research studies?

1. What percentage of the population experiences side-effects from a medication?\tightlist
