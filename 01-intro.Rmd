...
This book sometimes shows output from jamovi [@Software:jamovi], but using jamovi is *not* essential.\index{Software!jamovi}
:::
...
1. What is the average number of roof-top solar panels on domestic homes?
`r if( knitr::is_html_output() ) {mcq( c("Qualitative", answer="Quantitative") )}`
