...
A more recently example is the the verdict on the dangers of smoking, which was still being debated into the 1990s:
...
> ... the contention [...] that almost all cases of lung cancer are caused by cigarette smoking seems to be unproven and premature. 
>
...
Hypotheses that have not been contradicted by large amounts of evidence, over a long time, are sometimes referred to as *laws* or *theories*(for example, the 'law of conservation of energy').
...
Problems with using spreadsheets, as with any statistical software package, are often due to human error, but *spreadsheets make the errors hard to find and fix*.
...
The reseaechers noticed that many of those infected were gardeners who had recently handled potting mix.
So the researchers proposed a hypothesis, that the infection "was associated with handling of commercial potting mix" (@data:oconnor:pottingmix, p. 35).
...
They designed a study to test this idea, then collected the data (using a survey) from 100 people (25 people *with* the infection,  and 75 similar ('matched') people *without* the infection).
...
* **Designing** the study: Chaps. \@ref(ResearchDesign) to \@ref(Interpretation).
  In evidence-based research, data are needed to answer the question.
...
* **Describing** and **summarising** the data: Chaps. \@ref(DescribingVars) to \@ref(NumericalQual).
  The data need to be described and summarised.
...
A *qualitative research study* might use two small *focus groups*: one group who *have* purchased EV, and another group who purchased a non-EV.
