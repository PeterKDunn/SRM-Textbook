...
Spontaneous generation was consistent with *observations*: the above process *did* produce mice.
However, this hypothesis ('possible explanation') was rejected when evidence was found that contradicted the hypothesis.
So, a new hypothesis was proposed and tested, and new hypotheses were proposed that were consistent with all the evidence.
...
If the evidence is *consistent* with the hypothesis, the hypothesis is *temporarily* accepted (until contradictory emerges).
...
Research can be broadly classified as *qualitative* or *quantitative*, which are different yet complementary (Table\ \@ref(tab:TypesOfResearch)).
...
* **Collecting** the data: Chap.\ \@ref(CollectingDataProcedures).
  The data collection process must be ethical and clearly documented.
...
*Statistical* software (such as jamovi, Python, R, SAS, SPSS, etc.) is useful for summarising and analysing data.
