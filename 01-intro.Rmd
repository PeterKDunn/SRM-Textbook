...
Both the study design *and* the analysis of data are covered in this book.
...
In the rest of this book, we learn about each of the *six components of research*.
`r if( knitr::is_html_output() ) {
...
* **Designing** the study: Chaps. \@ref(ResearchDesign) to \@ref(Interpretation).
  Once a question is asked, data is needed to answer the question.
  The best way to get that data must be described, by designing a study.
...
* **Analysing** the data: Chaps. \@ref(MakingDecisions) to \@ref(Regression).
  Analysis determines how the data answer the research question.
  Analysis is often tricky, anddepends on the type of data and the research question.
  Computer software is useful in this step.
* **Reporting** the results: Chaps. \@ref(Reading) and \@ref(WritingResearch).
  Clearly communicating the results appropriately, accurately and ethically is important, includes reporting any limitations of the study.
