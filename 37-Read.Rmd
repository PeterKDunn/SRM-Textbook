...
For example, other terms used for *explanatory variables*\index{Variables!explanatory} include *independent variables*, *predictors*, *regressors*, *covariates* [@dunn2016learning].
