...
- To render in R, where `clean = TRUE` keeps the md files (for converting to epub?)
...
Check I need all the ines I'm using, or if I can reduce.


## General

- [x] "Study design" -> "Research design"
- [x] START INDEX!
- [ ] finish index
- In graphs chapter, exercises interpreting boxplots like: About what percentage of X were smaller than x (near lines in the boxes)
...
- [x] Use \usepackage{siunitx}: Check how it goes with latex and html first though...
  > It does not work in HTML... so unfortunately... DO NOT USE
  
## Chap 2:

* DEFINITIONS section out of place??
* [x] Add "sample size"? Make sure *sample* is used then!
* [x] "Between-individuals" and "within-individuals": Have to be associated with the noun "comparison"? This is Chap 3:
...
* [x] Walking Speed Exercise needs answers moved to Answers section
...
* [x] Sect 4,4: "Conditions* experienced by the units.
  *Conditions* has been defined specifically; use a different word. (e.g., circumstances)
...
* [x] Carryover effect: Is it really just with the treatments? 
