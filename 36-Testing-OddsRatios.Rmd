...
In a $2\times 2$ table, the jamovi output can be interpreted in *either* of these ways (i.e., both are correct):
...
The RQ can be written using proportions, odds, or odds ratios.
...
However, these are not directly related to the software output (which works with odds ratios).
...
Here, the test-statistic is a 'chi-squared' statistic,  written $\chi^2$.\index{Test statistic!$\chi^2$-score}
A $\chi^2$ statistic measures the overall size of the differences between the expected counts and observed counts, over the entire $2\times 2$ table.
...
As usual, a very small $P$-value ($0.008$ to three decimals) means very strong evidence exists to supporting $H_1$: the evidence suggests a difference in the *population* odds in the two groups.
We write:
...
A study of $400$ residents of  Klang Valley, Malayasia, examined residents' approach to waste management [@choon2017perception].
One RQ was:
