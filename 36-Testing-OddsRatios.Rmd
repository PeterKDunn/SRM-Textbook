...
The RQ can be written using proportions, odds, or odds ratios can be used.
...
The $\chi^2$-value can be better understood by finding the equivalent $z$-score, which allows a $P$-value to be estimated using the $68$--$95$--$99.7$ rule.
...
The data are shown in Table\ \@ref(tab:B12DataHT).
