...
if( knitr::is_latex_output() ) {
  ...
  kable( (rbind(WAkidsTable,
         ...
         align = "c",
         digits = 2,
         caption = "Numerical summary of the water-access data in $85$ households with children. `All households' are broken into those that reported, and did not report, diarrhea in children under $5$ in the last two weeks.") %>%
...
>  Is the percentage of households with children under\ $5$ having diarrhea the same for households that do and do not keep livestock?
