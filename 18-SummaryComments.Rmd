...
```{r Bar3D2D, out.width=c('50%', '46%'), fig.width=c(4, 4), fig.height=c(4, 4.), fig.align="center", fig.cap="Two plots of the NHANES participants, divided by age group and sex. Left: A three-dimensional bar chart; right: a side-by-side bar chart", fig.show="hold"}
