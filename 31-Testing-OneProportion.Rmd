...
So, I could roll one die, and see how often a 
...
If the die was fair, about one-sixth of rolls would produce a
`r if (knitr::is_latex_output()) {
   '\\Largedice{2}'
} else {
   '<span class="larger-die">&#9857;</span>'
}`
... but not necessarily *exactly* one-sixth, due to *sampling variation*.
