...
```{r, RollsSixesSD, fig.height=3.25, fig.width=9, out.width='90%', fig.align="center", fig.cap="The sampling distribution, showing the distribution of the sample proportion of ones when the population proportion is $1/6$, in $50$ die rolls"}
p <- 1/6
n <- 100
mu <- p
...
\index{Hypothesis testing!one proportion}\index{Test statistic!$z$-score}
...
If the statistical validity conditions are not met, other similar options include using a binomial test\index{Binomial test} [@conover2003practical], or using resampling methods [@efron2021computer].
