...
A confidence interval is an interval which gives a range of values of the population parameter that could plausibly have produced the observed value of the statistic.\index{Confidence intervals}
...
All other things being equal, *larger* samples produce more *precise* estimates of the parameter (Sect.\ \@ref(PrecisionAccuracy)), and hence *narrower* CIs.
