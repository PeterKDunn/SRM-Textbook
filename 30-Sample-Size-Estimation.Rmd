...
* the value of $s$ from the results of a pilot study (Sect.\ \@ref(Protocols)).
...
In Sect.\ \@ref(MeansIndSamples), a CI is computed for difference between the reaction times for drivers *using* and *not using* a mobile phone.
