...
7. While walking at $2.5$\ km.h^$-1$^, the above statistical test resulted in $t = 2.95$.
...
The article states that the mean MMO of males was $54.18$\ mm ($s = 5.21$), and for females was $49.62$\ mm ($s = 3.69$).
