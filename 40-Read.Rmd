...
At some time during your studies or employment, you will need to read research articles: to understand current practices in your discipline; to know *why* your discipline does things as it does; to critique the evidence for current or new practices; and to identify open or unresolved questions in your discipline.
...
Finally, if necessary, read the paper for details.
...
Check the terminology if unsure!
:::
...
2. *Designing the study*:
   ...
   * How was the sample obtained? 
     What are the implications for external validity?
...
4. *Summarising the data*:
   ...
   * What does the summary reveal about the data?
...
* *Asking* the RQ:
  * This is a repeated-measures RQ: data are collected before and after the intervention from the same people.
...
7. The paper reports the $t$-score for comparing MMO for males and females as $t = 10.63$.
