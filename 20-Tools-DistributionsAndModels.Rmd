...
That is, the normal model\index{Model} is often used to describe the *sampling distribution*.\index{Sampling distribution}
...
In theory, no upper limits or lower limits exist for a variable modelled using a normal distribution.
...
```{r EmpiricalRuleHts, fig.width=7.5, fig.height=3.15, out.width='85%', fig.align="center", fig.cap="A model for the height of adult Australian females in the population."}
...
This approach can be used to answer more complicated questions also.
...
```{r DBHBackwards2, fig.cap="Tree diameters: the largest $25$\\% is the same as the smallest $75$\\%.", fig.align="center", fig.width=6, out.width='70%', fig.height=2.65}
par( mar = c(4, 1, 3, 1) )
...
```{r RetentionTime, fig.cap="Retention times of food in sheep.", fig.align="center",  fig.width=6, out.width='70%', fig.height=2.65}
par( mar = c(4, 1, 3, 1) )
out <- plotNormal(42.5,
                  3.68,
