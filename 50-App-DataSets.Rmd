...
allows you to download some of the datasets used in this book.

In the list below (alphabetical within chapters), all datasets are from the **SRMData** package except when noted.
