...
# More about forming CIs {#AboutCIs}
...
```{r ValiditiesCI, echo=FALSE, fig.cap="Three types of validities for studies.", fig.align="center", fig.height=4, out.width="90%"}
...
1. A CI gives an interval in which we are fairly sure that the value of the
`r if( knitr::is_html_output() ) {mcq( c(
           "sample statistic",
