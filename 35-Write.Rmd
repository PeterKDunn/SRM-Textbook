...
<<<<<<< HEAD
These components capture the six-step research process in this book (Fig.\ \@ref(fig:ReportStructure)).\index{Research!six steps}
=======
These components capture the six-step research process used in this book (Fig.\ \@ref(fig:ReportStructure)).
>>>>>>> 9c9590e41cae5cbdfb0df59bd84626514a567d35
...
* what specialised equipment was used (don't list pencils, rulers, paper, etc.).
...
* gives the results from any hypothesis tests and confidence intervals (CIs).
...
* *Average*:\index{Averages}\index{Mean!of a sample}\index{Median!of a sample}
  In research, 'average' refers to *any* way of measuring the typical value (Sect.\ \@ref(ComputeAverage)) including the mean\index{Mean!of a sample} and the median,\index{Median!of a sample} but also other measures too (like geometric means, for instance).
