...
# Reporting research {#WritingResearch}
...
Research needs to be effectively communicated and shared, so the results can be used, evaluated and extended by others.
...
Hence, in this chapter, general comments are made about writing research, rather than giving specific requirements.
...
* *Take care using comparative terms.*  
  For example, writing 'this treatment is *better*' must be clarified; better than *what*? And 'better' in what sense: cost? ease of use? patient outcomes?
* *Use terminology consistently.*  
  Different words may be used for the same concept in research and statistics.
  Use the common term in your discipline; most of all, be consistent.
...
* *Ensure pronouns clearly identify what nouns they refer to.*  
...
* *Ensure verbs and nouns agree*.  
  ...
  For example, writing 'the rats *was* weighed' should be written as 'the rats *were* weighed'. 
  Usually, 'data' is considered plural ('datum' is the singular; 'dataset' is also singular).
  That is, write 'the data *were* right skewed' rather than 'the data *was* right skewed', but the latter use is becoming more common.
  In any case, ensure consistency of usage.
* *Avoid leaps of logic and reaching conclusions unsupported by the given evidence*, including overstating what has been learnt from the study.
  For example, a student project found that the proportion of provisional drivers (those yet to get a full open licence) was higher in the free university car park, compared to paid university car parks.
They concluded that provisional drivers seek to 'save money by parking in free car parks'.  
  This *may* be true, but the evidence does not show this.
  ...
  The proportion may be higher in the free car park as those car parks may be closer to their classrooms for instance.
* *Present the facts in an unbiased manner, and avoid promoting personal opinions*.
  ...
  Because academic writing avoids personal opinions, writing in third person ('the fertiliser was applied') is usually (but not always) preferred over writing in first person ('I applied the fertiliser').
...
Revise your document carefully as many times as necessary.
...
However, one recommendation from the study is to (p.\ 153):

> ... write clearly and simply if you can, and you'll be more likely to be thought of as intelligent.

Another conclusion of the research was that '*needless* complexity leads to negative evaluations...' (p.\ 151; emphasis added).
...
They are used at conferences, workshops, and progress meetings.
Presentations may be given to peers, stakeholders, funding bodies, small groups of other researchers, or work teams.
Presentations should be adapted to suit the time allocated and the target audience: a conference presentation to a group of your research peers should be different from a presentation to a progress meeting.
...
Written documents are more likely to be formally written and prepared than presentations, and generally contain details omitted in presentations.
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
Journal articles, and many other written documents too, should contain sufficient details so that other professionals can repeat the study (Chap.\ \@ref(Protocols)).
:::
...
This is ethical practice (Sect.\ \@ref(Ethics))\index{Ethics}, and includes those who helped with (see @brand2015beyond):
...
List the study objectives (or the RQ, or Aims, as necessary).
* *Methods*: Describe:
- the process of *data collection*.
- the *type* of study.
- the study design features.
...
Writing about research almost always refers to, and builds on, other people's work: to formulate the research question, to establish ideas and to explain the background of the research.
...
Sometimes an *Acknowledgements* section is used to thank and acknowledge other contributions, such as people who supported the research, and research funding bodies.
...
```{r ReportStructure, fig.cap="The connection between the article and the steps we have studied. The Abstract briefly covers all aspects of the study, and the Discussion explains what has been learnt through the process.", fig.align="center", fig.width=5.5, out.width='65%'}
...
The [Glossary] at the end of this book may prove helpful.
...
In general use, 'probability' and 'odds' may be used interchangeably.
...
* $\beta$:\index{Regression parameters}
In research, $\beta$ usually denotes the regression parameters (Chap.\ \@ref(CorrelationRegression)).
* $\rho$:\index{Correlation coefficient (Pearson)}
In research, $\rho$ denotes the population correlation coefficient (Chap.\ \@ref(CorrelationRegression)).
...
They should be written carefully, precisely using the best technically-correct words.
