...
Research needs to be effectively communicated and shared, so the results can be used and evaluated by others.
...
For example, stating that 'there is evidence that this treatment is *better*' must be clarified; better than *what*, and 'better' in what sense (cost? ease of use? patient outcomes?).
