...
```{r RedDeerSlopeSampDistCI, fig.cap="The distribution of sample slope for the red-deer data, around the population slope $\\beta_1$", fig.align="center", fig.height=3.25, fig.width=8.25, out.width='85%'}
mn <- 0
se <- 0.0289
...
out <- knitr::kables(list(T1, T2),
                     format = "latex",
                     label = "Data6MWTAge",
                     caption = "The six-minute walk test (6MWT) distance using a $30$\\ m walkway, and the subjects age.") %>% 
  kable_styling(font_size = 8)
