...
```{r, child = if (knitr::is_html_output()) {'introductions/29-CIs-OneProportion-HTML.Rmd'} else {'introductions/29-CIs-OneProportion-LaTeX.Rmd'}}
```
...
The unknown value of\ $p$ could be a little smaller or a little larger than the value of\ $\hat{p}$; the interval is $\hat{p}$ ive-or-take a little.
More formnally:
$$
