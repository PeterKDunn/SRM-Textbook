...
Pairing (Sect.\ \@ref(PairedIntro)) is a form of blocking\index{Blocking} (Sect.\ \@ref(ManagingConfounding)) and is used to manage confounding.
...
(That is, there is compelling evidence to support the alternative hypothesis.)
...
$$
where the alternative hypothesis is two-tailed, and $\mu$ is the mean difference between first-flowering day for the native skypilot and encroaching willow.
...
The hypotheses are (where $\mu$ represent the mean change in TG (in\ mg.dl^$-1$^) after eight weeks):
...
> There is very strong evidence ($t = 7.19$; two-tailed $P < 0.001$) of a mean change in TG for the chamomile-drinking groups (mean reduction: $38.62$\mgs.dl^$-1$^; $n = 32$; approx. $95$%\ CI: $27.88$ to\ $49.36$\mgs.dl^$-1$^), but *no* evidence ($t = -1.10$; two-tailed $P > 0.10$) of a mean change in the hot-water drinking group (mean reduction: $-7.12$\mgs.dl^$-1$^; $n = 32$; approx.\ $95$%\ CI: $-20.08$ to\ $5.84$\mgs.dl^$-1$^).
...
Suppose water quality was recorded $500$\ m upstream and $500$\ms downstream of $28$\ different copper mines.
...
(These data were also seen in Exercise\ \@ref(exr:PairedCIExercisesBroccoli).)
