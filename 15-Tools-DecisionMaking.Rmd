...
```{r Draw15Cards, echo=FALSE, cache=TRUE, fig.align="center", fig.width=5, out.width = "30%",fig.cap="How likely is it that you would get 15 red cards in a row from a fair pack?" }
