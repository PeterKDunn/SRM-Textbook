...
* HenceEach sample is likely to produce a different value for the statistic, such as the difference between the two sample means.
...
Since we only have one value of the sample statistic, out of the countless possible values, what does this difference between the *sample* means imply about the difference between the *population* means?
...
```{r DecisionFlow2, echo = FALSE, fig.cap = "A way to make decisions", fig.align="center", out.width='100%', fig.width = 9.5, fig.height = 4.75, }
showDecisionMaking()               
```
