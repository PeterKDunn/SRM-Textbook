...
* We could use mathematical theory.
* We could shuffle a pack of cards and deal 15 cards many hundreds of times, then count how often we see 15 red cards of out 15 cards.
* More reasonably, we could *simulate* (using a computer) dealing 15 cards many hundreds of times, and count how often we get 15 red cards of out 15 cards.
...
```{r RollDice10, echo = FALSE, fig.align = "center", fig.width = 6.5, out.width='80%', fig.cap = "Ten hands of 15 cards: The sample proportion that is red varies from hand to hand (as shown on the right-hand side)" , cache = FALSE}
if (knitr::is_latex_output()){
    set.seed(99999)
    num.in.hand <- 15
    num.sims <- 10
...
From this histogram, based on simulating one thousand hands, we could conclude that we would *almost never* find 15 red cards in 15 cards... *if the assumption of a fair pack was true*.
