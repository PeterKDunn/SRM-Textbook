...
```{r HandRedHist1000, fig.align="center", fig.height=4,fig.width=5.25, fig.cap="A histogram of the sample proportion of red cards, in hands of 15 cards, for 1000 repetitions" }
if (knitr::is_latex_output()){
    set.seed(99030991)
    num.in.hand <- 25
    num.sims <- 1000
