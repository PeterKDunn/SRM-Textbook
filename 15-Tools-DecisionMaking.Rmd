...
```{r Draw15Cards, echo=FALSE, cache=FALSE, fig.align="center", fig.width=3.5, out.width = "20%",fig.cap="How likely is it that you would get 15 red cards in a row from a fair pack?" }
