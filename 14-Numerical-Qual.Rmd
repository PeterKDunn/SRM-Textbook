...
Most commonly, qualitative data can be numerically summarised using [**percentages**](#def:Percentage) and [**odds**](#def:Odds).
...
However, sometimes the mean of *ordinal* data is computed if converting the categories into numbers seems appropriate. 
