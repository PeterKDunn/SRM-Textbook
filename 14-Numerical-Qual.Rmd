...
In addition, qualitative data can be numerically summarised using [**percentages**](#def:Percentage) and [**odds**](#def:Odds).
...
For example, *medians* can also be used to numerically summarise *ordinal* qualitative data, but **not** nominal data.
...
The *mode* age group is '15 to 19', since there are more individuals in this age groups than in either of the other two age groups.

Since 'Age group' is *ordinal*, the *median* age group can also be found.
The study includes `r earinfTotal` people, so the median age will be the middle observation: ordered observation `r earingAgeMedianLocation`.
...
colnames(EarInfectionTable) <- c("15 to 19",
                                 ...
                                 "25 to 29",
                                 "Total")
rownames(EarInfectionTable) <- c("Females: No infections",
                                 "Females: Infections",
                                 "Males: Infections",
                                 "Males: No infections",
                                 "Total")
