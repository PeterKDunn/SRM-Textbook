...
However, random allocation was not possible in this study, so the researchers used a different method to manage confounding: *recording* the size of the kidney stones (and also the age and sex of the patient); see Sect.\ \@ref(ObsManagingConfounding).
