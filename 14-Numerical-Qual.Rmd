...
'Gender' is nominal qualitative; all other variables are ordinal.

For the modes:

* Both listed genders contai 150 subjects. 
...
However, *ordinal* data **may be** [numerically summarised like quantitative data](#NumericalQuant) in special circumstance (for example, when the categories are considered 'equally spaced' and a mid-point for each level is sensible).
