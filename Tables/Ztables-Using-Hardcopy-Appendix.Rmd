...
1. Use Appendix\ \@ref(ZTablesNEG) to find $-2.4$ in the *left* margin of the table (Fig.\ \@ref(fig:TablesExampleLaTeXAppendix)).
...
```{r TablesExampleLaTeXAppendix, echo=FALSE, fig.align="center", fig.cap="Using the $z$-score tables.", out.width='50%'}
