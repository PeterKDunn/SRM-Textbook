...
\begin{small}
The table gives the probability (area) that a $z$-score is \textbf{less} than a given value.
For example: For $z = -1.38$, the area \emph{less than} $z = -1.38$ is $0.0838$, or $8.4$\%.
\end{small}
...
\begin{small}
The table gives the probability (area) that a $z$-score is \textbf{less} than the value looked up.
For example: for $z = 1.87$, the area \textit{less than} $z = 1.87$ is $0.9693$ ($96.9$\%).
\end{small}
\end{multicols}
