...
A study [@wright2021chestexamined] 25 gorillas are recorded information about their chest beating and their size (measured by the breadth of the gorillas' backs).
...
GOR <- read.csv("Data/Gorillas.csv")
