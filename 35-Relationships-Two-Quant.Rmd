...
A study [@data:Holgate1965:StraightLine] examined the relationship between the age of $n = 78$ male red deer and the weight of their
...
\captionof{table}{The first 10 observations of the male red deer data ($n = 78$)\label{tab:deerData}}
...
Describe the scatterplot of the diameter against the age of $385$ small-leaved lime trees (@data:ForestBiomass2017; Fig. \@ref(fig:LimeTreesScatter)).\label{thinkBox:DescribeLimeTreesScatter}
...
```{r LimeTreesScatter, fig.cap="The age and diameter of small-leaved lime trees grown in Russia ($n = 385$)", fig.align="center", fig.width=5, fig.height=3.5}
data(lime)
