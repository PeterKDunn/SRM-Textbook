...
```{r NHANESscatterDBPAge, fig.cap="Diastolic blood pressure plotted against age for the NHANES data", fig.align="center", fig.width=5, fig.height=4}
...
```{r MeanScatter, fig.cap="Onion yield plotted against planting density", fig.align="center", fig.width=5, fig.height=4}
data(yieldden)
...
```{r MandiblePlot, fig.cap="The relationship between gestational age and mandible length", fig.align="center", fig.width=5, fig.height=3.5}
data(mandible)
...
```{r SoftdrinkPlot, fig.cap="The time taken to deliver soft drinks to vending machines", fig.align="center", fig.width=5, fig.height=3.5}
data(sdrink)
