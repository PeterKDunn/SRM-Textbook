...
**Statistical hypotheses** refer to the *null hypothesis* and the *alternative hypothesis* that are necessary for formal hypothesis testing.
...
(Answer is here^[About 16% of the time.].)
:::
...
(Answer is here^[Based on the [68--95--99.7 rule](#def:EmpiricalRule), the $P$-value will be *extremely* small.].)
:::
...
`r if( knitr::is_html_output(exclude = "epub") ) {fitb(num=TRUE, tol=0.0001, answer=0.4243)}`
...
`r if( knitr::is_html_output(exclude = "epub") ) {fitb(num=TRUE, tol=0.01, answer=2.35)}`
