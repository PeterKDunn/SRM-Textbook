...
> There is no evidence (paired $t = 0.76$, $P > 0.10$) of a mean difference in the mean change in vigorous PA *during* (compared to *before*) lockdown (sample mean 2.68 minutes greater *during* lockdown; standard deviation: 51.30 minutes; approximate 95% CI: $-4.35$ to $9.71$).
:::
