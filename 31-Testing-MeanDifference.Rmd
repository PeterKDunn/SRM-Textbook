...
\begin{align*}
  \text{Tea group:\qquad}& \text{$H_0$: $\mu_d = 0$\quad$H_1$: $\mu_d \ne 0$};\\
  \text{Hot water group:\qquad} & \text{$H_0$: $\mu_d = 0$\quad$H_1$: $\mu_d \ne 0$}.
\end{align*}
