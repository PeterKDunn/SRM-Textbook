...
```{r InsulationTestNumericaljamovi, echo=FALSE, fig.cap="jamovi output for the insulation data", fig.align="center", out.width="75%"}
...
A study of $n = 213$ Spanish health students [@romero2020physical] measured (among other things) the number of minutes of vigorous physical activity (PA) performed by students *during* and *before* the COVID-19 lockdown (from March to April 2020 in Spain).
These numerical summary of the data are shown in Exercise \@ref(exr:MeanDiffCOVIDCI), so are not repeated here.
We define the *differences* as the number of minutes of vigorous PA *during* the COVID lockdown, minus the number of minutes of vigorous PA *before* the COVID lockdown.
