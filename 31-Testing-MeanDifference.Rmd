...
SoilSummary <- round(SoilSummary, 5)
SoilSummary[1:2, 1] <- round(SoilSummary[1:2, 1], 5)
...
If the difference is defined as the percentage N in *irrigated* sites minus *non-irrigated* sites, the RQ is asking if the mean difference is zero, or if it is less than zero.
