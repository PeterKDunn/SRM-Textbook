...
# CIs: comparing two odds or proportions {#OddsRatiosCI}
...
*Usually, you do not have to compute these expected values*, as software can produce the *expected* counts (see Fig.\ \@ref(fig:UniMealsTestOutputExpectedOnlyjamovi)).
