...
WACompareQual[4, 2:6] <- quantVals( WAKids$HouseholdPeople)
WACompareQual[5, 2:6] <- quantVals( WAKids$HouseholdPeople[WAKids$Diarrhea=="Y"])
WACompareQual[6, 2:6] <- quantVals( WAKids$HouseholdPeople[WAKids$Diarrhea=="N"])

WACompareQual[7, 2:6] <- quantVals( WAKids$HouseholdUnder5s)
WACompareQual[8, 2:6] <- quantVals( WAKids$HouseholdUnder5s[WAKids$Diarrhea=="Y"])
WACompareQual[9, 2:6] <- quantVals( WAKids$HouseholdUnder5s[WAKids$Diarrhea=="N"])
