...
Use the jamovi output (Fig.\ \@ref(fig:NHANESTwoSample))\index{jamovi output!Comparing two means} to construct an appropriate table showing the numerical summary relevant to the RQ.
:::
...
1. Using the jamovi output in Fig.\ \@ref(fig:SpeedjamoviCI), summarise the data numerically, then construct a summary table.
