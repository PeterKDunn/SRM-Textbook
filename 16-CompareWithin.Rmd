...
```{r RunningRM, fig.cap="Vertical oscillation measured using five methods for $15$ runners. The solid black points represent the means for each method.", fig.align="center", out.width='70%', fig.width=6, fig.height=4}
data(Running)
...
plot( x = c(0.75, 5.25),
      ...
      xlab = "Method",
      main = "Case-profile plot for the vertical oscillations\nmeasurements using five methods, for 15 runners",
      axes = FALSE)
...
knitr::kable( pad(IgETable,
              ...
              digits = 1,
              align = c("r", "r", "r", "c"),
              caption = "A numerical summary of the IgE data (in micrograms/L)") %>%
...
Selected answers are available in Sect.\ \@ref(SummariseWithin-Answer).
...
:::{.exercse #CompareWithinPainRelief}
...
Since the number of individuals in large, use the summary data in Table\ \@ref(tab:PainReliefTable) to sketch a plot of the means, like that in Figure\ \@ref(fig:TapeRepeated).
:::
