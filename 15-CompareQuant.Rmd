...
2. Use the software output (Fig.\ \@ref(fig:NHANESTwoSample))\index{Software output!comparing two means} to construct an appropriate table showing the numerical summary relevant to the
`r if (knitr::is_latex_output()) {
  '\\RQperiod'
} else {
  'RQ.'
