# Quantitative data: Comparing between individuals {#WithinQuantData}
...
The numerical summary information for comparing a quantitative between groups can be collated in a table, or a *tabular summary*.
...
boxplot(HouseholdPeople~ Diarrhea,
     ...
     main = "Diarrhea in children under 5\n(85 households)",
     las = 1,
      names = c("No",
                "Yes")
     )
...
if( knitr::is_latex_output() ) {
  tb1 <- cbind( Speed$Speed[Speed$When == "Before"][1:8],
                ...
                c( Speed$Speed[Speed$When == "Before"][33:38], NA, NA, NA ) )
...
if( knitr::is_latex_output() ) {
  tb1 <- cbind( Deceleration$Deceleration[Deceleration$When == "Before"][1:8],
                Deceleration$Deceleration[Deceleration$When == "Before"][9:16],
                Deceleration$Deceleration[Deceleration$When == "Before"][17:24],
                Deceleration$Deceleration[Deceleration$When == "Before"][25:32],
                c(Deceleration$Deceleration[Deceleration$When == "Before"][33:38], NA, NA) )
  T1 <- knitr::kable( pad(tb1,
                          surroundMaths = TRUE,
  ...
  tb2 <- cbind( Deceleration$Deceleration[Deceleration$When == "After"][1:8],
                Deceleration$Deceleration[Deceleration$When == "After"][9:16], 
                Deceleration$Deceleration[Deceleration$When == "After"][17:24], 
                Deceleration$Deceleration[Deceleration$When == "After"][25:32], 
                Deceleration$Deceleration[Deceleration$When == "After"][33:40], 
                c(Deceleration$Deceleration[Deceleration$When == "After"][41], NA, NA, NA, NA, NA, NA, NA) ) 
  T2 <- knitr::kable( pad(tb2,
                          surroundMaths = TRUE,
