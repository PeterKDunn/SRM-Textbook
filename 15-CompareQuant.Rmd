...
If more than two groups are being compared, the *differences* between one of the group means (the first, or the benchmark, or the initial situation) and the other group means are also usually compued.
...
```{r CementBuildBoxplot, fig.cap="Comparing three push-out values for three dental cements.", fig.align="center", fig.height=2.85, fig.width=6.5, fig.show='hold', out.width='85%'}
...
Data to answer this RQ are available from the American *National Health and Nutrition Examination Survey* (NHANES) [@data:NHANES:Rpackage].
