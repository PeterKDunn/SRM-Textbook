# Quantitative data: Summaries for comparing between individuals {#WithinQuantData}
...
\index{Stemplots!back-to-back}\index{Graphs!back-to-back stemplots}
...
### Boxplots {#Boxplot}
\index{Boxplots}\index{Graphs!boxplots}
...
\index{Quantitative data!compare between individuals!summary tables}
...
```{r}
if( knitr::is_latex_output() ) {
  tb1 <- cbind( Speed$Speed[Speed$When == "Before"][1:8],
                Speed$Speed[Speed$When == "Before"][9:16],
                Speed$Speed[Speed$When == "Before"][17:24],
                Speed$Speed[Speed$When == "Before"][25:32],
                c( Speed$Speed[Speed$When == "Before"][33:38], NA, NA ) )
  ...
  tb2 <- cbind( Speed$Speed[Speed$When == "After"][1:8],
                Speed$Speed[Speed$When == "After"][9:16], 
                Speed$Speed[Speed$When == "After"][17:24], 
                Speed$Speed[Speed$When == "After"][25:32], 
                Speed$Speed[Speed$When == "After"][33:40], 
                c( Speed$Speed[Speed$When == "After"][41], NA, NA, NA, NA, NA, NA, NA) )
