...
```{block2, tytpe="rmdimportant"}
One of the most important points about writing in the scientific disciplines
is to write *carefully* and *precisely*:

* Think carefully about the words you use: You do not want to just be understood,
  you need to make sure that you *can't* be misunderstood.
...
`r if (knitr::is_latex_output()) '<!--'`
```{r, echo=FALSE, out.width= "30%", out.extra='style="float:right; padding:10px"'}
include_graphics("Illustrations/writing-828911_1920.jpg")
```
`r if (knitr::is_latex_output()) '-->'`
