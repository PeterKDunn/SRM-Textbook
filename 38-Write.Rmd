...
One of the most important points about writing in the scientific disciplines
is to write *carefully* and *precisely*:
...
* Write what you mean.
* Mean what you write.
* Be careful using words whose meaning are *lexically ambiguous* [@richardson2013identification; @dunn2016learning]:
  Words with different meanings in science and in every-day use (Sect. \@ref(LexicalAmbiguity)).
:::
...
As noted in Sect. \@ref(Chap37-Intro),
writing *carefully* and *precisely* is incredibly important in science.

One aspect of writing well is using *lexically ambiguous words* carefully.
*Lexically ambiguous words* have a different meaning in other scientific disciplines,
or in their usual every-day use [@richardson2013identification; @dunn2016learning].
If you are unsure of the definitions used in this book, 
make use of the Glossary (Appendix \@ref(Glossary)).
...
Furthermore, some *symbols* may have different meanings in research and statistics than in some other scientific disiplines;
again, care is needed when using these symbols:
...
suppose Fig. \@ref(fig:ResultsPlot)
and Tables \@ref(tab:ResultsTable)
were produced.
...
that use disposable cups on [the university] Campus is the same'.
