...
## Beyond $2\times 2$ tables {#CompareManyProportions}

Often a tables of counts is larger than $2\times 2$.
In these situations, the RQ is worded in terms of *relationships* or *associations* (but *not* correlations) between the variables:
