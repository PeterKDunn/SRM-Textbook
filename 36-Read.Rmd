...
The *Discussion* section includes the following statements.
...
* The researchers listed limitations\index{Limitations!research design (effectiveness)} of the study, including that the sentence typed by the subjects was unchanged in both Trials\ 3 and\ 4; hence, Trial\ 4 may have been easier than the previous trial as the sentence was familiar (teh carryover effect)\index{Carryover effect}.
