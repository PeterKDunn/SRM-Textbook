...
* The *sample*\index{Sample} comprises students from the University School of Physical Education (Poland) studying a course in gait analysis.
  This sample may not represent any general population, though the conclusions may apply to non-students and not-Polish people.\index{External validity}
...
person walks most naturally).
  ...
  3. Task\ 1 was repeated, but with subjects continuously typing a sentence on a cell phone. 
  4. Task\ 2 was repeated, but with subjects continuously typing a sentence on a cell phone.
...
* Correlations were computed between the left-side stride length, right-side stride length, and walking velocity.
  ...
  All correlation coefficients were positive, and the corresponding $P$-values were all less than $0.05$, suggesting positive (non-linear) relationships between the variables.
...
* Nine hypothesis tests were conducted: the three between-tasks comparison listed above, for the three response variables.
...
* Mean stride length was smaller for Task\ 1 compared to Task\ 3, and for Task\ 2 compared to Task\ 4 (i.e., while texting), for both left-side and right-side strides.
* The researchers also made qualitative observations;\index{Research!qualitative} for example:  they observed 'moments when the subject took their eyes off the phone in order to assess the direction of the path' (p.\ 5).
...
20. What could explain the *increase* in sleep duration, if the control group used an ineffective intervention? 
