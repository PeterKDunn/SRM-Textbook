...
```{r DiceMeanNormal, fig.cap="The sampling distribution is an approximate normal distribution with mean\ $3.5$ and standard error\ $0.5$;  it is a model of how the mean roll varies when a die is rolled $25$ times.", fig.align="center", fig.width=9.5, fig.height=2.75, out.width='95%'}
...
11. Do you think that, on average, the pizzas do have a mean diameter of $12$\ inches in the population, as Eagle Boy's claim?
    Explain.
:::
...
6. What is an approximate $95$%\ CI for the mean for Claire's sample?
7. 'Aha,' said jake; 'I told you so!
