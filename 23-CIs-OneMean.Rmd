...
The multiplier woud be a $z$-score if the value of the *population* standard deviation was known (e.g., the situation in Sect.\ \@ref(SamplingDistSampleMeanSigmaKnown)).
...
All we can reasonably do is to identify (from the sample) whether the populations is likely to be non-normal (when the CI would be not valid).
