...
Suppose thousands of people made one sample of $25$\ rolls each, and computed the mean for their sample.\index{Mean!of a sample}
...
The CI for a single mean is *statistically validity* if *either* of these is true:
...
6. What is an approximate $95$%\ CIl for the mean for Claire's sample?
7. 'Aha---I told you so!  
