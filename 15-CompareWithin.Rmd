...
Sometimes the same variable is measured on each unit of analysis twice, when the *changes* (or *differences*) for each individual can be produced, and a histogram construct.
...
[*Dataset*: `Running`] Create a summary table for the data in Example\ \@ref(exm:CaseProfileRunning). 
:::
