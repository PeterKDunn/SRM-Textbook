...
The answer can also be expressed as a *percentage*: 'the probability of rolling a `r include_graphics("Dice/die4.png", dpi=1250)` is (approximately) $16.67$%'.
The answer could also be interpreted as 'the *expected* proportion of rolls that are a `r include_graphics("Dice/die4.png", dpi=1250)` is (approximately) $0.1667$'.
