...
* **Internal validity** (Sect. \@ref(IntroInternalValidity)):
  Discuss what study design features may compromise the internal validity of the study (such as identifying possible confounding variables).
...
They note that taste-testing studies should:
...
A discussion of the limitations of internal validity should cover, as appropriate: possible confounding variables; the impact of the carry-over, Hawthorne, observer and placebo effects; the impact of any other design decisions.
...
A study [@axmann2020access] randomly allocated Ugandan farmers to receive, or not receive, hybrid maize seeds.
The random allocation is good for internal validity.
However, the authors identified one threat to internal validity: 

> One worry is that farmers not receiving the offer could directly benefit from the intervention through receiving seeds from their peers.
>
> --- @axmann2020access, p. 220

To ensure this was not occurring, the researchers conducted follow-up phone calls to the 75 farmers allocated to receive the hybrid seeds; none of the 30 farmers who could be contacted reported selling or giving seeds to other farmers. 
...
External validity refers to the ability to *generalise* the results to the entire intended population, based on the sample studied (Sect. \@ref(InternalExternalValidity)).
...
If the RQ is 'Among Alaskans, what proportion own a smart speaker?', then the study is externally valid if the sample is representative of Alaskans.
The results **do not** have to apply to people in the rest of the United States (though this can be commented on, too).
The intended population, as given in the RQ, is *Alaskans*.
:::
...
The women in the sample were 'women of South Asian origin living in New Zealand [...] recruited using a convenience sample method throughout Auckland' (@data:Gammon2012:B12, p. 21).
...
A study is *ecologically valid* if the study methods, materials and context approximate the real situation of interest.
:::
...
This may not be ecologically valid, as how people *act* may not align with what they *say*, especially when social pressures may exist to use reusable cups.
...
## Study designs and limitations {#StudyDesignsLimitations}
