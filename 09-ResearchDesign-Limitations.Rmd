...
## Limitations: internal validity {#InterpretStudyDesign}\index{Limitations!Study design (effectivess)}
...
## Limitations: external validity {#InterpretGeneralisability}\index{Limitations!external validity (eneralizability)}
...
## Limitations: ecological validity {#InterpretApplicability}\index{Limitations!Ecological (practicality)}
...
## Study types and limitations {#StudyDesignsLimitations}\index{Limitations!study design}
...
Many experiments also require that people be told about being in a study (due to ethics), and so internal validity may be comprised (the [Hawthorne effect](#HawthorneEffectExperimental)).
...
Fill the blanks with the appropriate word: *internal*, *external* or *ecological*.

When interpreting the results of studies, we consider the practicality (`r if( knitr::is_html_output() ) {mcq( c(
                     "internal",
                     "external",
                     answer = "ecological") )} else {"________________"}` validity),
