...
Smoking was once promoted as healthy and beneficial.
One 
`r if (knitr::is_latex_output()) {
   'advertisement for Camel cigarettes'
} else {
   '[advertisement for Camel cigarettes](https://www.news.com.au/technology/science/human-body/the-time-before-cigarettes-were-bad-for-your-health/news-story/7c3e11e6f0dc774eacbafb49f2a09078)'
}`
claimed that 
`r if (knitr::is_latex_output()) {
...
In fact, the company that owned Camel cigarettes (RJ Reynolds) conducted the survey, company staff interviewed doctors, and *RJ Reynolds provided free cartons of Camel cigarettes* to the doctors.
