...
The results should be discussed in light of what the study actually tells, and what it doesn't actually tell us.
...
* **Internal validity** (the *effectiveness* of the study in the sample): 
	The steps taken to maximise the internal validity of the study, and the impacts of these on the interpretation of results (Sect. \@ref(InterpretStudyDesign)).
* **Ecological validity** (the *practicality* of the results to real life): 
	...
	how the study methods, materials and context approximate the real situation being studied.
...
*Identifying* these limitation, and *discussing the impact* that they have on the interpretation of the study results, is important and ethical.
:::
...
An [advertisement for Camel cigarettes](https://www.news.com.au/technology/science/human-body/the-time-before-cigarettes-were-bad-for-your-health/news-story/7c3e11e6f0dc774eacbafb49f2a09078) once claimed that '[More doctors smoke Camels](https://www.youtube.com/watch?v=gCMzjJjuxQI) than any other cigarette' based on a survey of 113 597 doctors.
That certainly is a *large* sample... but understanding how the data were collected is important.

In fact, the company that owned Camel cigarettes ([RJ Reynolds Tobacco Company](https://en.wikipedia.org/wiki/R._J._Reynolds_Tobacco_Company)) conducted the survey (which raises suspicions immediately).
Even worse, [RJ Reynolds](https://rjrt.com/) staff interviewed doctors and asked about their smoking habits *after RJ Reynolds provided free cartons of Camel cigarettes* to the doctors.
...
External validity refers to the *applicability* or the *generalisability* of the results to the *target* (or *intended*) population (Example \@ref(exm:AirConUse)), which depends on how the sample was obtained.
...
A study of using biochar [@farrar2018short] to grow ginger only used one farm at Mt Mellum, Australia.
...
That is, an internally valid study is *effective* in demonstrating that the conclusions made from the sample cannot be explained any other way.
...
That is, when participants knew they were being studied, they may have given responses that made their own behaviours appear better than their colleagues.
...
Although ecological validity is not essential for a good study, ecological validity is useful if it is possible to achieve.
...
Consider a study to determine how likely it is that people will buy a coffee in a reuseable cup.

We could *ask* people about their *intentions*.
This study may not be ecologically valid, as how people *act* in the real world may not align with what they *say*, especially when social pressures exist to use reusable cups.
...
:::{.exampleExtra data-latex=""}
A study was completed to observe the effect of using high-mounted rear brake lights [@data:Kahgane1998:RearBrakeLights], which are now commonplace.
...
A study [@bingham2016peer] examined the effect of peer pressure from passengers among teenage male drivers; the aim was to
...
The *Discussion* section of the article includes a subsection called 'Strengths and limitations'.
