...
External validity refers to the ability to *generalise* the results to the entire intended population, based on the sample studied (Sect. \@ref(IntroExternalValidity)).
