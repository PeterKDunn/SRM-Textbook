...
```{example name="External validity"}
A New Zealand study
[@data:Gammon2012:B12]
...
```{example name="Internal validity"}
...
The *practical* of the study results
in the real worldshould also be discussed.
...
```{example name="Ecological validity"}
