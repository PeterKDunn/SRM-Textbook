...
:::{.exampleExtra #LimitationsFoodChoices name="Limitations"}
...
:::{.exampleExtra #LimitationsLights name="Limitations"}
...
When interpreting the results of studies, we consider the practicality
...
Internal validity refers to issues such as
`r if( knitr::is_html_output(exclude = "epub") ) {mcq( c(
                     answer = "confounding",
                     "sampling") )}`
