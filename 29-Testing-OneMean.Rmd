...
The mean of this distribution is $\mu_{\bar{x}} = 37$ and the standard deviation of this distribution is the *standard error*: the amount of variation in the sample means across all possible samples.
