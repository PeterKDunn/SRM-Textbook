...
Summarising the data is important, because the using data is how the RQ is answered (Fig. \@ref(fig:BodyTempHist)); the internal body temperature of individuals varies from person to person.
...
OneMeanNotation <- array( dim = c(4, 4))

OneMeanNotation[1, ] <- c("Individual values in population, $x$",
                          "?",
                          "$\\mu$ (unknown)",
                          "$\\sigma$ (unknown)")
OneMeanNotation[2, ] <- c("Individual values in sample, $x$",
                          "Plot histogram",
                          "$\\bar{x}$",
                          "$s$")
OneMeanNotation[3, ] <- c("Sample means across all",
                          "Approx. normal",
                          "$\\mu_{\\bar{x}}$",
                          "$\\text{s.e.}(\\bar{x})$")
OneMeanNotation[4, ] <- c("\\null\\quad possible samples",
                          "(conditions apply)",
                          "(unknown)",
                          "(estimated using $s/\\sqrt{n}$)")
