...
OneMeanNotation[1, ] <- c("Describe individual values in population, $x$",
                          "?",
                          "$\\mu$",
                          "$\\sigma$")
OneMeanNotation[2, ] <- c("Describe individual values in sample, $x$",
                          "From histogram",
                          "$\\bar{x}$",
                          "$s$")
OneMeanNotation[3, ] <- c("Describe sample means across",
                          "Approx. normal",
                          "$\\mu_{\\bar{x}}$",
                          "$\\text{s.e.}(\\bar{x})$")
