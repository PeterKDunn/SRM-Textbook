...
* $z$-scores are calculated if *no sample information* (except the sample size) is used to compute the standard error (as with a test for proportions (Chap. \@ref(TestOneProportion)).
* $t$-scores are calculated if *some sample information* (beyond the sample size) is used to compute the standard error (as in this chapter).
