...
if( knitr::is_latex_output() ) {
  ...
  out <- knitr::kables(list(T1, T2),
                       format = "latex",
                       label = "DataBodyTemp",
                       caption = "The body temperature data: Ten of the 130 observations") %>% 
...
if( knitr::is_latex_output() ) {
  kable(RTimeArray,
    ...
    kable_styling(font_size = 10) %>%
  add_header_above(header = c("Recovery times" = 9), 
                   bold = TRUE, 
		   align = "c")
}
