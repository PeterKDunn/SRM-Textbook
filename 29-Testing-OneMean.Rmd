...
* 'Big' $P$-values mean that the sample statistic (i.e., $\bar{x}$) could reasonably have occurred through sampling variation, if the assumption about the parameter (stated in $H_0$) was true (Fig. \@ref(fig:BigSmallP), left panel).
  The data **do not contradict** the assumption ($H_0$).

* 'Small' $P$-values mean that the sample statistic (i.e., $\bar{x}$) is unlikely to have occurred through sampling variation, if the assumption about the parameter (stated in $H_0$) was true (Fig. \@ref(fig:BigSmallP), right panel).
