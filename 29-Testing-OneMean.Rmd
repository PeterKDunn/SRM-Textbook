...
```{r, child = if (knitr::is_html_output()) {'./introductions/29Testing-OneMean-HTML.Rmd'} else {'./introductions/29Testing-OneMean-LaTeX.Rmd'}}
```
...
**1.** 0.4243
**2.** The population mean is 13g.
**3.** 2.35.
**4.** Small.
**5.** There \emph{is} evidence.
:::
`r if (knitr::is_html_output()) '-->'`
