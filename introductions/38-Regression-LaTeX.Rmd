...
\begin{itemize}\tightlist
  ...
  \item
  conduct hypothesis tests for the slope (and intercept) of a regression line.
  \item
  produce confidence intervals for the slope (and intercept) of a regression line.
\end{itemize}
\end{objectivesBox}
