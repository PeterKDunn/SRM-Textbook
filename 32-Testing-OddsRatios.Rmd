...
(related to the size of the table^[For those who want to know: the degrees of freedom in a two-way table is the number of rows of data minus one, times the number of columns of data minus one. So, for a $2\times 2$ table, the degrees of freedom is $(2 - 1) \times (2 - 1) = 1$.]), 
