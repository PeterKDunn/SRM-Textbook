...
Notice that the two groups (students who live with parents; students who do *not* live with parents) contain different students.
...
Since both variables observed on each student (the unit of analysis) are qualitative, means are not appropriate.
However, the data can be compiled into a two-way table of counts (Table \@ref(tab:MealsDataTableHT)).
