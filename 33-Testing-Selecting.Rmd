...
For the situations studied in this book, identifying the *number* of variables and the *type* of variables (qualitative or quantitative) is important (Table\ \@ref(tab:InferenceTestCI2)).
...
if( knitr::is_latex_output() ) {
  ...
  kable(Scenarios[ , c(1, 2, 4, 3)],
        ...
        caption = "Five scenarios studied so far, plus one to follow (correlational RQs).",
        format = "latex") %>%
