...
[*Dataset*: `NHANES`]
Earlier, the <span style="font-variant:small-caps;">bhadp</span> study (Exercise\ \@ref(exr:CompareQuantExercisesNHANES)) was used to summarise the data used to answer this RQ:
