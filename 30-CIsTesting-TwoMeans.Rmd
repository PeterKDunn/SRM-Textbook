...
The standard error for the statistic was found is $\text{s.e.}(\bar{x}_T - \bar{x}_W) = 8.42$.
...
Sketch the sampling distribution for the difference between the mean speeds before and after adding extra signage, in Sect.\ \@ref(SpeedSignage).
:::
