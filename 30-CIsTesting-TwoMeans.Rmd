...
The CI and test for comparing two means is *statistically validity* if *either* of these is true:
...
* when one or both groups have $25$\ or fewer observations, *and* the *populations* corresponding to both comparison groups have an approximate normal distribution.
