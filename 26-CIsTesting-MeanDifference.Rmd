...
```{r, child = if (knitr::is_html_output()) {'./introductions/32-CIs-MeanDifference-HTML.Rmd'} else {'./introductions/32-CIs-MeanDifference-LaTeX.Rmd'}}
```
...
The notation used is (Table\ \@ref(tab:PairedNotation)):
...
## Hypothesis tests for $\mu_d$  {#MeanDiffTest}
\index{Sampling distribution!paired quantitative data}
