...
A *simple event* is any elements of the sample space.
...
We do not know beforehand what distance your next throw will be, but the *sample space* (the throwing distance) could be anywhere between (say) $0$ and $200$ metres (and some of those distances are *very* unlikely to occur...).
...
Events of interest are often combinations of other events, often combined using **and** and **or**.
...
Event $A$ comprises the events `r include_graphics("Dice/die2.png",dpi=1250)`, `r include_graphics("Dice/die4.png", dpi=1250)` and `r include_graphics("Dice/die6.png", dpi=1250)`, and event $B$ comprises the events `r include_graphics("Dice/die3.png",dpi=1250)` and `r include_graphics("Dice/die6.png", dpi=1250)`.
...
* The probability of receiving rain on any future day in Sydney is between $0$ and $1$ inclusive.
:::
...
$289\ 603$ live births occurred, with $148\ 636$ male births, $140\ 944$ female births, and $23$ others (or 'not stated') in 2021.
