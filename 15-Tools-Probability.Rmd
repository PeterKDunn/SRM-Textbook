...
Probabilities are similar to proportions, but concern unknown future events.

Before discussing probability, some associated terms needs defining.
For example, a 'random procedure' is one that can be repeated, in theory, indefinitely under essentially identical conditions; has well-defined results; and the result of any individual repetition is unpredictable.
...
The data in Table\ \@ref(tab:SkipBreakfast2) are from a study of Iranian children aged 6--18 years [@data:kelishadi2017:snack].\label{thinkBox:FindProbs}
