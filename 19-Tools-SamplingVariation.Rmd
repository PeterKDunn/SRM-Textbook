...
```{r RouletteWheel, fig.cap="A European roulette wheel, with numbers\\ $0$ to\\ $36$.", echo=FALSE, out.width = "42%", fig.align="center", fig.width = 3.15, fig.asp=1}
# Wheel  
DD <- 10
dd <- 4
...
The value of the sample statistic that is observed depends on which one of the countless samples is selected.
