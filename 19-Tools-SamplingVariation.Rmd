...
```{r RouletteWheel, fig.cap="A European roulette wheel, with numbers\\ $0$ to\\ $36$. The ball has landed on\\ $32$.", echo=FALSE, out.width = "42%", fig.align="center", fig.width = 3.15, fig.asp=1}
# Wheel   
DD <- 10
dd <- 4
