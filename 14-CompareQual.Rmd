...
\index{Bar chart!side-by-side}\index{Graphs!side-by-side bar chart}
...
if( knitr::is_latex_output() ) {
  kable(pad(WAKidsTab,
        ...
        col.names = c("in children", 
                      "in children"),
        caption = "Cross-tabulation of having livestock in the household, and children under $5$ having diarrhoea in the household in the last two week") %>%
    row_spec(0, bold = TRUE) %>%
    kable_styling(font_size = 8) %>%
    add_header_above( c(" " = 1,
