...
[*Dataset*: `WCTennis`]
@alberca2022sprint record the push-time for French wheelchair tennis players, while holding a racquet and not holding a racquet (Table\ \@ref(tab:WCTennis); @alberca2022sprintDATA).
...
if( knitr::is_latex_output() ) {
  kable(pad(WCTennis,
        ...
        escape = FALSE,
        align = "c",
        caption = "The wheelchair-tennis data.") %>%
    row_spec(0, bold = TRUE) %>%
    add_header_above( c(" " = 1,
                        "Push time (in s)" = 2,
                        " " = 1),
