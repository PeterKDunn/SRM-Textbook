...
\newenvironment{objectivesBox}[1]
  ...
  \setlength{\fboxsep}{1em}
  \begin{objectivescolourbox}\setlength{\parskip}{2mm}
  \item
  }
  {
...
\newtcolorbox{EOCanswercolourbox}{
  ...
  \setlength{\fboxsep}{1em}
  \begin{EOCanswercolourbox}\setlength{\parskip}{2mm}
  \item
  }
  {
...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{2mm}% Gap between above text, and top of box/shading  
   \begin{quote}\setlength{\parskip}{2mm}%
   \vspace{-7mm}% Gap between top of box/shading and the start of the text that is inside the box
   \origdefinition}%
  {\origenddefinition\end{quote}\vspace{2mm}\endgroup}}% Gap between bottom of box/shading and the start of the text below
...
\renewenvironment{example}%
  ...
  \begin{quote}\setlength{\parskip}{2mm}%
  \vspace{-7mm}% Gap between top of box/shading and the start of the text that is inside the box
  \origexample}% Last vspace adjusts space between start of gray box, and start of text
  {\origendexample\end{quote}\vspace{2mm}\endgroup}}% Gap between bottom of box/shading and the start of the text below
...
\renewenvironment{exercise}%
  ...
  \vspace{-6mm}\origexercise}%
  {\origendexercise\vspace{-2mm}\endgroup}}
...
{\origendquote\vspace{-0.25\parskip}}% Gap between text below, and bottom of quote shading
