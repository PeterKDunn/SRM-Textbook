...
%%% Answer boxes
\definecolor{QRAnswerColour}{RGB}{237, 233, 251}
\newtcolorbox{QRanswercolourbox}{
  colback=QRAnswerColour,
  colframe=QRAnswerColour,
  coltext=black,
  boxsep=5pt,
  arc=4pt}
  
  \newenvironment{QRanswerBox}[1]
  {\small
  ...
  \setlength{\fboxsep}{1em}
  \begin{QRanswercolourbox}
  \item
  }
  {
  \end{QRanswercolourbox}
  \end{itemize}
  }  


%%% End of chapter answer boxes
\definecolor{EOCAnswerColour}{RGB}{237, 233, 251}
...
\newenvironment{answer}
  {\null\vspace{-1mm}\small}
  {\null\vspace{-1mm}} %{\smallskip}
