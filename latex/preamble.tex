...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{2mm}\begin{quote}\setlength{\parskip}{2mm}\vspace{-7mm}\origdefinition}%
...
\renewenvironment{exercise}%
  {\small\begingroup\setlist{nosep,topsep=-0.8\parskip}\vspace{5mm}\setlength{\parskip}{1.5mm}\vspace{-6mm}\origexercise}%
...
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{3mm}\begin{quote}\setlength{\parskip}{2mm}\vspace{-7mm}\origexample}% Last vspace adjusts space between start of gray box, and start of text
