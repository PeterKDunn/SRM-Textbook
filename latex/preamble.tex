...
\renewenvironment{exercise}%
  {\small\begingroup\vspace{2mm}\setlength{\parskip}{2mm}\vspace{-6mm}\origexercise}%
...
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{2mm}\begin{quote}\setlength{\parskip}{2mm}\vspace{-9mm}\origexample}%
