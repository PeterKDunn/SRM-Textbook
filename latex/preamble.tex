...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{2mm}\begin{quote}\setlength{\parskip}{2mm}\vspace{-6mm}\origdefinition}%
...
\renewenvironment{exercise}%
  {\small\begingroup\setlist{nosep,topsep=-0.8\parskip}\vspace{2mm}\setlength{\parskip}{1.5mm}\vspace{-6mm}\origexercise}%
  {\origendexercise\vspace{1mm}\endgroup}}
    
\AtBeginDocument{%
\let\origendexample=\endexample%
\let\origexample=\example%
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\vspace{2mm}\begin{quote}\setlength{\parskip}{3mm}\vspace{-9mm}\origexample}%
