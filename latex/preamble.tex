...
\renewenvironment{definition}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\begin{quote}\vspace{-4mm}\origdefinition}%
  {\origenddefinition\end{quote}\vspace{-5mm}\endgroup}}
  
\AtBeginDocument{%
\let\origendexample=\endexample%
\let\origexample=\example%
\renewenvironment{example}%
  {\begingroup\definecolor{shadecolor}{RGB}{242, 242, 242}\begin{quote}\vspace{-4mm}\origexample}%
  {\origendexample\end{quote}\vspace{-5mm}\endgroup}}
