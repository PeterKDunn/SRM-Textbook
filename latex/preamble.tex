...
\usepackage{multicol} % For occasional two-colun parts
...
\renewenvironment{example}%
  ...
  {\origendexample\end{quote}\vspace{1mm}\endgroup}}% Gap between bottom of box/shading and the start of the text below
