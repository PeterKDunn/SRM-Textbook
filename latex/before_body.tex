...
\def\example{\vspace{1mm}\begingroup\begin{quote}\setlength{\parskip}{2mm}\vspace{-5mm}\origexample}  
...
\def\endexample{\origendexample\end{quote}\vspace{-5mm}\endgroup}


\let\origdefinition=\definition
\def\definition{\begingroup\definecolor{shadecolor}{RGB}{242, 255, 230}\begin{quote}\vspace{-4mm}\origdefinition}  
   %% -5mm removes some spacing at the top, which looked odd. Chosen by trial and error
\let\origenddefinition=\enddefinition
\def\enddefinition{\origenddefinition\end{quote}\vspace{-5mm}\endgroup}
