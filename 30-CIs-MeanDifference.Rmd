...
## Example: growing squash {#GrowingSquashCI}
...
> From the sample, the mean increase in fruit weight from 2014 (dry year) to 2015 (normal year) is $2.230$\ g ($\text{s.e.} = 10.879$; $n = 23$), with an approximate $95$% CI between $24.79$\ g lighter in 2014 to $20.33$\ g higher in 2015.
...
1. The appropriate graph for displaying paired data is often a histogram of the differences.  
`r if( knitr::is_html_output() ) { torf( answer=TRUE )}`
