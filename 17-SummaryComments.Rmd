...
One common optical illusion occurs when the frequency (or percentage) axis on a bar chart (or dot chart, or histogram) does not start at zero.
...
Graphs should focus on clear communication, rather than trying to appear clever or fancy. 
...
if( knitr::is_latex_output() ) {
  colList <- grey.colors(n = 7, 
                         start = 0, 
                         end = 1)
} else {
  colList <- viridis::viridis(7)
}
