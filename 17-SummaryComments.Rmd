...
In contrast, a $2$-D graph (a side-by-side bar graph; Fig.\ \@ref(fig:Bar3D2D), right panel) makes it clear whether each age group has more females or more males.\index{Graphs!side-by-side bar chart}
:::
...
@data:Solomon2002:Gingko studied the use of gingko for memory enhancement.
Caregivers blinded\index{Blinding} to the treatment (gingko or placebo)\index{Placebo} reported the impact on subjects' memory.
