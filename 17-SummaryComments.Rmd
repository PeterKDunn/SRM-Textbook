...
```{r BarchartTruncated1, fig.align="center", fig.width=10, fig.height=4, out.width='95%', fig.cap="The same dat presented in two bar charts, without truncating the vertical axis (left) and truncating the vertical axis (right)" }
...
```{r HistosTemp, fig.align="center", fig.width=10, fig.height=4, out.width='100%', fig.cap="Three histograms displaying the body temperature of $130$ people." }
data(BodyTemp)
