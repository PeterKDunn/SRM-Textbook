...
### Recognise when to avoid truncating axes {#TruncatingAxes}
...
### Recognise that pie charts may be difficult to read {#PieChartProblems}
...
### Recognise the dangers of overplotting {#Overplotting}
...
In these case, points can be *stacked*\index{Overplotting!stacking} or jittered\index{Overplotting!jittering}; see Example\ \@ref(exm:Dotchart2DGorillas).
