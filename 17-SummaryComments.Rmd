...
```{r Bar3D2D, out.width='100%', fig.width=8.5, fig.height=3.75, fig.align="center", fig.cap="Two plots of the NHANES participants, divided by age group and sex. Left: a three-dimensional bar chart. Right: a side-by-side bar chart."}
