...
```{r Bar3D2D, out.width='100%', fig.width=9, fig.height=4.0, fig.align="center", fig.cap="Two plots of the NHANES participants, divided by age group and sex. Left: a three-dimensional bar chart. Right: a side-by-side bar chart."}
...
This is a problem in graphs where the distance represented visually implies the frequency of those observations, as may be the case for the count (or perercentage) axis in bar charts, dot charts, or histograms.
...
However, the horizontal axis starts at\ $35.5$^o^C, which does not create any problems as the *distances* from a temperature of\ $0$^o^C do not visual imply any quantity of interest.\index{Histogram}\index{Graphs!histogram}
...
```{r, MinerCrabPlot, fig.cap="Left: the number of noisy miners and the number of eucalyptus trees. Right: a scatterplot of the colour of female horseshoe crabs and the condition of their spines.", fig.align="center", fig.width=8, fig.height=3.15, out.width='95%'}
par(mfrow = c(1, 2))
...
```{r AISSportBarchart, fig.cap="Sports played by athletes in the AIS study.", fig.align="center", fig.width=5, fig.height=3.5}
...
\hspace{0.1\textwidth}
\begin{minipage}{0.45\textwidth}%
```{r, fig.width=5, fig.height=3.75, out.width='95%'}
data(NHANES)
par( mpar = c(5, 4, 2, 2) + 0.1 )
