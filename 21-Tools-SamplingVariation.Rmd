...
The previous chapter introduced the [decision-making process](#DecisionMaking) (Sect.\ \@ref(MakingDecisionsInResearch)) used in research:
...
Using the [classical approach to probability](#ProbClassical), the probability of the ball landing on an *odd* number (an '*odd-spin*') is $p = 18/37 =  0.486$.
