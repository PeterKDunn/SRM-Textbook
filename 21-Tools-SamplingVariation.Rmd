...
```{r RouletteWheelHist, results='hide', fig.width=5, fig.cap="Sampling distributions for the proportion of roulette wheel spins that show an odd number, for set of rolls of varying sizes", fig.align="center", out.width="100%", fig.width=9.25}
p <- 18/37
