...
## Comparing two means {#CompareTwoMeans}
...
Section\ \@ref(CompareTwoMeans) introduced a $t$-test for comparing two means.
However, often more than two means should be compared, and different methods are needed.
