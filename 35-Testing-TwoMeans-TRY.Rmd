...
The *sampling distribution of the difference between two sample means* $\bar{x}_A$ and $\bar{x}_B$ is, when the appropriate conditions are met (Sect.\ \@ref(ValidityTwoMeans)), described by:\index{Sampling distribution!difference between two means}
...
## Comparing more than two means: ANOVA {#CompareManyMeans}
