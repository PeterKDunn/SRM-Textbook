...
[Repeated-measures research question](#def:RepeatedMeasuresRQ)
...
[$t$-score](#TestStatistic)\index{t@$t$-score|textbf}
: A *$t$-score* measures how many standard deviations a value is from the mean.
A $t$-score is like a $z$-score, but uses sample information to estimate the standard deviation of the variable.
Also see: $z$-score.
...
: In a true experiment, the researchers (1) allocate treatments to groups of individuals (i.e., explanatory variable to the individuals), *and* and (2) determine who or what is in those groups.
