...
[Chi-square ($\chi^2$) score](#TestStatObs)\index{chi@$\chi^2$-score|textbf}
: The test-statistic used when comparing odds (or proportions).
...
[Comparison (between individuals)](#def:ComparisonBetween)
...
[Compound event](#def:CompoundEvent)
...
[Descriptive research question](#def:DescriptiveRQ)
...
[Exclusion criteria](#def:InclusionExclusionCriteria) 
...
[Extraneous variable](#def:ExtraneousVariable)
...
[Inclusion criteria](#def:InclusionExclusionCriteria) 
...
[Jittering](#exm:DotsChartsQuant2)
...
: *Paired data* occurs when every observation in one group is related to, or can be matched sensibly to, one unique observation in another group.
...
[Proportion](#def:Proportion)\index{Proportion|textbf}
...
[Variable](#def:Variable)\index{Variable|textbf}
...
[$z$-score](#def:zScore)\index{z@$z$-score|textbf}
