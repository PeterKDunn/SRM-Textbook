...
[Between-individual comparisons and connections](#Betweenindividuals)
...
Also see *Within-individual comparisons and connections*.
...
: The *conditions* are the values of the comparison or connection that those in the *observational* study experience, but are not imposed by the researchers.
.
...
: An *experimental study* (or an *experiment*) answer RQs with an intervention.
...
[Outcome](#def:Outcome)
: The *outcome* in a RQ is the result, output, consequence or effect of interest in a study, numerically summarising the entire population.
...
[Within-individual comparison and connections](#Betweenindividuals)
:  *Within-individual comparisons or connections* mean that the comparison or connection is being made *within* the same individuals.
Also see *Between-individual comparisons and connections*.
