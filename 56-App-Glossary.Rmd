...
[Carry-over effect](#def:CarryoverEffect)
...
: *Categorical data* is not *mathematically* numerical data: it consists of categories or labels (even if those labels are numbers). 
In this book, categorical data are called *qualitative* data.
...
[Questionnaire](#def:Questionnaire)
...
[Random procedure](#def:RandomProcedure)
...
[Relational research question](#def:RelationalRQ)
...
[Sampling mean](#def:SamplingMean)
...
In this book, scale data are called *quantitative data*.


[Simple event](#def:SimpleEvent name)
