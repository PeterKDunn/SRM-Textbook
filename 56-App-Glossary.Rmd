...
Alternatively, the CI is the range of plausible values for the [parameter](#def:Parameter) that may have produced the observed sample [statistic](#def:Statistic).
