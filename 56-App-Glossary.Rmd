...
: *Between-individuals comparisons or connections* mean that the comparison or connection is being made between different individuals.
...
[Dataset](#def:DataSet)
: A *dataset* refers to a collection of data from a study.
...
: *Internally valid* refers to how reasonable and logical it is to conclude that changes in the value of the response variable can be attributed to changes in the values of the explanatory variable; that is, the strength of the *inferences* made from those studied.
...
* Accidental---for instance, if a student has poor note-taking skills or doesn't know how to reference correctly, and they inadvertently present someone else's ideas and words as their own.
...
Quantitative data arise from counting or measuring. 
