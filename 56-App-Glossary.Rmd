...
(Sect.\ \@ref(CarryOverEffectExperimental)) or observational studies (Sect.\ \@ref(CarryOverEffectObservational)).
...
: The *placebo effect* occurs when individuals report perceived or actual effects despite not receiving an active treatment or condition, in experimental studies (Sect.\ \@ref(PlaceboEffectExperimental)).
