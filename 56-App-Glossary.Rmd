...
: The *placebo effect* occurs when individuals report perceived or actual effects despite not receiving an active treatment or condition, in experimental studies (Sect. \@ref(PlaceboEffectObservational)) or observational studies (Sect. \@ref(PlaceboEffectObservational)).
