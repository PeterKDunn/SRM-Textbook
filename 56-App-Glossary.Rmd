...
[Between-individual comparisons](#BetweenIndividuals)\index{Comparison!between individuals|textbf}
...
[Nominal variable](#Nominal)\index{Variables!ordinal|textbf}\index{Data!nominal|textbf}
: A *nominal* qualitative variable is a qualitative variable where the levels *do not* have a natural order. 


[Normal distribution](#NormalDistributions)\index{Normal distribution|textbf}
...
```{r DefNormalDistribution, fig.cap="A normal distribution", fig.align="center", fig.width=5, fig.height=3}
...
[Simple event](#def:SimpleEvent name)\index{Simple event|textbf}
...
[Within-individual comparison](#BetweenIndividuals)\index{Comparison!within individuals|textbf}
