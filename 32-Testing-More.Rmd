...
When the sampling distribution is an approximate normal distribution, the test statistic is a $t$-score or $z$-score,\index{zscores@$z$-scores} and $P$-values can often be approximated using the $68$--$95$--$99.7$ rule.
...
Consider the study to determine if the mean body temperature (Chap.\ \@ref(TestOneMean)) was $37.0$^o^C, where $\bar{x} = 36.8052$^o^C.
