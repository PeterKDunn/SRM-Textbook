...
Hypothesising, for example, that the *sample* mean body temperature is equal to $37.0^\circ\text{C}$ is silly (Chap.\ \@ref(TestOneMean)), because the *sample* mean clearly is $36.8052^\circ\text{C}$ for the sample available, and its value will vary from sample to sample anyway.
...
For the body-temperature study (Chap.\ \@ref(TestOneMean)), the alternative hypothesis is *two-tailed* (i.e., $H_1$: $\mu \ne 37.0$): the RQ asks if the population mean is $37.0^\circ\text{C}$ or *not*. 
Two possibilities are considered: that $\mu$  could be either larger *or* smaller than $37.0$.

A *one-tailed alternative hypothesis* would be appropriate if the RQ asked 'Is the *population* mean internal body temperature *greater* than $37.0^\circ\text{C}$?' (i.e., $H_1$: $\mu > 37.0$),
or 'Is the *population* mean internal body temperature *smaller* than $37.0^\circ\text{C}$?' (i.e., $H_1$: $\mu < 37.0$).
...
For the body-temperature example (Chap.\ \@ref(TestOneMean)), the conclusion was that the sample provided very strong evidence that the population mean body temperature was *not* $37.0^\circ\text{C}$ (i.e., very strong evidence to reject the null hypothesis).

However, in truth, the mean internal body may not have changed, and is still $37.0^\circ\text{C}$; that is, the null hypotheses actually is true, but we incorrectly decided it was probably not true.
...
Consider the study to determine if the mean body temperature (Chap.\ \@ref(TestOneMean)) was $37.0$^o^C, where $\bar{x} = 36.8052^{\circ}\text{C}$.
