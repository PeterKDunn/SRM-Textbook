...
A 'big' $P$-value mean that the sample statistic (such as $\hat{p}$) could reasonably have occurred through sampling variation in one of the many possible samples, if the assumption made about the parameter (stated in $H_0$) was true.
