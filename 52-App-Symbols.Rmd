...
#                  "$\\mu$", 
                 ...
                 "$\\displaystyle \\frac{s}{\\sqrt{n}}$", 
                  ifelse( knitr::is_latex_output(), "\\ding{51}", "&#10004;"),
...
ParStat[11, ] <- c("Test:",
                  ...
                  "$\\rho$",
                  "(Not provided)",
                  ifelse( knitr::is_latex_output(), "\\ding{54}", "&#10007;"),
                  " ")
ParStat[12, ] <- c("CI:",
                  "$r$",
                  "$\\rho$",
...
if( knitr::is_latex_output() ) {
  kable( ParStat[, c(2, 3, 5, 4, 6)],
   ...
   column_spec(column = 5, width = "24mm") %>%
...
\]
* $t$-scores are like $z$-scores, except the standard deviation of the distribution involves a sample estimate.
