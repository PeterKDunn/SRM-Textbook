...
* The sampling distribution of the sample mean:  
  normal distribution, with mean $\mu_{\bar{x}} = \mu$ and standard deviation $\text{s.e.}(\bar{x})$ as in the table.
* The sampling distribution of the sample proportion:  
  normal distribution, with mean $\mu_{\hat{p}} = p$ and standard deviation $\text{s.e.}(\hat{p})$ as in the table.
* The sampling distribution of the sample mean difference:  
  normal distribution, with mean $\mu_{\bar{d}} = \mu$ and standard deviation $\text{s.e.}(\bar{d})$ as in the table.
* The sampling distribution of the difference between two means:  
  normal distribution, with mean $\mu_{\bar{x}_A - \bar{x}_B} = \mu_A - \mu_B$ and standard deviation $\text{s.e.}(\bar{x}_A - \bar{x}_B)$.
