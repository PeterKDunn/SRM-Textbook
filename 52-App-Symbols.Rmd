...
(ref:SamplingDistributionPropCI) Ch.\ \@ref(def:CIOneProportion)

(ref:SamplingDistributionPropHT) Ch.\ \@ref(def:SamplingDistProp)

(ref:SamplingDistributionXbarCI) Ch.\ \@ref(def:OneMeanConfInterval)
