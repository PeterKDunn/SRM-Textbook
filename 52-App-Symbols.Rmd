...
#                 "$p_1 - p_2$",
                 ...
                 "CI: $\\displaystyle \\sqrt{\\text{s.e.}(\\hat{p}_1) + \\text{s.e.}(\\hat{p}_2)}$", 
                  ifelse( knitr::is_latex_output(), "\\ding{52}", "&#10004;"),
                 "(ref:SamplingDistributionTwoPropsCI)")
ParStat[10, ] <- c("Test:",
#                  "$p_1 - p_2$", 
                 "$\\hat{p}_1 - \\hat{p}_2$",
                 "$p_1 - p_2$",
                 "HT: $\\displaystyle \\sqrt{\\text{s.e.}(\\hat{p}) + \\text{s.e.}(\\hat{p})}$ for common proportion $\\hat{p}$", 
                  ifelse( knitr::is_latex_output(), "\\ding{52}", "&#10004;"),
                 "(ref:SamplingDistributionTwoPropsHT)")# ParStat[6, ] <- c("$\\sigma$", 
ParStat[11, ] <- c("CI:",
                 "Sample OR", 
                 "Pop. OR",
                 "(Not given)",
...
All the following formulas compute the approximate minimum (i.e., conservative) sample size needed to produce a $95$% confidence interval with a specified margin of error.\index{Sample size!estimation}
