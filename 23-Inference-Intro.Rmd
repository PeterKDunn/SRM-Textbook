...
Answering the RQ is difficult, since we only study one of the countless possible samples, and hence observe only one of the countless possible values for the statistic.
...
The appropriate type of analysis depends upon the number and types of variables.
The analysis depends on the purpiose of the RQ (Sect.\ \@ref(TwoPurposesOfRQs)):

* *Confidence intervals* answer estimation RQ, where the interest is in how precisely a *statistic* estimates a *parameter*.\index{Confidence intervals}
* *Hypothesis tests* answer decision-making RQs, where *decisions* are required.\index{Hypothesis testing}
