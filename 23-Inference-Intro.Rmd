...
\begin{objectivesBox}{iconmonstr-target-4-240.png}
So far, you have learnt to ask a RQ, design a study, classify and summarise the data, understand sampling variation.
\textbf{In this chapter}, you will be introduced to the two big ideas in inference: \emph{confidence intervals} and \emph{hypothesis testing}.
...
```{r fig.width=3, fig.height=5.5, out.width="100%"}
source("R/SixSteps3.R")
SixSteps3(5, 
         "Analysis: CIs and Tests")
```
...
* *Confidence intervals* answer [estimation-type RQ](#TypesOfRQs), where the interest is in how precisely a *statistic* estimates a *parameter*.
