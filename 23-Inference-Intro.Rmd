...
* *Confidence intervals* answer estimation RQ (Sect.\ \@(TwoPurposesOfRQs)), where the interest is in how precisely a *statistic* estimates a *parameter*.\index{Confidence intervals}
