...
* *Confidence intervals* answer [estimation-type RQ](#TypesOfRQs), where the interest is in how precisely a *statistic* estimates a *parameter*.\index{Confidence intervals}
* *Hypothesis tests* answer [decision-type RQs](#TypesOfRQs), where *decisions* are required.\index{Hypothesis testing}
