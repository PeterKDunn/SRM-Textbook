...
Then the data are described (Chap.\ \@ref(DescribingVars)) and summarised (Chaps.\ \@ref(SummariseQualData) to\ \@ref(SummariseComments)) in preparation for answering the RQ.
...
This Part introduces *analysis*: where now the data are used to answer the research question.
