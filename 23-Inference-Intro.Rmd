...
* *Confidence intervals* answer estimation RQ (Sect.\ \@ref(TwoPurposesOfRQs), where the interest is in how precisely a *statistic* estimates a *parameter*.\index{Confidence intervals}
* *Hypothesis tests* answer decision-making RQs (Sect.\ \@ref(TwoPurposesOfRQs), where *decisions* are required.\index{Hypothesis testing}
