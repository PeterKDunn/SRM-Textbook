...
\[
   \frac{\text{a value of something that varies} - \text{mean of the distribution}}
...
In both cases, the *test statistic* is a $t$-score if the measure of variation use a *sample* estimate.
:::
