...
Use the $158$ games with a result (i.e., ignore the draws) to determine if there is evidence that the home team wins more often than $50$% (i.e., that there is a home-side advantage).
:::
...
students in Poland spun a one-euro coin $250$ times, and found $140$ heads (as reported by @data:Gelman2002:DiceCoins).
...
1. The value of $105.5$ is effectively a population odds ratio.
   Show that this is equivalent to stating the the probability of a male birth is $0.51338$.

This value is essentially a population proportion; that is, $p = 0.513$.
