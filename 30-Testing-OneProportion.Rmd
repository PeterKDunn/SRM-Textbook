...
```{r, RollsSixesSD, fig.height=3.25, fig.width=8.75, out.width='100%', fig.align="center", fig.cap="The sampling distribution, showing the distribution of the sample proportion of ones when the population proportion is $1/6$, in $50$ die rolls"}
p <- 1/6
n <- 100
mu <- p
...
```{r DecisionFlowDodgyDice, fig.cap = "A way to make decisions for the loaded-dice example", fig.align="center", out.width='100%', fig.width = 9.5, fig.height = 4}
...
showDecisionMaking(populationText = expression( atop(bold(Assume)~the,
                   ...
                   oneSampleText = expression( atop(Roll~the~die,
                                                    100~times) ),
                   oneStatisticText =  expression( atop(41*"%"~of~rolls,
                                                        are~ones)),
                   Decision = "Reject"     
)
