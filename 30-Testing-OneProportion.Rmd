...
So how could I determine which die was 'loaded'?
...
However, if I assumed the value of $p$ is $1/6$, the possible values of the *sample* proportion from all possible rolls of the fair die could be described; that is, the *sampling distribution* could be described.
The sampling distribution would show what values of $\hat{p}$ could reasonably be expected from a die with $p = 1/6$.

Suppose we find the value of $\hat{p}$ is not *exactly* $1/6$.
Two explanations exist to explain why:
