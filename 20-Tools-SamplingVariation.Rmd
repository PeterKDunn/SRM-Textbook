...
This is no accident: *many statistics vary from sample to sample with an approximate bell-shape distribution* if certain conditions are met.
This bell-shaped distribution is formally called a *normal distribution*, and these are studied further in Chap.\ \@ref(SamplingDistributions).
...
```{r StatisticVariesAcrossSamples, fig.align="center", fig.width=6.5, fig.height=3.85, out.width="70%", fig.cap="Describing how the value of the sample statistic varies across all possible samples."}
#
...
The standard error *is* a standard deviation, but is used to specifically describe the variation in sampling distributions.
