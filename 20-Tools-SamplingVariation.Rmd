...
```{r RouletteWheel, fig.cap="A European roulette wheel, with numbers $0$ to $36$", echo=FALSE, cache=FALSE, out.width = "85%", fig.align="center", fig.height=2.25, fig.width=2.25}
# Wheel  
DD <- 10
dd <- 4
