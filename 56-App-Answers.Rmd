...
**12.** $\hat{y} = 16.41 - (0.96\times 6) = 10.65$, or $10\,650; expensive.
**13.** Hardly need a test:  $H_0$: $\beta_1 = 0$ vs $H_1$: $\beta_1 < 0$; $t = -13.71$, $P = 0.0001/2 = 0.00005$.
        Very strong evidence older cars fetch lower second-hand prices, on average.
**14.** $-0.958 \pm (2\times 0.070)$, or $-0.958\pm 0.140$, or $-1.098$ to $-0.818$.
**15.** Same, reflected left-to-right.
