...
**1.** $r$ moderately strong, positive; $\hat{y} = 4 + 1.4x$
...
**3.** Stat.\ valid if relationship approx. linear; variation in STAI same for diff levels of work experience.
$n \ge 25$.
:::
...
**1.** $b_0$: *No* time spent on application, average of $0.27$\gs applied; nonsense.
...
**4.** $\hat{y} = 18$\gs.
**5.** About $64$% reduction in unexplained variation using time spent on application.
...
**3.** $\hat{y} = 17.47 - 2.59x$: $x$ is percentage bitumen by weight; $y$ is percentage air voids by volume.
**4.** *Slope*: increase in bitumen weight by one percentage point *decreases* average percentage air voids by volume by $2.59$ percentage points.
...
**6.** $P < 0.001$, same as for slope.
**7.** $\hat{y} = 4.5027$, or $4.5$%.
Expected good prediction, as relationship strong.
**8.** $\hat{y} = 1.909$, or $1.9$%.
...
**8.** Sample sizes and linearity OK; for Sex\ B, perhaps hint of increasing variation.
:::
...
**1.** Yes.
**2.** Almost certainly; $n = 24$ is very close to $n - 25$.
...
**1.** Yes.
**2.** No: sample correlation do not have an approx.\ normal sampling distribution.
**3.** Yes.
:::
...
**1.** *to*.
**2.** *its*.
**3.** One sample with $50$ individuals; use 'mean' or 'median', as appropriate, not 'average'; units of age is 'years'.
