...
**4.** If mean of both response, explanatory variables different for F and M, sex of the participant a *confounder*; would need to be factored into the analysis.
...
*Gender*: bar or dot: mode is M. F: $20$%; odds: $0.25$.
...
**3.** Little difference between M, F in *sample*.
:::
...
**4.** $77.4$ to\ $92.4$\kgs.
**5.** Approx. $95$% confident *population mean* weight of M American black bears between $77.4$ and $92.4$\kgs.
