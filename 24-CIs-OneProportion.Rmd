...
In this example, the *population proportion* of even rolls is $p = 0.5$ (using the classical approach to probability: three of the six faces of the die are even).
...
Suppose a fair die was rolled $25$ times, and this was repeated *thousands* of times (not just for ten samples as in 
`r if (knitr::is_latex_output()) {
...
can be determined using statistical theory.
...
While we still don't know *exactly* what we'll find next roll, we have some idea of *how* the sample proportion is likely to vary in samples of $25$ rolls.
...
For the die example, where $n = 25$ rolls and the population proportion of even rolls is $p = 0.5$, the standard error of the sample proportion is  
\begin{equation} 
