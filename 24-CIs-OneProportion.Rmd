...
We have seen that the value of the sample statistic often varies between samples with a normal distribution (whose standard deviation is called the *standard error*).
