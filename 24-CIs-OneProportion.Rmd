...
```{r fig.show="animate", animation.hook="gifski", interval=0.4, loop=FALSE}
if (knitr::is_html_output()){
...
```{r pProducingpHat, fig.width=7.5, fig.height=8, out.width='100%', fig.cap="The CI gives an interval containing values of $p$ that may have produced the observed value of $\\hat{p}$", fig.align="center"}
if (knitr::is_latex_output()){
