...
The *standard error is the standard deviation of the distribution of a sample statistic*, that measures how much a sample estimate varies across all possible samples.
...
Almost always, we only have one sample.
:::
