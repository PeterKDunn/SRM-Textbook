...
The proportion of even rolls varies from sample to sample.
For these ten samples of $n = 25$ rolls, the proportion of even rolls ranged from $\hat{p} = 0.32$ to $\hat{p} = 0.60$.
...
Suppose a fair die was rolled $25$ times, and this was repeated for *thousands* of samples (not just ten samples as in 
`r if (knitr::is_latex_output()) {
   'Fig.\\ \\@ref(fig:RollDiceFig)),'
} else {
   'the animation above),'
}`
and the proportion of even rolls was recorded for every one of those thousands of samples.
