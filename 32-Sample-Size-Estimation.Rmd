...
All else being equal, a *larger* sample size gives a *more precise* (Sect.\ \@ref(PrecisionAccuracy)) estimate of the parameter;\index{Precision} that is, a *narrower* CI.
