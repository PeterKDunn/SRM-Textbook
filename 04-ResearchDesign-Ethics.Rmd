...
In the context of research design, academic integrity covers areas such as collusion, fraud and plagiarism  (discussed in Sect. \@ref(Plagiarism)).
...
Rather than using spreadsheets, which can have significant problems when used for analysis (Sect. \@ref(DataEntry)), using tools which encourage reproducible research are recommended.
