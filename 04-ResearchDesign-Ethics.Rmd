...
Practically every university and research organisation in the world is committed to promoting and enforcing responsible research practices (RRPs).
...
* *Funding*:
  Studies should not be funded by, or at least not sanctioned by, companies or organisations with vested interests (for example, studies funded by cigarette companies will probably conclude that smoking is not harmful).
...
However, realising that reproducibility is nexcessary is important.
