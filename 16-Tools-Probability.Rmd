...
In this chapter, *probability* is discussed.
...
We can say that 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 1/6', or 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 0.1667'.
...
For the *first* card, the sample space lists every card in the pack, and drawing any one card is as equally likely as drawing any other.
...
1 Suppose **Event A** is defined as '*I will roll a `r include_graphics("Dice/dice1.png", dpi=2000)` or a `r include_graphics("Dice/dice2.png", dpi=2000)` on a fair die*'.
