...
* Rolling a `r include_graphics("Dice/dice4.png", dpi=2000)`: This event includes one element of the sample space: 
  `r include_graphics("Dice/dice4.png", dpi=2000)`.
* Rolling a even number: This event includes three elements of the sample space: 
  `r include_graphics("Dice/dice2.png", dpi=2000)` 
  `r include_graphics("Dice/dice4.png", dpi=2000)` and
  `r include_graphics("Dice/dice6.png", dpi=2000)`
* Rolling a number larger than `r include_graphics("Dice/dice2.png", dpi=2000)`: This event includes four elements of the sample space:   `r include_graphics("Dice/dice3.png", dpi=2000)`
  `r include_graphics("Dice/dice4.png", dpi=2000)` 
...
that are
*equally likely*,
and the event ('rolling a `r include_graphics("Dice/dice4.png", dpi=2000)`')
...
We can say that 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 1/6',
or 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 0.1667'.
The answer can also be expressed as a *percentage*
('the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 16.7%').

The answer could also be interpreted as
'the *expected* proportion of rolls that are a `r include_graphics("Dice/dice4.png", dpi=2000)` is 0.167'.
This approach to computing probabilities is called the 
*classical* approach to probability.

The chance of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` in the future is 0.167,
but a roll of the die will either produce a `r include_graphics("Dice/dice4.png", dpi=2000)`, 
or will not produce a `r include_graphics("Dice/dice4.png", dpi=2000)`...
...
The probability of rolling a `r include_graphics("Dice/dice1.png", dpi=2000)` 
*or* a `r include_graphics("Dice/dice2.png", dpi=2000)` is
$2/6$ (or 33.3%).
:::
...
'Subjective' probabilities are **not** necessarily 'made up';
...
<iframe src="https://learningapps.org/watch?v=pbd3ekn3k22" style="border:0px;width:100%;height:500px" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
...
1 Suppose **Event A** is defined as '*I will roll a `r include_graphics("Dice/dice1.png", dpi=4200)` or a `r include_graphics("Dice/dice2.png", dpi=12000)` on a fair die*'.
