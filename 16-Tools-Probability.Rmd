...
The chance of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` in the future is 0.1667, but a roll of the die either will or will not produce a `r include_graphics("Dice/dice4.png", dpi=2000)`... and we don't know which will occur.
