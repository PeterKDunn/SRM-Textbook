...
`r include_graphics("Dice/die1.png", dpi=4000)` 
`r include_graphics("Dice/die2.png", dpi=4000)` 
`r include_graphics("Dice/die3.png", dpi=4000)` 
`r include_graphics("Dice/die4.png", dpi=4000)` 
`r include_graphics("Dice/die5.png", dpi=4000)` 
and
`r include_graphics("Dice/die6.png", dpi=4000)`
...
* Rolling a `r include_graphics("Dice/die4.png", dpi=4000)`: This event includes one element of the sample space: 
  `r include_graphics("Dice/die4.png", dpi=4000)`.
* Rolling a even number: This event includes three elements of the sample space: 
  `r include_graphics("Dice/die2.png", dpi=4000)` 
  `r include_graphics("Dice/die4.png", dpi=4000)` and
  `r include_graphics("Dice/die6.png", dpi=4000)`
* Rolling a number larger than `r include_graphics("Dice/die2.png", dpi=4000)`: This event includes four elements of the sample space:   `r include_graphics("Dice/die3.png", dpi=4000)`
  `r include_graphics("Dice/die4.png", dpi=4000)` 
  `r include_graphics("Dice/die5.png", dpi=4000)` and
  `r include_graphics("Dice/die6.png", dpi=4000)`.
:::
...
We can say that 'the probability of rolling a `r include_graphics("Dice/die4.png", dpi=4000)` is 1/6',
...
What is the *probability* of rolling a `r include_graphics("Dice/die2.png", dpi=4000)` on a die?
What are the *odds* of rolling a `r include_graphics("Dice/die2.png", dpi=4000)` on a die?
...
The probability of rolling a `r include_graphics("Dice/die1.png", dpi=4000)` 
*or* a `r include_graphics("Dice/die2.png", dpi=4000)` is
$2/6$ (or 33.3%).
:::
...
1. Suppose I draw one card from the pack and roll a six-sided die.
   Are the events 'Draw a **Jack** from the pack of cards' and 'Roll a   `r include_graphics("Dice/die5.png", dpi=4000)` on the die' independent events? 
:::
