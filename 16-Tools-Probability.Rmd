...
(Answer is here^[**1:**  $159/255 = 62.4$%; **2:** $40/255=15.7$%; **3:** $40/96 = 41.7$%.].)
:::
...
(Answer is here^[**1:** Subjective; **2:** Relative frequency; **3:** Classical; **4:** Probably subjective.].)
:::
...
* Suppose **Event A** is defined as '*I will roll a `r include_graphics("Dice/dice1.png", dpi=4200)` 
or a `r include_graphics("Dice/dice2.png", dpi=12000)` on a fair die*'.
...
<!-- ####################### REVIEW QUESTIONS ##################################### -->
```{r, child = if (knitr::is_html_output(excludes="epub")) './children/ReviewQuestions/ReviewQuestions-Probability.Rmd'}
```
