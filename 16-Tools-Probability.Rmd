...
In short, *probability* quantifies the chance that something (an 'event') will happen in the future.

More formally, probability is discussed in the context of a procedure whose result is unknown beforehand. 
...
`r include_graphics("Dice/dice1.png", dpi=2000)` 
`r include_graphics("Dice/dice2.png", dpi=2000)` 
`r include_graphics("Dice/dice3.png", dpi=2000)` 
`r include_graphics("Dice/dice4.png", dpi=2000)` 
`r include_graphics("Dice/dice5.png", dpi=2000)` 
and
`r include_graphics("Dice/dice6.png", dpi=2000)`
...
* Rolling a `r include_graphics("Dice/dice4.png", dpi=2000)`: 
  This event includes one element of the sample space: 
  `r include_graphics("Dice/dice4.png", dpi=2000)`.
* Rolling a even number: 
  This event includes three elements of the sample space: 
  `r include_graphics("Dice/dice2.png", dpi=2000)` 
  `r include_graphics("Dice/dice4.png", dpi=2000)` and
  `r include_graphics("Dice/dice6.png", dpi=2000)`
* Rolling a number larger than `r include_graphics("Dice/dice2.png", dpi=2000)`: 
  This event includes four elements of the sample space:   `r include_graphics("Dice/dice3.png", dpi=2000)`
  `r include_graphics("Dice/dice4.png", dpi=2000)` 
  `r include_graphics("Dice/dice5.png", dpi=2000)` and
  `r include_graphics("Dice/dice6.png", dpi=2000)`.
:::
...
We do not know what distance your throw will be until you throw, but we can describe the *sample space* for this procedure:
...
A probability of zero (or 0%) means the event is 'impossible' (will *never* occur).
At the other extreme, a probability of one (or 100%) means that the event is *certain* to happen (will always occur).
...
* The probability of receiving some rain in Sydney in the next decade is one. 
  It is certain.
* The probability of receiving rain on any given day in Sydney... is somewhere between 0 and 1.
:::
...
What is the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` on a die?
The sample space has six possible outcomes (listed in Example \@ref(exm:SampleSpaceDie)) that are *equally likely*, and the event ('rolling a `r include_graphics("Dice/dice4.png", dpi=2000)`') comprises just *one* of those.
...
We say that 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 1/6', or 'the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 0.1667'.
The answer can also be expressed as a *percentage* ('the probability of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` is 16.7%').

The answer could also be interpreted as 'the *expected* proportion of rolls that are a `r include_graphics("Dice/dice4.png", dpi=2000)` is 0.167'.
This approach to computing probabilities is called the  *classical* approach to probability.

The chance of rolling a `r include_graphics("Dice/dice4.png", dpi=2000)` in the future is 0.167, but a roll of the die will either produce a `r include_graphics("Dice/dice4.png", dpi=2000)`,  or will not produce a `r include_graphics("Dice/dice4.png", dpi=2000)`... and we don't know which will occur.
...
What is the *probability* of rolling a `r include_graphics("Dice/dice2.png", dpi=2000)` on a die?
What are the *odds* of rolling a `r include_graphics("Dice/dice2.png", dpi=2000)` on a die?
...
The probability of rolling a `r include_graphics("Dice/dice1.png", dpi=2000)`  *or* a `r include_graphics("Dice/dice2.png", dpi=2000)` is $2/6$ (or 33.3%).
:::
...
1 Suppose **Event A** is defined as '*Rolling a `r include_graphics("Dice/dice1.png", dpi=2000)` or a `r include_graphics("Dice/dice2.png", dpi=2000)` on a fair die*'.
...
1. Suppose I draw one card from the pack and roll a six-sided die.
   Are the events 'Draw a **Jack** from the pack of cards' and 'Roll a   `r include_graphics("Dice/dice5.png", dpi=2000)` on the die' independent events? 
:::
