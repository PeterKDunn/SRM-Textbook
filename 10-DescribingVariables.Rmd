...
Consider a study to determine if the weight of $500$\ g bags of pasta actually weigh\ $500$\gs (or more) on average.
...
How would these variables be classified using the language of this chapter?
