...
However, annual incomes are much larger than cents, and vary at scales much greater than cents, and so are usually treated as continuous.
:::
\index{Quantitative data|)}\index{Variables!quantitative|)}
...
A *nominal* qualitative variable is a qualitative variable where the levels\index{Levels} *do not* have a natural order. 
:::


::: {.definition #Ordinal name="Ordinal qualitative variables"}
\index{Qualitative data!ordinal}\index{Variables!ordinal qualitative}
An *ordinal* qualitative variable is a qualitative variable where the levels\index{Levels} *do* have a natural order. 
:::
