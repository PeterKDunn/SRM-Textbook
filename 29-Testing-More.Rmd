...
When using software to obtain $P$-values, if the software reports one- or two-tailed $P$-values.\iundex{P@$P$-values!reporting very small}
Some software (such as SPSS) always reports two-tailed $P$-values.
:::


## About interpreting $P$-values {#AboutPvalues}
\index{P@$P$-values!interpretation}
