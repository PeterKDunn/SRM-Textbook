...
::: {.answer data-latex=""}
**Answer to Exercise\@ref(exr:SignageSummaryDec)**
**1.** The parameter could be written as $\mu{\text{After}} - \mu_{\text{Before}}$,
       the *increase* is the deceleration.
**2.** The approximate CI is -0.00162 to 0.00562 m/s.
       That is, 
       the difference between the mean decelerations is likely to be somewhere between
       -0.0016 m/s (i.e, a mean acceleration of 00016 m/s) to 0.0056 m/s.
::
