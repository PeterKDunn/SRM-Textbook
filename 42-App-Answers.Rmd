...
TurbineCISumTable[1, ] <- c("0.1061", "9.59%", "73")
TurbineCISumTable[2, ] <- c("0.2727", "21.43%", "42")
...
1. Use $n = \left(\frac{1}{(0.04)^2} \right) = 625$; 625 needed.
1. Use $n = \left(\frac{1}{(0.02)^2} \right) = 2500$; 2500 needed. That is *four times as many* as when the margin-of-error was 0.04.
1. Use $n = \left(\frac{1}{(0.01)^2} \right) = 10,00$; 10,000 needed. That is *sixteens times as many* as when the margin-of-error was 0.04.
...
1. Use $n = \left(\frac{1}{(0.01)^2} \right) = 10000$; 10,000 needed.
1. Use $n = \left(\frac{1}{(0.02)^2} \right) = 2500$; 2,500 needed.
1. Use $n = \left(\frac{1}{(0.10)^2} \right) = 100$; 1000 needed.
...
1. Use $n = \left(\frac{2\times 0.43}{(0.02)^2} \right) = 1849$; 1849 needed.
1. Use $n = \left(\frac{2\times 0.43}{(0.05)^2} \right) = 295.85$; 296 needed.
1. Use $n = \left(\frac{2\times 0.43}{(0.10)^2} \right) = 73.96$; 74 needed.
