...
The groups either are naturally different (e.g., sub-species), or are manipulated by the researchers to be different (e.g., different doses of a drug).
...
The different groups have different, unique attributes to be compared.
:::
...
The comparisons may be made when researchers manipulating the individuals between measurements or observations (e.g., recording pulse rate *before* and *after* drinking caffeine), or with researchers not manipulating the individuals (e.g., recording the activity of lizards at 4a.m. and 4p.m.). 
...
* Comparing the average amount of wear in many individual floor boards (O) after one, five and ten years of use.


::: {.definition #ComparisonWithin name="Comparisons (within individuals)"}
...
::: {.example #Comparisons name="Within-individuals comparison"}
...
The relationship between the size of trees (using DBH, diameter at breast height; the **O**utcome), and the pH of the soil was explored (the *connection*).
...
A *within*-individuals comparison would record the daily sun exposure for one individual over many days: the comparison is *within* each individual.
:::
...
Comparisons or the connections that are *not* manipulated by the researchers are called *conditions*.
...
Any type of comparison or connection can have an intervention (though they are less common with connections).
...
All RQ types can also be written to elicit different information, depending on the purpose of the research:
...
*Relational RQs* state the **P**opulation, the **O**utcome, and the *between-individuals* **C**omparison.
...
There is *no intervention* since the sex of the individual (the C) is *not* manipulated by, or imposed by, the researchers.
...
*Repeated measures RQs* state the **P**opulation, the **O**utcome, and the *within-individuals* **C**omparison.
They may or may not have an intervention.
...
*Correlational RQs* state the **P**opulation, the **O**utcome, and the **C**omparison.
...
* In British young people aged $4$--$18$, is the average zinc intake *higher* for boys compared to girls?
...
One of the last two would only be adopted if there was a specific reason why a one-tailed direction was suspected.
...
Similarly, the values of the explanatory variable measured on the individuals distinguish between the values of the *comparison* (Table\ \@ref(tab:RQsPopulationIndividualsExamplesComparison) and\  \@ref(RQsPopulationIndividualsExamplesComparisonWithin)) or the *connection* (Table\ \@ref(tab:RQsPopulationIndividualsExamplesConnection)) being made.
...
The data worksheet will have two columns (Fig.\ \@ref(fig:DataPrepjamovi), left panel):
