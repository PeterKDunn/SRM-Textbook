...
These make no sense in this context: there is no set of data for which a standard deviation or sample size can be found.
...
The information can be found using jamovi (Fig.\ \@ref(fig:ReactionPhoneSummaryjamovi)).
...
The data can be summarised (Table\ \@ref(tab:SignageSummary)) using the jamovi output (Fig.\ \@ref(fig:SpeedjamoviCI2)).
...
From Fig.\ \@ref(fig:SpeedjamoviCI2), an exact $95$% CI is from $-11.6$ to $0.23$\ km.h^-1^, *lower* before the addition of extra signage (since the *After* information is given first in the second table of Fig.\ \@ref(fig:SpeedjamoviCI2)).
This is equivalent to an exact $95$% CI from $-0.23$ to $11.6$\ km.h^-1^, *higher* before the addition of extra signage.
...
Defining $\mu$ as the mean reduction in TG, define the *differences* between the TG reductions in the two groups as $\mu_T - \mu_W$.
