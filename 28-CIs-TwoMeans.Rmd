...
```{r, child = if (knitr::is_html_output()) {'introductions/28-CIs-TwoMeans-HTML.Rmd'} else {'introductions/28-CIs-TwoMeans-LaTeX.Rmd'}}
```
...
## Sampling distribution for $\bar{x}_1 - \bar{x}_2$ {#SamplingDistDiffMeansCI}
...
The data can be summarised using the jamovi output (Fig.\ \@ref(fig:SpeedjamoviCI2)).
...
1. Determine the *gain* in each individuals girls weight.
