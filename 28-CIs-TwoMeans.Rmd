...
Since two groups are being compared, distinguishing the two groups is important.
...
The sample size is not $32 - 32 = 0$; there are just two samples of given sizes.
...
Then, finding a $95$%\ CI for the difference between the mean reaction times is similar to the process used in Chap.\ \@ref(OneMeanConfInterval), since almost all CIs have the same form:  
\[
...
From the output, the exact $95$%\ CI is from $12.32$ to $90.87$\ ms.
