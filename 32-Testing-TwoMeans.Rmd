...
RT.DataTable   <- cbind( ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"],
                         ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"] )
RT.DataTable10 <- cbind( head(ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"], 10), 
                         head(ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"], 10) ) 
...
Phone.DataSummary[3, 2] <- NA
Phone.DataSummary[3, 3] <- NA
rownames(Phone.DataSummary) <- c("Using phone", 
                                 "Not using phone", 
                                 "All students")

if( knitr::is_latex_output() ) {
  kable(surroundMaths(Phone.DataSummary,
                      decDigits = c(2, 0, 2, 3)),
        format = "latex",
        booktabs = TRUE,
        longtable = FALSE,
