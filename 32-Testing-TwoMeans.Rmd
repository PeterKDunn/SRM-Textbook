...
The table also gives the standard error for estimating this *difference* as $\text{s.e.}(\bar{x}_D - \bar{x}_N) = 0.80285$ (*given* in the article), since the difference will vary for all possible samples.
