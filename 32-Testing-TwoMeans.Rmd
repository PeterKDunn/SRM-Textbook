...
(This study was seen in Sect.\ \@ref(BHADPCI).)
...
The table also gives the standard error for estimating this *difference* as $\text{s.e.}(\bar{x}_D - \bar{x}_N) = 0.78794$, since the difference will vary for all possible samples.
...
> There is very strong evidence ($t = 5.43$; one-tailed $P < 0.001$) that the mean reduction in TG for the chamomile-tea drinking group is greater than the mean reduction in TG for the hot-water drinking group (difference between means: $45.74$\ mg.dl^-1^; approx. $95$% CI: $28.90$ to $62.84$\ mg.dl^-1^).
