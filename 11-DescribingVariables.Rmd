...
For example,
the post code of Caboolture is 4510, but it could have been QCAB for instance.
:::
...
For both packages, however, declaring the variables correctly is very important (Table \@ref(tab:TypesOfVars)).
