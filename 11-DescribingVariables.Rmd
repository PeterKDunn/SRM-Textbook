...
*Quantitative research* can use both *quantitative* and *qualitative* data, because both can be summarised numerically (Chaps.\ \@ref(SummariseQuantData) and\ \@ref(SummariseQualData) respectively) and analysed numerically.
:::
...
One purpose of the study was to determine contributors to the incidence of diarrhea in young children ($85$ households had children under\ $5$).
...
if( knitr::is_latex_output() ) {
  kable(WATableQual,
    ...
    column_spec(column = 3, width = "59mm") 
}
