...
1. Blood type.  
   The levels are: Type A; Type B; Type AB; Type O.

2. Age group.  
   The levels are: Under 20; 20 to under 30; 30 to under 50; 50 or over.
:::
...
Consider a study to determine if the weight of 500g bags of pasta are really at least 500g.
...
Another approach is to record whether each bag of pasta was underweight or not.
...
Statistical software, like jamovi and SPSS, require the user to describe the variables.
...
A study on the bruising of apples [@doosti2016development] explored the relationship between the recorded surface temperature of apple, and the depth of bruising.
