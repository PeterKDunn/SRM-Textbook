...
*Quantitative data* is *mathematically* numerical data: the numbers have numerical meaning, and perform mathematical operations on them makes sense.
...
Australian postcodes are numbers, but are *not* quantitative; the numbers are just labels.
...
For example, the post code of Caboolture is 4510, but could have been QCAB.
:::
