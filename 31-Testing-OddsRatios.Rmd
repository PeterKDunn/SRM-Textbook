...
# Hypothesis tests for odds ratios {#TestsOddsRatio}
...
## The test statistic: Observations {#TestStatObs}
...
```{r, echo=FALSE}
htmltools::tags$video(src ="./videos/tablesChiSquare", 
                      width="550", 
                      autoplay="false", 
                      controls="controls", 
                      loop="loop", 
...
<!-- ```{r PedestrianPhonesResiduals, echo=FALSE} -->
<!-- #chisq.test(PhoneTable) -->
<!-- if( knitr::is_latex_output() ) { -->
<!--   kable( round(chisq.test(PhoneTable)$residuals, 2), -->
<!--          format="latex", -->
<!--          longtable=FALSE, -->
<!--       caption="The standardized residuals for the mobile-phone behaviour of pedestrians", -->
<!--       booktabs=TRUE) -->
<!-- } -->
