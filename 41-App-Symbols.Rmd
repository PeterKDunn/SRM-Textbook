...
if( knitr::is_html_output() ) {
  out <- kable( ParStat,
         ...
         booktabs = TRUE,
         align = c("c", "c", "c", "c"),
         caption = "Some sample statistics used to estimate population parameters. Empty table cells means that these are not studied. The dashes means that no formula is given in this text.")
