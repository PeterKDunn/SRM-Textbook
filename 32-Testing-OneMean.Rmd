...
Researchers wanted to re-examine this claim [@data:mackowiak:bodytemp] to determine if these values are still appropriate. 
...
A numerical summary, using jamovi (Fig.\ \@ref(fig:BodyTempjamovi)), shows that:
