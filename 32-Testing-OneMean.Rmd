...
Given the sampling distribution (Fig.\ \@ref(fig:BodyTempSamplingDist)), use the [$68$--$95$--$99.7$ rule](#def:EmpiricalRule) to determine how often will $\bar{x}$ be *larger* than $37.0357^\circ$C, if $\mu$ really is $37.0$.
