...
\index{Hypothesis testing!one mean}\index{Test statistic!$t$-score}
...
* $t$-scores use a standard error involving sample "estimat"es (as in this chapter, where $s$ is used).
