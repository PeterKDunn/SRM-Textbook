...
Two possibilities are considered, so this is a *two-tailed* alternative hypothesis.
...
* *Step 2: Expectation*: 
  The *sampling distribution* describes what to expect from the sample statistic *if* the null hypothesis is true.
* *Step 3: Observation*: 
