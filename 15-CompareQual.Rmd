...
SM2[1, ] <- SM3[2, ]
SM2[2, ] <- SM3[1, ]
rownames(SM2) <- c("Urban residents",
                   "Rural")
...
**1.** True.
**2.** False. <!-- 78/167 = 0.4670659 -->
**3.** True.
**4.** True. <!-- 78/89 = 0.8764045 -->
**5.** False. <!-- (416/568)/(78/89) = 0.8356808 -->
**6.** False. <!-- (416/568)-(78/89) = -0.1440101 -->
::: 
`r if (knitr::is_html_output()) '-->'`
