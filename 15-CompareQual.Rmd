...
* with Method\ A, the odds of success is $81/6 = 13.5$; there are $13.5$ more successful procedures than failures for Method\ A.
* with Method\ B, the odds of success is $234/36 = 6.5$; there are $6.5$ more successful procedures than failures for Method\ B.
...
- for *Method\ A*, the proportion of successful procedures is $\hat{p}_A = 0.931$.
- for *Method\ B*, the proportion of successful procedures is $\hat{p}_B = 0.867$.
...
if( knitr::is_latex_output() ) {
  ...
  kable(pad(WANumericalSummary,
        ...
        col.names = c("having diarrhoea", 
                      "having diarrhoea", 
                      "size"),
        caption = "Numerical summary of the water-access data: odds and percentage of children with diarrhoea in the last two weeks (comparing those without livestock to those with).") %>%
    row_spec(0, bold = TRUE) %>%
    kable_styling(font_size = 8) %>%
    row_spec(3, italic = TRUE) %>%
    row_spec(row = 2, 
...
if( knitr::is_html_output() ) {
  ...
  kable(pad(WANumericalSummary,
        ...
        align = "c",
        digits = c(1, 3),
        col.names = c("Percentage children", 
                      "Odds children", 
                      "Sample size"),
...
if( knitr::is_latex_output() ) {
  kable(SoccerTab,
        format = "latex",
        booktabs = TRUE,
        caption = "The number of concussions experienced by college students.") %>%
    column_spec(1, bold = TRUE) %>%
