...
However, the odds ratio could also be computed using the odds within the columns (i.e., comparing the *columns*), rather than within the rows.
...
if( knitr::is_latex_output() ) {
  KidneySmall.Sum[3, 1] <- paste0("\\llap{Difference:\\ \\ }$\\phantom{0}",
                                  KidneySmall.Sum[3, 1],
                                  "$")
  KidneySmall.Sum[3, 2] <- paste0("\\llap{Odds ratio:\\ }$\\phantom{0}",
...
if( knitr::is_html_output() ) {
  ...
  KidneySmall.Sum[3, 1] <- paste0("Difference: $\\phantom{0}",
                                KidneySmall.Sum[3, 1],
                                "$")
  KidneySmall.Sum[3, 2] <- paste0("Odds ratio: $\\phantom{0}",
                                round( as.numeric(KidneySmall.Sum[3, 2]), 2),
                                "$")
...
if( knitr::is_html_output() ) {
  WANumericalSummary[3, 1] <- paste0("Difference: $",
                                     WANumericalSummary[3, 1],
                                     "$")
  WANumericalSummary[3, 2] <- paste0("Odds ratio: $",
                                     WANumericalSummary[3, 2],
                                     "$")
