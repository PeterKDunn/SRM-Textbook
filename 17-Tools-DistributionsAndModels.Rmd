...
The [Australian Bureau of Statistics (ABS)](http://www.abs.gov.au/ausstats/abs@.nsf/Lookup/4338.0main+features212011-13), however, takes samples of Australians to compute estimates of the 
...
Then, the *distribution* of the heights of Australian adult males may look like Fig. \@ref(fig:HeightsModel).
...
Proceeding as before, we need to ask 'How many standard deviation below the mean is 160cm?'
...
* **Draw a diagram**: 
  Mark on 160&nbsp;cm (Fig. \@ref(fig:HtsExer3)).
...
<iframe src="https://learningapps.org/watch?v=ppievv9gc22" style="border:0px;width:100%;height:600px" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
...
Drawing a picture of the situation is important: it helps visualise how to get the answer from what the table give us.
