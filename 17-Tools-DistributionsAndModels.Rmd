...
```{r HeightsModelFig, echo=FALSE, fig.align="center", fig.width=5, fig.height=3.5, fig.cap="The model for heights of Australian adult males, plus the histogram from one specific sample if size $n=100$ of Australian adult males" }
...
```{r NormalMiddleFig, echo=FALSE, fig.align="center", fig.height = 4,fig.width=6, fig.cap="Finding the area (probability) between two $z$-scores" }
if (knitr::is_latex_output()){
       plot.norm(RT.mn, 
                 sd = RT.sd, 
                 width = 5, 
