...
::: {.example label=RQs name="Normal distributions"}
...
We can draw this normal distribution (Fig. \@ref(fig:RetentionTime)).
We can then apply the 68--95--99.7 rule:
...
mcq( c(
   ...
   "-1.49",
   "-6.5") )}`
* Using the [normal distribution tables](ZTablesOnline), what is the area to the left of $z = -1.77$?
`r if( knitr::is_html_output(exclude = "epub")) {
mcq( c(
   "0.9192", 
   "0.9616",
