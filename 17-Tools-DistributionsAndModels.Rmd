...
In the [decision-making process used in statistics](#DecisionMaking), an *assumption* is made about the population parameter.
Then, based on this assumption, we describe the values of the statistic that we would *expect* from all possible samples.
...
Under [certain circumstances](#ValidityProportions), many sample statistics have a similar-shaped distribution: a [*bell-shaped (or normal) distribution*](#NormalDistributions).
...
```{r HeightsModel, echo=FALSE, out.width='95%', results='hide', fig.cap="A model for the heights of Australian adult males, showing 1, 2 qnd 3 standard deviations either side of the mean (left); the model for heights of Australian adult males, plus the histogram from one specific sample if size $n = 100$ of Australian adult males (right)", fig.align="center", fig.width=7.75, fig.height=2.5}
HT.mn <- 175
HT.sd <- 7
...
```{r HtsExer1, echo=FALSE, fig.cap="Left: What proportion of Australian adult males are taller than 182cm? Right: What proportion of Australian adult males are shorter than 161cm?", fig.align="center", fig.width=7.5, fig.height=2.5, out.width='90%'}
...
```{r HtsEmpirical, echo=FALSE, fig.cap="The empirical rule and heights of Australian adult males", fig.align="center", fig.width=6.0, fig.height=2.75, out.width='65%'}
...
```{r HtsExer3, echo=FALSE, fig.cap="What proportion of Australian adult males are shorter than 160cm?", fig.align="center", fig.width=7.0, fig.height=2.75, out.width='70%'}
...
```{r MatchDiagrams, echo=FALSE, fig.cap="Match the diagram with the description",  fig.align="center", out.width="85%", fig.height=4.5}
par( mfrow = c(2, 2))
...
```{r ZDBH3, echo=FALSE, fig.cap="What proportion of tree diameters are between 6 and 11 inches? The two shaded areas given are what we find by using the tables with $z = -1.04$ and $z = 0.81$, but neither give us the area we are seeking", fig.align="center", fig.width=9.5, fig.height = 2.75,out.width='100%'}
...
```{r WorkingWithZ, echo=FALSE, fig.cap="Working with $z$-scores", fig.align="center", out.width='70%'}
...
```{r DBHBackwards, echo=FALSE, fig.cap="Tree diameters: The smallest 10\\%", fig.align="center", out.width='60%', fig.width=6.5, fig.height=2.75}
out <- plotNormal(mu,
                  sigma,
                  main = "Smallest 10% of trees",
                  xlab = "Tree diameters (in inches)")
shadeNormal(out$x,
            out$y,
            col = plot.colour,
...
text(5.344, 
     ...
     pos = 3, 
     cex = 1)
lines(x = c(5.344, 5.344),
      y = c(0, max(out$y) * 0.775),
      col = "grey",
      lwd = 2)


arrows(2, max(out$y) * 0.55, 
       4.5, max(out$y) * 0.1, 
       angle = 15, 
       length = 0.15, 
       lwd = 2) 
text(2, max(out$y) * 0.55, 
     "Approx. 10%", 
     pos = 3)
```
...
arrows(15, max(out$y) * 0.7, 
       13, max(out$y) * 0.1, 
       angle = 15, 
       length = 0.15, 
       lwd = 2) # Note: Locations in terms of z-scores
text(15, max(out$y) * 0.7, 
     "Largest 25%", 
     cex = 0.9,
     pos = 3)
...
```{r IQMatchDiagramsForwards, echo=FALSE, fig.cap="Match the diagram with the description", fig.align="center", out.width="100%", fig.height=3.75, fig.width=6.5}
par( mfrow = c(2, 2),
     mar = c(4, 1, 1, 2) + 0.1)
...
```{r IQMatchDiagramsBackwards, echo=FALSE, fig.cap="Match the diagram with the description", fig.align="center", out.width="100%", fig.height=3.75, fig.width=6.5}
par( mfrow = c(2, 2),
     mar = c(4, 1, 1, 2) + 0.1)
