...
```{r HeightsModelMovie, animation.hook="gifski", cache=FALSE, dev=if (is_latex_output()){"pdf"}else{"png"}}
...
```{r HtsExer1, fig.cap="Left: What proportion of Australian adult males are taller than 182cm? Right: What proportion of Australian adult males are shorter than 161cm?", fig.align="center", fig.width=7.5, fig.height=3, out.width='90%'}
...
```{r HtsEmpirical, fig.cap="The empirical rule and heights of Australian adult males", fig.align="center", fig.width=6.0, fig.height=2.75, out.width='62.5%'}
