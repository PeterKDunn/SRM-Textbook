...
```{r WorkingWithZ, echo=FALSE, fig.cap="Working with $z$-scores. In the tables, the areas (probabilitues) are in the body of the table, and the $z$-scores are in the margins of the table.", fig.align="center", out.width='70%', fig.height=2.25, fig.width=7}
