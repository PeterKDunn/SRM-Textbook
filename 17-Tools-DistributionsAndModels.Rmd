...
```{r HeightsModelMovie, echo=FALSE, animation.hook="gifski", cache=TRUE, dev=if (is_latex_output()){"png"}else{"pdf"}}
...
```{r echo=FALSE, animation.hook="gifski", cache=TRUE, dev=if (is_latex_output()){"png"}else{"pdf"}}
  RT.mn <- 8.8
  RT.sd <- 2.7
