...
That is, knowing information about the age of the deer seems to provide some information about the weight of the molars.
...
## Statistical hypotheses and the test {#CorrelationHT}
...
Since the relationship is approximately linear, the variation in heights do not seem to differ for different lengths, and the sample size is larger than $25$, the test is statistically valid.
