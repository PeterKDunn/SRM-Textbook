...
Recall that the *the standard error is just a special standard deviation*, that measures how much a sample estimate is likely to vary from sample to sample.
