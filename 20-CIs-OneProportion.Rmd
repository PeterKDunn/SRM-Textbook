...
so no-one knows what proportion will be even for any sample of 25 rolls.

In addition,
the proportion of the 25 rolls that will be even
will not be the same for every sample of 25 rolls.
...
Each sample of $n = 25$ rolls is a *sample* of all possible sets of $n=25$ rolls,
...
for every sample of 25 rolls.

These thousands of sample proportions $\hat{p}$, 
one from every sample of 25 rolls,
...
is not the same in every sample of 25 rolls.
That is, 
$\hat{p}$ varies,
and exhibits 
*sampling variation*.
...
when the value of $p$ is known is
given by
...
could be recorded for each sample of 20 rolls.
...
rolls that show as **one** for each sample of 60 rolls.
