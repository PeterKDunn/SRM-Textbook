...
```{r RollDice, echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.5, dev=if (is_latex_output()){"pdf"}else{"png"}}
...
<center>
```{r fig.show="animate", RollDiceHistHTML, echo=FALSE, cache = TRUE, animation.hook="gifski", cache=TRUE, interval=0.0005, loop=FALSE, dev=if (is_latex_output()){"pdf"}else{"png"}}
if (knitr::is_html_output()){
  set.seed(990099)
    num.rolls <- 25
    num.sims <- 1000
...
```{r RollDiceCIMovie, echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.1, dev=if (is_latex_output()){"pdf"}else{"png"}}
if (knitr::is_html_output()){
  set.seed(99999)
    num.rolls <- 25
    num.sims <- 50
