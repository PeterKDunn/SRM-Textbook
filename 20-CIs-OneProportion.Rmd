...
```{r, pProducingpHat, out.width='100%', fig.width=6, fig.height=2, fig.align="center", fig.cap="Various possible values for $p$, and the values of $\\hat{p}$ these are likely to produce."}
par(mfrow = c(1, 4),
    mar = c(4, 0.3, 4, 0.3) )
