...
```{r NormalDieTheory, echo=FALSE, fig.cap="The normal distribution, showing how the proportion of even rolls varies when a die is rolled 25 times", fig.align="center", fig.width=6, fig.height=2.5, out.width='65%'}
pop.p <- 0.5
n <- 25
...
Based on this picture, how often would a value of $\hat{p}$ larger than 0.80 be expected?
