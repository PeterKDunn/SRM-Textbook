...
```{r RollDiceHistFig, echo=FALSE, fig.align="center", fig.height = 3, fig.width=6.5, fig.cap="The proportion of rolls that are even change from one sample of 25 rolls to the next sample of 25 rolls" }
if (knitr::is_latex_output()){
  set.seed(990099)
    num.rolls <- 25
    num.sims <- 1000
...
```{r HistoProportionsConditions, echo=FALSE, fig.width=7, fig.height=3.0, out.width = '90%', fig.align="center", fig.cap="The sampling distribution of the proportion of ones rolled, for sets of 20 rolls (left panel) and sets of 60 rolls (right panel)" }
par( mfrow = c(1, 2),
