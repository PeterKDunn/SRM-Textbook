...
More precisely, a value of $p$ between $0.44 - 0.199$ and $0.44 + 0.199$  could reasonably be expected to produce the observed value of $\hat{p}$ (Fig. \@ref(fig:CIrelationshipsCI)).



```{r CIrelationshipsCI, echo=FALSE, out.width='75%', fig.align="center", fig.cap="A CI gives a range of possible values of $p$ for which it is reasonable to produce the observed value of $\\hat{p}$ values. The shaded regions represent the regions containing 95\\% of the values of $\\hat{p}$ for each value of $p$.", fig.width=7, fig.height=8}
