...
```{r HistoProportionsConditions, echo=FALSE, fig.width=7, fig.height=5, fig.align="center", fig.cap="The sampling distribution of the proportion of ones rolled, for sets of 20 rolls (bottom panel) and sets of 60 rolls (right panel)" }
par( mfrow = c(1, 2),
