...
## Numerically describing linear relationships {#CorrelationNumerical}
...
abline( h = mean(RedDeer$Weight),
        lwd = 2,
        col = "grey")
mtext(text = expression(~bar(italic(y))),
      side = 4, 
      las = 1)
...
Hence, numerical summaries here are described specifically for *linear* relationships.
...
If the relationship is linear, the measures described in Sect.\ \@ref(CorrelationNumerical) may also be added to the summary table.



:::{.example #CorrelationSummaryTable name="Summary table"}
For the red-deer data, a summary table is show in Table\ \@ref(tab:RDSummaryTable).
:::
