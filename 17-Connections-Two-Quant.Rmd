...
# Relationships: quantitative data correlations {#TwoQuant}
...
For this reason, *we now focus just on linear relationships*, and discuss numerically summarising *linear relationships*.
