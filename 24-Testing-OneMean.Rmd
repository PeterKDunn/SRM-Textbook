...
```{r, child = if (knitr::is_html_output()) {'./introductions/24-Testing-OneMean-HTML.Rmd'} else {'./introductions/24-Testing-OneMean-LaTeX.Rmd'}}
```
...
::: {.definition #DEFSamplingDistributionXbar name="Sampling distribution of a sample mean for $\sigma$ unknown"}
