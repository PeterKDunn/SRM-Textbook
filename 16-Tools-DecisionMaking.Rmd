...
In Sect.\ \@ref(NHANESSummaryTable), the NHANES data [@data:NHANES3:Data] were numerically summarised.
...
1. The two *population* means are the *same*; the difference between the *sample* means is due to *sampling variation*.
...
Similarly, in Sect.\ \@ref(NHANESSummaryTable) the *odds* of being diabetic were different for smokers ($0.181$) and non-smokers ($0.078$).
...
2. Alternatively, the *population* odds are different, and the *sample* odds reflect this.
