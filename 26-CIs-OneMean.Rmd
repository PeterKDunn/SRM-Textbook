...
If thousands of people made one set of $25$ rolls each, and computed the mean for their set, every person would have a sample mean for their sample of $25$ rolls, and we could produce a histogram of all these sample means;
`r if (knitr::is_latex_output()) {
...
\[
  ...
  \frac{ s }{\sqrt{n}},
\]
where $s$ is the sample standatd deviation.
...
Using data from the NHANES study, the approximate $95$% CI for the mean direct HDL cholesterol is $1.356$ to $1.374$\ mmol/L.
