...
So, the [$68$--$95$--$99.7$ rule](#def:EmpiricalRule) could be used to construct an approximate $95$% interval for the plausible values of $\mu$ that may have produced the observed values of the sample mean.
...
The multiplier is not a $z$-score here.
...
Whether the population has a normal dusrribution is obviouslty difficult; we do not have access to the whole population.
