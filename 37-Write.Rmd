...
USC describes plagiarism in a university context
this way:


```{definition, Plagiarism, name="Plagiarism"}
*Plagiarism* occurs when a student 
uses---without acknowledging---the work of other people. 
In a sense, 
plagiarism is a form of intellectual theft in which 
ideas, words, information or images are taken without attribution. 
Plagiarism can be deliberate or accidental:

* Deliberate---for instance, 
  if a student intentionally copies the work of others 
  and pretends it is their own work.
* Accidental---for instance,
  if a student has poor notetaking skills or 
  doesn't know how to reference correctly, 
  and they inadvertently present someone else's ideas
  and words as their own.

([USC webpages](https://www.usc.edu.au/learn/student-support/academic-and-study-support/online-study-resources/academic-integrity))
```

The USC webpage continues:

> ... one of the best ways to avoid plagiarism 
> is to know what it looks like. 
> An illustrative demonstration of the common types of plagiarism 
> is outlined in the 
> [Turnitin website](turnitin.com/assets/en_us/media/plagiarism-spectrum/).
...
> Which font allows USC students to read a pangram the fastest,
