...
```{r RandomAllocationHimalaya, echo=FALSE, fig.cap="Random allocation can occur in two places for the Himalaya study", fig.align="center", fig.height=3, out.width='70%'}
...
```{r RandomAllocationGeneral, echo=FALSE, fig.cap="Random allocation in general, with more than two treatments and groups", fig.align="center", fig.height=3, out.width='70%'}
showStudyDesign(studyType = "TrueExp",  
                addIndividuals = TRUE,    
                addImages = FALSE,
...
shape::emptyplot(ylim = c(0.1, 0.9), # No change
                   xlim = c(0, 1),
                   asp = NULL) # ELSE  asp=1 or requested


### WITHOUT Washout
polygon( x = c(0.16, 0.16, 0.52, 0.52),
         y = c(0.63, 0.79, 0.79, 0.63),
         lwd = 1, 
         border = "grey")
polygon( x = c(0.58, 0.58, 0.94, 0.94),
         y = c(0.63, 0.79, 0.79, 0.63),
         lwd = 1, 
         border = "grey")
...
```{r, BlindingThirdParty, echo=FALSE, fig.align="center", fig.cap="Using a third party to avoid the observer effect", fig.height=3, out.width='75%'}
showStudyDesign(studyType = "TrueExp",
                addIndividuals = TRUE,
                addThirdParty = TRUE)   
```
...
In these cases, the possibe impacts should be minimized as far as possible, and then the likely impact on the conclusions discussed.
