...
```{r  BlockingHimalaya, echo=FALSE, message=FALSE, fig.cap="(ref:BlockingHimalaya)",  fig.align="center", fig.width=8, fig.height=6, out.width="90%"}
...
Three active analgesics (pain relievers) were compared to four different-coloured placebo [@data:Huskisson1974:placebo].
