...
Whether the VR method was used first or not (Table \@ref(tab:CompressionTable)), the percentage relaxation change little when using the real-life method, and was far higher than the target of 50%.
