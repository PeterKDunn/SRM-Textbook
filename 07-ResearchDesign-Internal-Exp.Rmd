...
A study on the bruising of apples [@doosti2016development] aimed to determine the relationship between the recorded surface temperature of the apple, the depth of bruising.
...
by incorporating potential confounding variables in the analysis.  
`r if( knitr::is_html_output(exclude = "epub") ) {torf( TRUE)}`
1. True or false: The researchers could use random allocation of the treatments to  apples to minimise confounding.  
`r if( knitr::is_html_output(exclude = "epub") ) {torf( TRUE)}`
