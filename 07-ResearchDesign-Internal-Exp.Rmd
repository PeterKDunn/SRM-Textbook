...
```{example DesignExample, "Stuydy design"}
...
Participants could not, however, be blinded to which group they were in (dominant hand pon chest; non-dominant hand on chest).
