...
Sometimes,
researchers can *randomly allocation* the  *order* in which the treatments (i.e., the diets) are used.
That is,
...
The impact of the observer effect can be minimized by blinding the researchers so that they do not know:
