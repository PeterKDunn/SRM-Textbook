...
Whether the VR method was used first or not (Table \@ref(CompressionTable)), the percentage relaxation change little when using the real-life method, and was far higher than the target of 50%.
...
Compressions[2, ] <- c("VR:",
                       ...
                       "RL, then VR:",
                       45.4)
colnames(Compressions) <- c("Real life",
                            "% relaxation",
                            "Virtual reality",
                            "% relaxation")
