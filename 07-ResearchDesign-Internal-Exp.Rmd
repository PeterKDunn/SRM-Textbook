...
```{example name="Exclusion criteria"}
...
```{example name="Random allocation"}
In the *Himalaya 292* study,
...
```{example name="Carry-over effect"}
...
```{example name="Study limitations"}
