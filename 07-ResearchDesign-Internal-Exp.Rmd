...
other possible issues that might influence the value of the response variable should be eliminated.
...
Consequently, all the farmers' yields changed.
...
* [Managing observer bias by blinding the researchers](#ObserverEffectExperimental); and
* [Managing the placebo effect using controls](#PlaceboEffectExperimental).
...
## Other biases {#OtherBiases}



| Name          | Who/what is aware                                | What changes/is compromised
|---------------|--------------------------------------------------+------------------------+-------------------------
| [Hawthorne]() | * Individuals: aware of being in a study         | Behaviour of, or reporting by, **individuals**
| effect        | * Individuals: aware of C                        |
| [Placebo]()   | Individuals: *think* they are in a study,        | Behaviour of, or reporting by **individuals**
| effect        | or in a specific C                               | 
| [Observer]()  | Researcher is aware of C                         | Behaviour of **researchers**, especially when
| bias          |                                                  | measuring or observing values of the response variable
| [Observer-expectancy]() | Researcher: aware of C, which          | Behaviour of **researchers** (unconsciously), which subsequently changes the   
| effect        | is unconsciously communicated to **individuals** | behaviour of, or reporting by, **individuals**
...
This could also compromise the [internal validity](#def:InternalValidity) of the study.
...
### Observer-expectancy effect and blinding researchers {#ObserverEffectExperimental}

What if the *researchers* assessing the outcomes *knew the diet* allocated to each patient?

Perhaps surprisingly,
this can mean that the reseachers may (unconsciously) have expectations for how the individuals are managed,
and how the data (and especially the values of the response variable) are recorded from the individuals.
...
* the *individuals* to change their behaviour to conform to those expectations; and/or 
* the *researchers* to unconsciously change how the data (especially the values of the response variable) are recorded.

Typically, the observer-expectancy effect occurs when the observer (i.e., the researcher) knows the comparison or connection for the individuals.
```
...
When participants are blinded in as many ways as possible, the internal validity of the study is increased.
However,
