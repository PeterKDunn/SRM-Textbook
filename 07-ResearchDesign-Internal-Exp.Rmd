...
Specific design strategies for maximising [internal validity](#def:InternalValidity) include:
...
Any difference  in faecal weight detected between the two groups may not be because of the diets (Table\ \@ref(tab:ConfoundingGroups)): the study has very poor internal validity, due to poor study design.
