...
other possible issues that might influences the value of the response variable should be eliminated.
...
```{example InternalValidity, name = "Poor internal validity"}
...
this may means that the influence of one treatment 
