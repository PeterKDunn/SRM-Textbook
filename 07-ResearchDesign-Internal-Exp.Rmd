...
Ginko[2, ] <- c("Men (number; percentage)", "46 (41)", "45 (42)")
...
## Observer bias and blinding researchers {#ObserverEffectExperimental}
...
This is called the *observer effect*\index{observer bias}
or *observer bias*

occurs when the investigator is aware of the disease status, treatment group or outcome of the subject and their ability to interview the subject, collect or analyse the data in an unbiased manner is compromised. Sim


In experiments, sometimes called the *experimenter effect*).\index{experimenter effect}
...
occurs when researchers are *unintentionally* influenced by the individuals.
