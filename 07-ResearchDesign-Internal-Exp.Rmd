...
by reducing the possibility that other explanations are eliminated.
...
In general, by making the individuals unaware ([blinding](#Blinding)) that they are in a study,
...
and may (unconsciously) influence how the data (and especially the values of the response variable) are recorded from the individuals.
