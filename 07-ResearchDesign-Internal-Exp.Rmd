...
To draw solid conclusions, a well-designed study is needed: a study with high [*internal validity*](#def:InternalValidity):  a study that shows that the changes in the response variable can be attributed to changes in the explanatory variables, and other explanations have been ruled out.
Many aspects of the design must be considered to achieve this goal, some of which are discussed in this chapter (for experimental studies).


::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
Study design aims to maximise internal validity: to design a study to isolate the relationship of interest, by eliminating, as far as possible, all other possible explanations.
:::
...
* The different *ages* in each group (Group\ A is likely to be younger on average; Group\ B is likely to be older on average);
...
For example, the age of the subject may be related to faecal weight (older people tend to eat less, and differently, than younger people), and the study design means that older people are more likely to consume the refined cereal.
This is an extreme case of *confounding*; usually, confounding is more subtle (and more difficult to detect) than in this example.
...
Participants could be *randomly allocated* into one of two groups, so both groups would similar spreads of ages (and other potential confounders)
...
* *Random sampling* impacts *external* validity, and concerns *finding individuals* to study.
...
For example, a study aiming to increase fruit and vegetable intake in young adults [@clark2019educational] noted that the observed increases in intake 'could be explained by the Hawthorne effect' as 'know they are being observed...'.
:::
...
* To explain some variation in the response variable, using special methods of analysis, so that the relationship between the response and explanatory variable can be revealed (Sect.\ \@ref(ExtraneousVariables)).
