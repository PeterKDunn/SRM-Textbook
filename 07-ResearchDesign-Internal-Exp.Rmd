...
Ideally, we would like to be able to rule out any other reason for the changes in the values of the respomse variable,
...
may (unconsciously) influence how the researchers interact with the individuals, and perhaps (unconsciously) influence the behaviour of the individuals.
...
The impact of observer expectany can be minimized by blinding the researchers so that they do not know:
...
```{example ObsBiasPain, name = "Observer}
