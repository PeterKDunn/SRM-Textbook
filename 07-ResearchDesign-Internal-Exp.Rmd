...
\index{Internal validity!experimental studies}\index{Research design!experimental|(}
...
Some research design decisions to maximise internal validity are discussed in this chapter (for experimental studies).
...
Suppose that the researchers for the *Himalaya 292* study created two groups of individuals:
...
The refined cereal acted as a benchmark; like a *placebo*.\index{Placebo}
...
In the *Himalaya* study, the diet is a *between-individuals* comparison: one group of patients was given the refined cereal diet (the control), and a different group of people was given *Himalaya 292*.
...
\index{Research design!experimental|)}
...
Paramedics were involved in a study to compare two new pills (Treatment\ A; Treatment\ B) to treat Post Traumatic Stress Disorder (PTSD). 
