...
Whether the VR method was used first or not (Table \@ref(tab:CompressionTable), first columns), the percentage relaxation change little when using the real-life method, and was far higher than the target of 50%.
...
For clarity, explicitly stating who or what is blinded---and in what ways---is recommended.
...
In a cropping study comparing yields from modern and traditional cowpea crops in Tanzania [@bulte2014behavioral], the researchers wanted to use a double-blind study, so the two seed types ('traditional' and 'modern') were made similar in appearance: "the seed types must be indistinguishable in terms of size and color" (p. 817).
...
* To compare the sample to the population, to see if the sample is representative (external validity; Sect. \@ref(Representative-samples)).
...
* the *placebo effect* (e.g., by blinding participants to the treatments and by using *controls*); and
