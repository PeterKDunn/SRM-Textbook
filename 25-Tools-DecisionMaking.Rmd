...
## Making decisions: an example {#DecisionMaking}
...
4. *Make a decision*.
   If the observed *sample statistic*:
    ...
    - could have easily been explained by chance, the statistic (i.e., the evidence) is *consistent with* the assumption about the *parameter*, and the assumption may be (but is not certainly) *correct*.
...
A student researcher takes a sample of $n = 40$\ students from the School of Arts to determine if students in the School of Arts are somehow different from the general university population in terms of age.
