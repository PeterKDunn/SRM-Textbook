...
Different samples comprise different households, and the sample results depends on which households are in the studied sample.
...
```{r DecisionFlowCards, fig.cap = "A way to make decisions for the cards example.", fig.align="center", out.width='100%', fig.width = 9.5, fig.height = 4, cache=FALSE}  
source("R/showDecisionMaking.R")
