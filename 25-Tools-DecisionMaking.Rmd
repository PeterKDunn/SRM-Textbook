...
2. Based on that assumption, you *expected* about half the cards in the sample of\ $25$ to be red (i.e., expect\ $\hat{p}$ to be about\ $0.5$).
   You wouldn't necessarily expect *exactly* half red cards (because of sampling variation), but you'd probably expect that\ $\hat{p}$ would be close to\ $0.5$.
...
This is one way to describe the decision-making process in science, as depicted in
