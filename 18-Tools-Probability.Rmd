...
The colour of the two cards is recorded (B: Black; R: Red), and we are interested in Event\ $D$: 'the total number of black cards drawn, minus the total number of red cards drawn'.
