...
We do not know beforehand what distance your next throw will be, but the *sample space* (the throwing distance) is a number greater than $0$\ms (and some of those distances are *very* unlikely to occur).
...
Because the sample space is continuous, throwing an *exact* distance (such as *exactly*\ $10$\ms) is technically not possible.
:::
