...
1. The sample odds ratio, with both samples of size $n = 43$.
:::
...
1. The sample mean of a set of differences $\bar{d}$, with a sample of $n = 32$ difference, but slightly right-skewed distributions of the data.
