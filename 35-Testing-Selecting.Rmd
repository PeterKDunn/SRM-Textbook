...
They compared the mean lead concentration in blood and feathers, for birds in neighborhoods with *low* and with *high* lead levels; this is a *relational RQ*.

For each bird (the unit of analysis), three variables were recorded.
The *neighborhood* (the explanatory variable)  is qualitative with two levels: high lead-level neighbourhoods, and low lead-level neighbourhoods.
