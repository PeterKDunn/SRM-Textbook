...
If the relationships are approximately linear (determined by a examining the two scatterplots), a test for correlations (and corresponding CI, if available from software) would be used, for one each relationship to be studied.
...
The *neighborhood* (the explanatory variable)  is qualitative with two levels: high-lead levels, and low lead-levels.
