...
Statistical software\index{Software output!mean difference} produces *exact* $95$%\ CIs, which may be slightly different from the *approximate* $95$%\ CI (recall: the $68$--$95$--$99.7$ rule gives *approximate* multipliers).
