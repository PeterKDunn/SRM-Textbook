...
plot(x = c(-40, 80),
     ...
     ylab = "Frequency",
     sub = "(30 m distance minus 20 m distance)",
     las = 2,
     type = "n",
...
```{r FruitDescriptivesjamovi, fig.cap="Software output for the fruit data.", fig.align="center", out.width='100%'}
...
1. Perform a hypothesis test to compare the change in mean minutes of vigorous PA (including a\ CI).
:::
...
SWlen <- length(StudentWt$WtWk1)

Labels <- 1 : length(StudentWt$Student)

tb1 <- array( cbind( Labels[1:5 ],
                     StudentWt$WtWk1[1:5 ],
                     StudentWt$WtWk12[1:5 ],
...
tb2 <- array( cbind( Labels[(SWlen - 4):SWlen ],
                     StudentWt$WtWk1[(SWlen - 4):SWlen ],
                     StudentWt$WtWk12[(SWlen - 4):SWlen ],
