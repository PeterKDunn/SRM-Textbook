...
```{r echo=FALSE, animation.hook="ffmpeg", cache=TRUE, interval=0.4}
# SRS
if (knitr::is_html_output()){
...
```{r echo=FALSE, animation.hook="ffmpeg", cache=TRUE, interval=0.2}
...
```{r echo=FALSE, animation.hook="ffmpeg", cache=TRUE, interval=0.75}
 if (knitr::is_html_output()) {
    # CLUSTER
...
```{r animation.hook="ffmpeg", cache=TRUE, echo=FALSE, interval=1.5}
if (knitr::is_html_output()){
   for (i in 1:4){
