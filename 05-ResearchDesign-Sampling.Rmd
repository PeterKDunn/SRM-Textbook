...
In a well-designed study, the researchers learn about the population by studying just the sample.
That is, the sample that is studied is representative of the intended population.
...
A study is *externally valid* if the results from the sample can be generalised to the population, which is only possible if the sample faithfully represents the population.\index{External validity}
...
This second sample would not represent all Americans either (it would *under*-represent).
