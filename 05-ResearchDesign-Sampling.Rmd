...
```{r PrecisionAccuracy, echo=FALSE,fig.align="center", fig.cap="Precision and accuracy: Each dot is where a shot lands, and is like a sample estimate of the population value (shown by the black central dot)", fig.width=5.0, out.width='55%'}
par( mfrow = c(2,2),
     mar = c(1, 1, 1, 1),
