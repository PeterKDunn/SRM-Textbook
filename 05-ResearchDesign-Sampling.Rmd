...
```{r animation.hook="gifski", cache=FALSE, interval=0.4, fig.height = 6.5, dev=if (is_latex_output()){"pdf"}else{"png"}}
# SRS
if (knitr::is_html_output()){
...
```{r animation.hook="gifski", cache=FALSE, fig.height = 6.5, interval=0.4, dev=if (is_latex_output()){"pdf"}else{"png"}}
# Systematic
if (knitr::is_html_output()){
...
```{r, animation.hook="gifski", cache=FALSE, interval=0.2, fig.height = 6.5, dev=if (is_latex_output()){"pdf"}else{"png"}}
...
```{r animation.hook="gifski", fig.height = 6.5, cache=FALSE, interval=0.75, dev=if (is_latex_output()){"pdf"}else{"png"}}
 if (knitr::is_html_output()) {
...
```{r animation.hook="gifski", cache=FALSE, interval=0.75, fig.height = 6.5, dev=if (is_latex_output()){"pdf"}else{"png"}}
if (knitr::is_html_output()){
