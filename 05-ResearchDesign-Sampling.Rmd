...
```{r DealCards, echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.20, dev=if (is_latex_output()){"pdf"}else{"png"}}
library(png)
...
```{r echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.4, dev=if (is_latex_output()){"pdf"}else{"png"}}
# SRS
if (knitr::is_html_output()){
...
```{r echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.2, dev=if (is_latex_output()){"pdf"}else{"png"}}
...
```{r echo=FALSE, animation.hook="gifski", cache=TRUE, interval=0.75, dev=if (is_latex_output()){"pdf"}else{"png"}}
 if (knitr::is_html_output()) {
    # CLUSTER
...
\begin{wrapfigure}{R}{.25\textwidth}
  \begin{center}
    \includegraphics[width=.20\textwidth]{Illustrations/pexels-thisisengineering-3912979.jpg}
  \end{center}
\end{wrapfigure}
`r if (knitr::is_html_output()) '-->'`
...
```{r animation.hook="gifski", cache=TRUE, echo=FALSE, interval=1.5, dev=if (is_latex_output()){"pdf"}else{"png"}}
if (knitr::is_html_output()){
   for (i in 1:4){
