...
This second sample would not be expected to represent all Americnas either (it would *under*-represent).
...
2. *Randomly* select one floor, and select the 20 apartments on that floor cloest to the elevators, then interview the oldest resident of that apartment.
...
Four possible sampling schemes are listed below; describe the type of sampling used.
...
2. The researcher waits at the main entrance for $30$ minutes at $8$am every morning for a week, and approaches every 5th person. 
