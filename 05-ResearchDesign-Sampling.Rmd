...
Almost always, a subset of the population (a *sample*) is studied, comprising some *individuals* from the population.
...
Hence, the results of studying a sample depends on which individuals happen to be in the studied sample.
...
One key to obtaining accurate estimates about the population from the sample (i.e., ensuring externally validity) is to ensure that the sample faithfully represents the population of interest.
...
* *Voluntary* response (self-selecting) sample:
  ...
  For example, researchers may ask people to volunteer to participate in a survey.
...
The results generalise to the population which the sample *does* represent.
...
Sometimes, practicalities dictate how the sample can be obtained, which may result in a non-random sample.
...
The researchers select some schools by asking school principals to volunteer their schools, then record information for *every* teacher in the chosen schools.
