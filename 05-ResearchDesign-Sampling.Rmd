...
if( knitr::is_html_output() ) {
   ...
   SampleTypes[1, 5] <- "![](./Pics/iconmonstr-chart-22-240.png){#id .class height=90px}"
   SampleTypes[2, 5] <- "![](./Pics/iconmonstr-layer-17-240.png){#id .class height=90px}"
   SampleTypes[3, 5] <- "![](./Pics/iconmonstr-view-5-240.png){#id .class height=90px}"
   SampleTypes[4, 5] <- "![](./Pics/iconmonstr-view-4-240.png){#id .class height=90px}"
