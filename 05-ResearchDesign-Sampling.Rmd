...
cannot possibly use every single human alive who might one day wish to take aspirin.
...
The last issue must be left [until later](#EstimatingSampleSize),
...
<div>
<iframe src='https://www.ferendum.com/en/embeded.php?pregunta_ID=879051&sec_digit=620571698&embeded_digit=541828783' style='width:100%; height:400px; overflow: auto;' frameBorder='0'></iframe><BR />
...
* The *type* of sampling (i.e., the way in which the samples is selected) 
...
because each possible sample value will produce similar estimates, 
...
In fact, 
the sample may give a precise and accurate answer to a *different* question:
...
(Remember that *random* means that the sample is determined completly by chance!)
...
Ideally,
**students would not be included more than once in our sample**,
...
(Answer is here^[Stratified sampling].)
:::
...
(Answer is here^[Non-response bias].)
:::
