...
A study is [*externally valid*](#def:ExternalValidity) if the results from the sample can be generalised to the population, which is only possible if the sample faithfully represents the population.
...
:::{.example}
In a 'population' as small as $100$, the number of samples of size $25$ is more than twice the number of people on earth.
:::
