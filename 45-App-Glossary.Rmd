...
*Bias* can be introduced at any part of the research prcoess,
...
[Collusion](#Collusion)
: *Collusion* occurs when people work together to produce a work, but only one gets the credit
for it.
...
is another name for *observer bias* in experimental studies
(that is,
when the researchers are *unintentionally* influenced the subjects).
...
: A *nominal* qualitative variable is a qualitative variable where the levels
...
to (potentially) change the response of the participants. 
 ...
 [Observer bias](#def:ObserverEffect)
: *Observer bias*
is when researchers are *unintentionally* influenced by subjects,
in experimental studies (Sect. \@ref(ObserverEffectExperimental))
or observational studies (Sect. \@ref(ObserverEffectExperimental)).
Typically, observer bias occurs when the observer (i.e., the researchers) know the comparison or connection for the individuals.
...
: An *ordinal* qualitative variable is a qualitative variable where the levels
