...
<img src="07-ResearchDesign-Internal_files/figure-html/unnamed-chunk-7-1.png" width="65%" height="33%" style="display: block; margin: auto;" />
...
This chapter discusses some research design decisions to maximise internal validity.
...
<img src="07-ResearchDesign-Internal_files/figure-html/unnamed-chunk-5-1.png" width="95%" />
...
<caption>(\#tab:ConfoundingGroups)Comparing Groups A and B: an extreme example of confounding.</caption>
<tbody>
  <tr>
   <td> 
...
<tbody>
  <tr>
   <td style="text-align:center;"> ![](./Pics/iconmonstr-candy-5-240.png){#id .class height=60px}<br>
               ![](./Pics/iconmonstr-arrow-down-thin-240.png){#id .class height=50px} <br>
               ![](./Pics/iconmonstr-generation-4-240.png){#id .class height=60px} </td>
  </tr>
</tbody>
</table>
...
<tbody>
  ...
  <tr>
   <td style="text-align:center;"> Younger (in general) </td>
   <td style="text-align:center;"> *Age* </td>
   <td style="text-align:center;"> Older (in general) </td>
  </tr>
  <tr>
   <td style="text-align:center;"> *Himalaya 292* </td>
   <td style="text-align:center;"> *Cereal* </td>
   <td style="text-align:center;"> Refined </td>
  </tr>
  <tr>
   <td style="text-align:center;"> Very fit (in general) </td>
   <td style="text-align:center;"> *Fitness* </td>
   <td style="text-align:center;"> Less fit (in general) </td>
  </tr>
</tbody>
</table>
...
<tbody>
  <tr>
   <td style="text-align:center;"> ![](./Pics/iconmonstr-candy-8-240.png){#id .class height=60px} <br>
               ![](./Pics/iconmonstr-arrow-down-thin-240.png){#id .class height=50px} <br>
               ![](./Pics/iconmonstr-generation-15-240.png){#id .class height=60px} </td>
  </tr>
</tbody>
</table>
...
<img src="07-ResearchDesign-Internal_files/figure-html/ConfoundingDiagram-1.png" alt="An extreme example of confounding." width="55%" />
<p class="caption">(\#fig:ConfoundingDiagram)An extreme example of confounding.</p>
</div>
...
For this reason, the control group\index{Control group} comprised trees on which the researchers applied water.\index{Control} 
...
That is, each person is paired with another person of the same sex and of a similar age and weight; one of each pair is given the *Himalaya\ 292* diet, and the other is given the refined cereal diet. 
...
Then, these extraneous variables can be included in the analysis.
...
(ref:RandomAllocationHimalaya) Random allocation can occur in two places for the *Himalaya* study.

<div class="figure" style="text-align: center">
<img src="07-ResearchDesign-Internal_files/figure-html/RandomAllocationHimalaya-1.png" alt="(ref:RandomAllocationHimalaya)" width="65%" />
<p class="caption">(\#fig:RandomAllocationHimalaya)(ref:RandomAllocationHimalaya)</p>
</div>
...
<table>
<caption>(\#tab:ginkgoDemographics)Comparing the two groups in the ginkgo-memory study.</caption>
 <thead>
  <tr>
   <th style="text-align:right;"> Characteristic </th>
   <th style="text-align:right;"> Group A (ginkgo) </th>
   <th style="text-align:right;"> Group B (Fake) </th>
  </tr>
 </thead>
<tbody>
  <tr>
   <td style="text-align:right;"> Average age (in years) </td>
   <td style="text-align:right;"> 68.7 </td>
   <td style="text-align:right;"> 69.9 </td>
  </tr>
  <tr>
   <td style="text-align:right;"> Men (number; percentage) </td>
   <td style="text-align:right;"> 46 (41%) </td>
   <td style="text-align:right;"> 45 (42%) </td>
  </tr>
  <tr>
   <td style="text-align:right;"> Average years of education </td>
...
<table>
<caption>(\#tab:SedentaryDemographics)The demographic information for those in the study of iron levels in women.</caption>
 <thead>
  <tr>
   <th style="text-align:right;"> Characteristic </th>
   <th style="text-align:center;"> Active women </th>
   <th style="text-align:center;"> Sedentary women </th>
  </tr>
 </thead>
<tbody>
  <tr>
  ...
  <tr>
   <td style="text-align:right;"> Average weight (in kg) </td>
   <td style="text-align:center;"> $68$ </td>
   <td style="text-align:center;"> $62$ </td>
  </tr>
  <tr>
   <td style="text-align:right;"> Percentage using hormonal contraceptives </td>
...
<div class="figure" style="text-align: center">
<img src="07-ResearchDesign-Internal_files/figure-html/RandomAllocationSampling-1.png" alt="Comparing random allocation and random sampling." width="75%" />
<p class="caption">(\#fig:RandomAllocationSampling)Comparing random allocation and random sampling.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-ResearchDesign-Internal_files/figure-html/BlindingThirdParty-1.png" alt="Using a third party to avoid the observer effect." width="85%" />
<p class="caption">(\#fig:BlindingThirdParty)Using a third party to avoid the observer effect.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="07-ResearchDesign-Internal_files/figure-html/Placebos-1.png" alt="Pain relief, for various pain relief medicine and different-coloured placebos." width="65%" />
<p class="caption">(\#fig:Placebos)Pain relief, for various pain relief medicine and different-coloured placebos.</p>
</div>
...
However, *observing* individuals exposed to Condition\ A\index{Conditions} then Condition\ B, and other individuals exposed to Condition\ B then Condition\ A, may be possible.
...
<div class="figure" style="text-align: center">
<img src="07-ResearchDesign-Internal_files/figure-html/DesignConsiderations-1.png" alt="(ref:DesignConsiderations-Caption)" width="90%" />
<p class="caption">(\#fig:DesignConsiderations)(ref:DesignConsiderations-Caption)</p>
</div>
...
4. The researchers could minimise the effects of confounding by incorporating potential confounding variables in the analysis.  \tightlist
<select class='webex-select'><option value='blank'></option><option value='answer'>TRUE</option><option value=''>FALSE</option></select>
...
Participants were given either a new or an existing toothpaste, and evaluations of plaque remaining on the teeth were taken after brushing.
...
<div class='webex-radiogroup' id='radio_SPEZGDQZAR'><label><input type="radio" autocomplete="off" name="radio_SPEZGDQZAR" value=""></input> <span>To minimise the impact of the Hawthorne effect</span></label><label><input type="radio" autocomplete="off" name="radio_SPEZGDQZAR" value=""></input> <span>To ensure external validity</span></label><label><input type="radio" autocomplete="off" name="radio_SPEZGDQZAR" value=""></input> <span>Because the size of the hive is the explanatory variable</span></label><label><input type="radio" autocomplete="off" name="radio_SPEZGDQZAR" value="answer"></input> <span>In case the size of the hive is a confounding variable</span></label></div>
...
The concentration of particulate matter with a diameter smaller than or equal to\ $2.5$ (per cubic metre of air) was recorded (PM~$2.5$~) from\ $12$ cafés and $16$\ pubs.
...
<div class='webex-radiogroup' id='radio_BABJCXELFD'><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value=""></input> <span>The group receiving Treatment A</span></label><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value=""></input> <span>A group of paramedics who do not have PTSD</span></label><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value=""></input> <span>The group receiving Treatment B</span></label><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value=""></input> <span>A group of paramedics not involved in the study</span></label><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value=""></input> <span>A group of people with PTSD who are not paramedics</span></label><label><input type="radio" autocomplete="off" name="radio_BABJCXELFD" value="answer"></input> <span>A group receiving a pill that looks just like Treatment A and B, but has no effective ingredient</span></label></div>
...
What is this called?
<div class='webex-radiogroup' id='radio_AFSOYNAHHV'><label><input type="radio" autocomplete="off" name="radio_AFSOYNAHHV" value=""></input> <span>Blinding the researchers</span></label><label><input type="radio" autocomplete="off" name="radio_AFSOYNAHHV" value=""></input> <span>Double-blinding</span></label><label><input type="radio" autocomplete="off" name="radio_AFSOYNAHHV" value=""></input> <span>Managing confounding</span></label><label><input type="radio" autocomplete="off" name="radio_AFSOYNAHHV" value="answer"></input> <span>Blinding the participants</span></label></div>

1. What is the purpose of blinding the participants?
<div class='webex-radiogroup' id='radio_WFUOGCGBJL'><label><input type="radio" autocomplete="off" name="radio_WFUOGCGBJL" value=""></input> <span>To ensure that researchers did not unintentionally influence the results</span></label><label><input type="radio" autocomplete="off" name="radio_WFUOGCGBJL" value="answer"></input> <span>To ensure that participants did not change their behaviour because of the treatment they were receiving</span></label><label><input type="radio" autocomplete="off" name="radio_WFUOGCGBJL" value=""></input> <span>To manage confounding</span></label></div>
...
Subjects taste either bottled or tap water from a plastic cup, and give a rating of the taste on a scale of\ $1$ (terrible) to\ $5$ (fantastic).
You decide to address this question using an *experiment*.
...
1. What extraneous variables are apparent?
:::
...
<div class='webex-radiogroup' id='radio_OSYGDQDUOO'><label><input type="radio" autocomplete="off" name="radio_OSYGDQDUOO" value="answer"></input> <span>Floor area</span></label><label><input type="radio" autocomplete="off" name="radio_OSYGDQDUOO" value=""></input> <span>Hours of labour</span></label><label><input type="radio" autocomplete="off" name="radio_OSYGDQDUOO" value=""></input> <span>Average age of workers</span></label><label><input type="radio" autocomplete="off" name="radio_OSYGDQDUOO" value=""></input> <span>Average years of experience of workers</span></label><label><input type="radio" autocomplete="off" name="radio_OSYGDQDUOO" value=""></input> <span>Storey height</span></label></div>

1. What is the *response variable*?
<div class='webex-radiogroup' id='radio_OKMSRZCRAK'><label><input type="radio" autocomplete="off" name="radio_OKMSRZCRAK" value=""></input> <span>Floor area</span></label><label><input type="radio" autocomplete="off" name="radio_OKMSRZCRAK" value="answer"></input> <span>Hours of labour</span></label><label><input type="radio" autocomplete="off" name="radio_OKMSRZCRAK" value=""></input> <span>Average age of workers</span></label><label><input type="radio" autocomplete="off" name="radio_OKMSRZCRAK" value=""></input> <span>Average years of experience of workers</span></label><label><input type="radio" autocomplete="off" name="radio_OKMSRZCRAK" value=""></input> <span>Storey height</span></label></div>

1. What *type* of description is appropriate for the variable 'age of the workers'?
<div class='webex-radiogroup' id='radio_DSEQOICVAM'><label><input type="radio" autocomplete="off" name="radio_DSEQOICVAM" value=""></input> <span>A confounding variable, since it is likely to be related to the explanatory variable only</span></label><label><input type="radio" autocomplete="off" name="radio_DSEQOICVAM" value=""></input> <span>A confounding variable, since it is likely to be related to the response variable only</span></label><label><input type="radio" autocomplete="off" name="radio_DSEQOICVAM" value="answer"></input> <span>An extraneous variable, because it is likely to be related to the response variable only</span></label><label><input type="radio" autocomplete="off" name="radio_DSEQOICVAM" value=""></input> <span>A lurking variable, since we don&apos;t know how it might be related to the response and explanatory variables</span></label></div>
...
<div class='webex-radiogroup' id='radio_GBIWNDBCVB'><label><input type="radio" autocomplete="off" name="radio_GBIWNDBCVB" value=""></input> <span>Restricting, the study to multi-storey buildings</span></label><label><input type="radio" autocomplete="off" name="radio_GBIWNDBCVB" value=""></input> <span>Blocking, by only studying unit blocks</span></label><label><input type="radio" autocomplete="off" name="radio_GBIWNDBCVB" value="answer"></input> <span>Analysis, by using other recorded variables in the analysis</span></label><label><input type="radio" autocomplete="off" name="radio_GBIWNDBCVB" value=""></input> <span>Random allocation of workers to the building projects</span></label></div>
