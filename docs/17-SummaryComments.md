...
<div class='webex-radiogroup' id='radio_SEBVMOTVSG'><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value=""></input> <span>A bar chart</span></label><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value=""></input> <span>A histogram</span></label><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value=""></input> <span>A boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value="answer"></input> <span>A histogram of the differences</span></label><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value=""></input> <span>A scatterplot</span></label><label><input type="radio" autocomplete="off" name="radio_SEBVMOTVSG" value=""></input> <span>A side-by-side bar chart</span></label></div>
...
<div class='webex-radiogroup' id='radio_GGLEIRBEBI'><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value=""></input> <span>A bar chart</span></label><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value=""></input> <span>A histogram</span></label><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value=""></input> <span>A boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value=""></input> <span>A histogram of the differences</span></label><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value=""></input> <span>A scatterplot</span></label><label><input type="radio" autocomplete="off" name="radio_GGLEIRBEBI" value="answer"></input> <span>A side-by-side bar chart</span></label></div>
...
<div class='webex-radiogroup' id='radio_PSUSDNVBZV'><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value=""></input> <span>A bar chart</span></label><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value="answer"></input> <span>A histogram</span></label><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value=""></input> <span>A boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value=""></input> <span>A histogram of the differences</span></label><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value=""></input> <span>A scatterplot</span></label><label><input type="radio" autocomplete="off" name="radio_PSUSDNVBZV" value=""></input> <span>A side-by-side bar chart</span></label></div>
...
<div class='webex-radiogroup' id='radio_UEYIDNFOWV'><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value=""></input> <span>A bar chart</span></label><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value=""></input> <span>A histogram</span></label><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value=""></input> <span>A boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value="answer"></input> <span>A histogram of the differences</span></label><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value=""></input> <span>A scatterplot</span></label><label><input type="radio" autocomplete="off" name="radio_UEYIDNFOWV" value=""></input> <span>A side-by-side bar chart</span></label></div>
...
<div class='webex-radiogroup' id='radio_KFMJWUADUO'><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value=""></input> <span>A bar chart</span></label><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value=""></input> <span>A histogram</span></label><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value="answer"></input> <span>A boxplot</span></label><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value=""></input> <span>A histogram of the differences</span></label><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value=""></input> <span>A scatterplot</span></label><label><input type="radio" autocomplete="off" name="radio_KFMJWUADUO" value=""></input> <span>A side-by-side bar chart</span></label></div>
