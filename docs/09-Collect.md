...
<div class='webex-radiogroup' id='radio_GYSRTUQWXJ'><label><input type="radio" autocomplete="off" name="radio_GYSRTUQWXJ" value=""></input> <span>It is double-barrelled</span></label><label><input type="radio" autocomplete="off" name="radio_GYSRTUQWXJ" value=""></input> <span>It is a leading question</span></label><label><input type="radio" autocomplete="off" name="radio_GYSRTUQWXJ" value="answer"></input> <span>It uses language that may not be understood</span></label><label><input type="radio" autocomplete="off" name="radio_GYSRTUQWXJ" value=""></input> <span>It is ambiguous</span></label></div>


1. What is the biggest problem with this question:
   'Do you spend too much time connected to the internet?'
<div class='webex-radiogroup' id='radio_SIVNMCKUDD'><label><input type="radio" autocomplete="off" name="radio_SIVNMCKUDD" value=""></input> <span>It is double-barrelled</span></label><label><input type="radio" autocomplete="off" name="radio_SIVNMCKUDD" value=""></input> <span>It is a leading question</span></label><label><input type="radio" autocomplete="off" name="radio_SIVNMCKUDD" value=""></input> <span>It uses language that may not be understood</span></label><label><input type="radio" autocomplete="off" name="radio_SIVNMCKUDD" value="answer"></input> <span>It is ambiguous</span></label></div>

1. What is the biggest problem with this question:
   'Do you eat fruits and vegetables?'
<div class='webex-radiogroup' id='radio_BYKKWVEYMG'><label><input type="radio" autocomplete="off" name="radio_BYKKWVEYMG" value="answer"></input> <span>It is double-barrelled</span></label><label><input type="radio" autocomplete="off" name="radio_BYKKWVEYMG" value=""></input> <span>It is a leading question</span></label><label><input type="radio" autocomplete="off" name="radio_BYKKWVEYMG" value=""></input> <span>It uses language that may not be understood</span></label><label><input type="radio" autocomplete="off" name="radio_BYKKWVEYMG" value=""></input> <span>It is ambiguous</span></label></div>
