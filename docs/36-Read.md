...
<img src="36-Read_files/figure-html/unnamed-chunk-5-1.png" width="65%" height="33%" style="display: block; margin: auto;" />
...
<table>
<caption>(\#tab:HearingLossTable)The Hearing Loss Questionnaire scores for various demographic variables.</caption>
 <thead>
<tr>
<th style="empty-cells: hide;border-bottom:hidden;" colspan="2"></th>
<th style="border-bottom:hidden;padding-bottom:0; padding-left:3px;padding-right:3px;text-align: center; font-weight: bold; " colspan="2"><div style="border-bottom: 1px solid #ddd; padding-bottom: 5px; ">HLQ</div></th>
<th style="empty-cells: hide;border-bottom:hidden;" colspan="1"></th>
</tr>
  <tr>
   <th style="text-align:center;font-weight: bold;"> Levels </th>
...
<tr>
  ...
  <tr grouplength="3"><td colspan="5" style="border-bottom: 1px solid;"><strong>Frequency of earphone use</strong></td></tr>
<tr>
   <td style="text-align:center;font-weight: bold;padding-left: 2em;" indentlevel="1"> $0$, $1$ times/day </td>
  ...
  <tr>
   <td style="text-align:center;font-weight: bold;padding-left: 2em;" indentlevel="1"> $2$ to $3$ times/day </td>
  ...
  <tr>
   <td style="text-align:center;font-weight: bold;padding-left: 2em;" indentlevel="1"> More than $3$ times/day </td>
   <td style="text-align:center;"> $278$ </td>
   <td style="text-align:center;"> $20.20$ </td>
   <td style="text-align:center;"> $3.54$ </td>
   <td style="text-align:center;">  </td>
  </tr>
  <tr grouplength="2"><td colspan="5" style="border-bottom: 1px solid;"><strong>Earphone use</strong></td></tr>
<tr>
   <td style="text-align:center;font-weight: bold;padding-left: 2em;" indentlevel="1"> Yes </td>
   <td style="text-align:center;"> $745$ </td>
   <td style="text-align:center;"> $19.80$ </td>
   <td style="text-align:center;"> $3.08$ </td>
   <td style="text-align:center;"> less than $0.001$ </td>
  </tr>
  <tr>
   <td style="text-align:center;font-weight: bold;padding-left: 2em;" indentlevel="1"> No </td>
...
<table>
<caption>(\#tab:seleniumTable)Number of wells with dissolved selenium (Se) concentration above $2\microgs.\xLs^{-1}$, and the geology within $5\kms$ radius of the well.</caption>
 <thead>
  <tr>
...
<tbody>
  <tr>
   <td style="text-align:left;"> Se concentration $\le 2\microgs.\xLs^{-1}$ </td>
   <td style="text-align:center;"> $78$ </td>
   <td style="text-align:center;"> $15$ </td>
  </tr>
  <tr>
   <td style="text-align:left;"> Se concentration greater than $2\microgs.\xLs^{-1}$ </td>
