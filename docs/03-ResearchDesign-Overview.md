...
<div class='webex-radiogroup' id='radio_SVBWCDLJCN'><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value="answer"></input> <span>Arsenic concentration</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Distance of the lake from the mine</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Type of bedrock</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Ecology type</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Elevation</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Lake area</span></label><label><input type="radio" autocomplete="off" name="radio_SVBWCDLJCN" value=""></input> <span>Catchment area</span></label></div>

1. What is the *explanatory* variable?  
<div class='webex-radiogroup' id='radio_OFVPWKGBAT'><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Arsenic concentration</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value="answer"></input> <span>Distance of the lake from the mine</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Type of bedrock</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Ecology type</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Elevation</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Lake area</span></label><label><input type="radio" autocomplete="off" name="radio_OFVPWKGBAT" value=""></input> <span>Catchment area</span></label></div>

1. Is the variable 'Catchment area' likely to be a *lurking* variable?  
<div class='webex-radiogroup' id='radio_NDCSHGKIGW'><label><input type="radio" autocomplete="off" name="radio_NDCSHGKIGW" value=""></input> <span>No: it is not related to the response variable</span></label><label><input type="radio" autocomplete="off" name="radio_NDCSHGKIGW" value="answer"></input> <span>No: it is measured and recorded, so cannot be a lurking variable</span></label><label><input type="radio" autocomplete="off" name="radio_NDCSHGKIGW" value=""></input> <span>Yes: it may be related to the response and explanatory variables</span></label><label><input type="radio" autocomplete="off" name="radio_NDCSHGKIGW" value=""></input> <span>Yes: it may be related to the response variable</span></label></div>

1. Is the variable 'Type of bedrock' likely to be a *confounding* variable?  
<div class='webex-radiogroup' id='radio_UQLPNZLONU'><label><input type="radio" autocomplete="off" name="radio_UQLPNZLONU" value=""></input> <span>No: it is not related to the response variable</span></label><label><input type="radio" autocomplete="off" name="radio_UQLPNZLONU" value=""></input> <span>No: it is measured and recorded, so cannot be a confounding variable</span></label><label><input type="radio" autocomplete="off" name="radio_UQLPNZLONU" value="answer"></input> <span>Yes: it may be related to the response and explanatory variables</span></label><label><input type="radio" autocomplete="off" name="radio_UQLPNZLONU" value=""></input> <span>Yes: it may be related to the response variable</span></label></div>

1. What is the *best* description of the variable 'Ecology type':
<div class='webex-radiogroup' id='radio_TKBCTQLLOX'><label><input type="radio" autocomplete="off" name="radio_TKBCTQLLOX" value=""></input> <span>Response variable</span></label><label><input type="radio" autocomplete="off" name="radio_TKBCTQLLOX" value=""></input> <span>Explanatory variable</span></label><label><input type="radio" autocomplete="off" name="radio_TKBCTQLLOX" value="answer"></input> <span>Confounding variable</span></label><label><input type="radio" autocomplete="off" name="radio_TKBCTQLLOX" value=""></input> <span>Lurking variable</span></label></div>
...
<div class='webex-radiogroup' id='radio_LQXGDIQJSV'><label><input type="radio" autocomplete="off" name="radio_LQXGDIQJSV" value=""></input> <span>Yes: it is likely to be related to the response variable</span></label><label><input type="radio" autocomplete="off" name="radio_LQXGDIQJSV" value=""></input> <span>No: it is the explanatory variable</span></label><label><input type="radio" autocomplete="off" name="radio_LQXGDIQJSV" value="answer"></input> <span>No: it is a variable that is recorded so it can&apos;t be a lurking variable</span></label><label><input type="radio" autocomplete="off" name="radio_LQXGDIQJSV" value=""></input> <span>Yes: it is likely to be related to the explanatory variable</span></label><label><input type="radio" autocomplete="off" name="radio_LQXGDIQJSV" value=""></input> <span>Yes: it is likely to be related to the response and explanatory variable</span></label></div>

3. Is it reasonable to consider the weight of the child as a lurking variable?
<div class='webex-radiogroup' id='radio_UKNYQMGZWT'><label><input type="radio" autocomplete="off" name="radio_UKNYQMGZWT" value=""></input> <span>No: it can&apos;t be a lurking variable because it is probably not related to all the extraneous variables.</span></label><label><input type="radio" autocomplete="off" name="radio_UKNYQMGZWT" value=""></input> <span>Yes, because it is related to whether the child consumes RTEC.</span></label><label><input type="radio" autocomplete="off" name="radio_UKNYQMGZWT" value="answer"></input> <span>Yes: It is not measured, and could be related to the age of the child, and whether the child consumes RTEC.</span></label><label><input type="radio" autocomplete="off" name="radio_UKNYQMGZWT" value=""></input> <span>No: it can&apos;t be a variable because it is not measured.</span></label><label><input type="radio" autocomplete="off" name="radio_UKNYQMGZWT" value=""></input> <span>Yes, because it is probably related to age group of the child.</span></label></div>
