...
<img src="35-Write_files/figure-html/unnamed-chunk-4-1.png" width="65%" height="33%" style="display: block; margin: auto;" />
...
<img src="35-Write_files/figure-html/ReportStructure-1.png" alt="(ref:Structure)" width="60%" />
<p class="caption">(\#fig:ReportStructure)(ref:Structure)</p>
</div>
...
<table>
<caption>(\#tab:WriteExercisesProject2)A numerical summary of the data, showing how much higher the standing jump height is compared to the squat jump</caption>
 <thead>
  <tr>
   ...
   <th style="text-align:center;"> Confidence interval $95$\% </th>
...
<tbody>
  <tr>
   ...
   <td style="text-align:center;"> $6.152$ to $8.808$ </td>
   <td style="text-align:center;"> $11.316$ </td>
