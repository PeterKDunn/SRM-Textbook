...
@drinkwater1995fundamental compared tomatoes growing on conventional ($n = 14$) and organic ($n = 17$) farms.
...
> In our greenhouse studies, total numbers of actino- mycetes isolated from tomato rhizosphere soils were significantly larger in the ORG soils compared to CNV (Student's t test, t = 5.4, P = 0.006), but

p.\ 1103:

> The proportions of actinomycetes hydrolyzing cellulose [...] were significantly greater in ORG soil than in CNV soil (Student's t test, t = 5.4, P = 0.006; and t = 17.3, P = 0.001, respectively) while starch hydrolyzing actino- mycetes were more numerous in CNV than in ORG soil (Student's t test, t = 4.0, P = 0.005).

p.\ 1103:

> Total actinomycete abundance, actino- mycete diversity, and proportion of cellulolytic acti- nomycetes were all negatively correlated with corky root severity (r = -0.76, P = 0.08; r = -0.82, P = 0.05; and r = -0.85, P = 0.03, respectively).

p.\ 1110:

> Furthermore, while controlled conditions allow isolation of single variable effects, realistic assessment of  process dependent characteristics such as yield or community structure can be extremely sensitive to factors operating at the whole-farm level. 
> Time and space dependent factors such as long-term crop history, habitat and soil management regimes, cumulative pesticide applications, and surrounding vegetation cannot be replicated in experiment station plots. 
> Insufficient time and/or spatial heterogeneity generally preclude the development of complex biotic communities and soil organic matter dynamics that occur on ORG farms. 
> The importance of time-dependent processes is illustrated by the fact that comparative field station experiments often report reduced yields in the ORG treatments more frequently during the first few years of ORG management than later in the experimen
:::
...
>>>>>>> 624baeea688a63104972a2f2aef8d1cfb96f5155
