...
**4.** No intervention.
**5.** Relational.
**6.** What is meant by 'regularly'; 'USC student' 
(all campuses? undergraduate *and* postgraduate? full-time and part-time?).
**7.** Resting diastolic blood pressure; 
whether they regularly drive to USC or regularly ride their bicycles.
```
...
```{block2, type="answer"}
**Answer to Exercise \@ref(exr:SamplingParking)**:
...
**2.** No. The difference is 0.17 hours, or about 10 minutes. 
       A difference of 10 minutes in over 5 hours of use is trivial.
...
$t = (5.2 - 0)/3.06 = 1.699$; $P$ larger than 0.05:
