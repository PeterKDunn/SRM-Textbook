...
```{r HusbandHistNormalShadeEmpirical, fig.cap="The heights of husbands, showing the 68--95--99.7 rule in use", fig.align="center", fig.width=6.7, fig.height=1.8, out.width='100%'}
par( mfrow = c(1, 3),
     mar = c(6, 2, 2, 1) )
...
Three standard deviations is $3\times6.88 = 20.64$:
About 99.7% of husbands *in the population* are between $152.6$cm and $193.8$cm.
