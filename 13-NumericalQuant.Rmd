...
While skewness can be described numerically, we will describe shape using words (skewed, approximately symmetric, bimodal, etc.) as before (Sect.\ \@ref(SummariseData)).
