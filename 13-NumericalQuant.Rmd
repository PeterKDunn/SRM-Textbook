...
```{r PosNegDistMeansFig, cache=FALSE, fig.align="center", fig.width=5.5, out.width='45%', fig.cap="The mean is the value such that the positive and negative distances sum to zero" }
if (knitr::is_latex_output()){
...
```{r HusbandHistNormalShadeEmpiricalOLD, fig.cap="The heights of husbands, showing the 68--95--99.7 rule in use", fig.align="center", fig.width=6.7, fig.height=2.1, out.width='100%'}
par( mfrow = c(1, 3),
     mar = c(6, 2, 2, 1) )
