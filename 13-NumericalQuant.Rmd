...
T1 <- knitr::kable(MaryRiverTable[1:4, ],
                   format = "latex",
                   colnames = c("Range of daily streamflow (ML)",
                                "Number of days"),
                   booktabs = TRUE)
T2 <- knitr::kable(MaryRiverTable[2:8, ],
                   format = "latex",
                   col.names = c("Range of daily streamflow (ML)",
                                 "Number of days"),
                   booktabs = TRUE)

out2 <- knitr::kables(list(T1, T2),
                       format = "latex",
                       label = "Mary River daily streamflow for February (in ML)") %>% 
    kable_styling(font_size = 10)
