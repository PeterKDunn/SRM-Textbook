...
```{r NHANESdirectHDLHisto, fig.cap="The histogram of the direct HDL cholesterol from the NHANES study. Large outliers exist but are hard to see.", fig.align="center", fig.width=5, fig.height=3.5}
...
```{r NHANEDescriptives, fig.cap="Output for direct HDL cholesterol: jamovi (left); SPSS (right)", fig.align="center",  out.width=c('30%', '8%', '60%'), fig.show="hold"}
...
```{r NHANEDescriptivesBySmoking, fig.cap="Output for direct HDL cholesterol, by current smoking status: jamovi (left) and SPSS (right)", fig.align="center",fig.show="hold", out.width=c('33%', '5%', '60%')}
...
The histogram of the direct HDL cholesterol from the NHANES study is shown  in Fig. \@ref(fig:NHANESHDLHist).
