...
(Answer is here^[We do not know! We know the value of the *sample* mean, but not the *population* mean.
...
(Answer is here^[With $n = 8$ observations, the median is ordered observation number $(8 + 1)/2 = 4.5$, 
...
* If the sample size $n$ is *even* (such as the glaucoma example), 
...
(Answer is here^[The *population* standard deviation is unknown.
...
(Answer is here^[Three standard deviations is $3\times6.88=20.64$; about 99.7% of husbands are between $(173.2 - 20.64) = 152.6$cm and $(173.2 + 20.64) = 193.8$cm.].)
:::
