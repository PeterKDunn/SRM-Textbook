...
```{r DeathAgeHist, fig.cap="Histograms of age at death for Australians in 2012", fig.align="center", fig.width=4.5, fig.height=3}
...
`r if( knitr::is_html_output(exclude = "epub") ) {mcq( c(
	...
	"655g",
	"635g",
	"We do not know"))} else {"________________"}`
...
`r if( knitr::is_html_output(exclude = "epub") ) {mcq( c(
	...
	"12.884g",
	"8.75g",
	answer = "We do not know"))} else {"________________"}`
...
1. A study of fatalities on amusement rides in the US [@levenson2005amusement] recorded these number of fatalities from 1994 to 2003:
