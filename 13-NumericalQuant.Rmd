...
A number that describes a feature of a *population* is called a *parameter* (Sect. \@ref(StatisticsAndParameters)).
The values of parameters are usually unknown.
In contrast, a number that describes a feature of a *sample* is called a  *statistic* (Sect. \@ref(StatisticsAndParameters)).
That is:
