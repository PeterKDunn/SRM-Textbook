...
```{r BalanceMeansFig, fig.align="center", fig.width=4.5, fig.height=3,fig.cap="The mean is the balance point of the data" }
...
```{r PosNegDistMeansFig, fig.align="center", fig.width=5.5, out.width='50%', fig.cap="The mean is the value such that the positive and negative distances sum to zero" }
if (knitr::is_latex_output()){
