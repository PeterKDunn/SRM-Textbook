...
Different output (Fig.\ \@ref(fig:NHANEDescriptivesBySmoking)), Table\ \@ref(tab:NHANESSummaryQuant) shows the numerical summaries of direct HDL cholesterol concentration for each group, and the difference.

When creating numerical summary tables, remember to:
...
This could impact the results (non-response bias; Sect.\ \@ref(SelectionBias)), if those who provide data and those who do not are different regarding direct HDL cholesterol concentration.
:::
