...
```{r TurbinesOutputHT, fig.show="hold", fig.cap="jamovi output for the turbine data", fig.align="center", out.width="50%"}
knitr::include_graphics( "jamovi/Turbines/TurbinesCI-jamovi.png" )
```

```{r TurbinesOutputExpectedHT, fig.show="hold", fig.cap="jamovi output for the turbine data: expected counts", fig.align="center", out.width="45%"}
