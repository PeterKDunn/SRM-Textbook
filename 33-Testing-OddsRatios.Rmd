...
if( knitr::is_latex_output() ) {
  kable(surroundMaths(Eating.tab),
        format = "latex",
        booktabs = TRUE,
        longtable = FALSE,
        escape = FALSE,
...
if( knitr::is_latex_output() ) {
  kable(surroundMaths(EatingNumericalSummary,
                      decDigits = c(3, 1, 0)),
        format = "latex",
        longtable = FALSE,
        booktabs = TRUE,
...
* The *odds* are the odds of living with parents (Column\ 1) compared to not living with parents (Column\ 2; on the bottom of the fraction):
  ...
  * for those eating most meals on-campus: and $2/24 = 0.083333$.
  ...
  So the OR is $0.49524/0.083333 = 5.943$ (Row2  on bottom of the fraction), as in the output (Fig.\ \@ref(fig:UniMealsTestOutputHTjamovi)).
...
Usually, for $2 \times2$ tables, working with *odds* or *odds ratios* is best, because most software (including jamovi) readily produce CIs for the odds ratio.
...
if( knitr::is_latex_output() ) {
  kable( surroundMaths(Eating.tab.ExpCounts,
                       decDigits = c(3, 3, 0)),
        format = "latex",
        booktabs = TRUE,
        longtable = FALSE,
...
if( knitr::is_latex_output() ) {
  T1 <- kable(surroundMaths(TurtleData,
                            decDigits = 0),
              format = "latex",
              booktabs = TRUE,
              valign = 't',
  ...
  T2 <- kable( surroundMaths(TNsummary,
                             decDigits = c(3, 2, 0)),
               format = "latex",
               booktabs = TRUE,
               valign = 't',
...
From the jamovi output (Fig.\ \@ref(fig:TurtleNestsOutputjamovi)), the $\chi^2$-value is $0.777$; this is like a $z$-score of $z = \sqrt{0.777/1} = 0.88$, which is very small, so expect a large $P$-value.
Indeed, the $P$-value is $0.378$ on the output.
The smallest *expected* count is $6.49$ (Fig.\ \@ref(fig:TurtleNestsOutputjamovi)), so this test is statistically valid.
We write:

> There is no evidence of a difference in the odds of infection ($\chi^2$: $0.777$; $P$-value: $0.378$; odds ratio: $1.657; $95$% CI: $0.537$ to $5.12$) between natural nests (odds: $2.90$; $n = 39$) and relocated nests (relocated nests (odds: $1.75$; $n = 22$).
...
The software output is shown in Fig.\ \@ref(fig:KerbsideChisqjamovi); a graphical summary in Fig.\ \@ref(fig:KerbsideSidebysideBar).
...
All *expected* values exceed $5$ (Fig.\ \@ref(fig:KerbsideChisqjamovi)), even though one *observed* count is less than five.
