...
In a two-by-two table, jamovi and SPSS output can be interpreted in *either* of these ways:
...
SPSS tells us if this condition is not satisfied, underneath the *first* output table in Fig.&nbsp;\@ref(fig:UniMealsTestOutputSPSS).
