...
In research, $\beta$ usually denotes the regression parameters (Sect.\ \@ref(Regression-Software)).
* $\rho$:\index{Correlation coefficient (Pearson)}
In research, $\rho$ denotes the population correlation coefficient (Sect.\ \@ref(CorrCoefficients)).
