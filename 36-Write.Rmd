...
In general use, 'correlation' is often used to mean any 'association' between any two variables.
...
The two variables observed on each person in the study were (a)\ whether or not the person used a disposable cup, and (b)\ the sex of the person.
