...
Ensure your fonts are colours are readable from a distance (especially in tables and graphs).
...
The *Abstract* (or *Summary*) is a short section at the start of an article summarising the *whole* article, including the results; it is *not* an introduction!
