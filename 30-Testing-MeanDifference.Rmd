...
In one study (@data:hand:handbook, Dataset 232; HOAGLIN), the beta-endorphin concentration was measured for 19 patients about to undergo surgery.
The RQ was:
...
A numerical summary can be produced from jamovi output (Table \@ref(tab:StressDescriptivesjamovi)).


```{r StressDescriptivesjamovi, echo=FALSE, fig.cap="jamovi output for the surgery-stress data. Means, standard deviation and standard errors are measured in fmol/mol", fig.align="center", out.width='80%'}
