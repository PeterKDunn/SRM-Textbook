...
\captionof{table}{The compliance of students by age group\label{tab:AAAAA}}
\fontsize{8}{12}\selectfont
```{r}
  kable(pad(MumpsTable,
            surroundMaths = TRUE,
...
```
\caption{Software output for the compliance data}\label{fig:MumpsjamoviPDF}
\end{minipage}%
\end{figure}
`r if (knitr::is_html_output()) '-->'`
...
```{r BagsChisqjamovi, fig.show="hold", fig.cap="Software output for the shopping-bags data", fig.align="center", out.width="56%"}
