...
## General advices {#WritingGeneralTips}
...
* use apostrophes correctly. 
  For example, "it's" is only ever an abbreviation for "it is"; be careful with plural words.
...
```{r ReportStructure, fig.cap="The connection between the paper and the steps we have studied. The Abstract briefly covers all aspects of the study, and the Discussion explains what has been learnt by the process.", fig.align="center", fig.width=7.5, out.width='55%'}
source("R/showAIMRAD.R")  
showAIMRAD(debug = TRUE)  
