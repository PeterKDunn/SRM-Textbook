...
**In this chapter**, you will learn to write about your own research.
You will learn to:
...
\begin{wrapfigure}{R}{.20\textwidth}
  \begin{center}
    \includegraphics[width=.15\textwidth]{Illustrations/pexels-ivan-samkov-4240494.jpg}
  \end{center}
\end{wrapfigure}
`r if (knitr::is_html_output()) '-->'`
...
* Think carefully about the words you use.
  You do not want to just be understood, you need to make sure that you *can't* be misunderstood.
...
Don't just be understood; make sure that you *can't* be misunderstood.
:::
...
One conclusion of the study was that using 'fancy' language *does not work*: 'needless complexity leads to negative evaluations...' (@oppenheimer2006consequences, p. 151).
