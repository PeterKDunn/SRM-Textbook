...
Titles are important: poor titles can easily discourage a reader from reading an article.
...
Avoid saying "The authors wish to thank..." and instead directly thank them: "We thank...".
...
* Be consistent and careful with decimal numbers.
  Some journal require numbers to be written with a leading zero, and some do not.
...
One potential source of confusion is words with a different meaning in science compared to every-day use (*lexical ambiguity*; @richardson2013identification; @dunn2016learning).
