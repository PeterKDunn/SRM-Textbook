...
So, would expect that each die face would appear about one-sixth of the time (based on [classical probability](#ProbClassical)),
...
We cold use a computer to 'pretend' to roll a die 20,000 times and record the proportion of  `r include_graphics("Dice/dice6.png", dpi=2000)`s.
...
We can do this because we know that the actual proportion of 6s should be $1/6 = 0.1666$.
