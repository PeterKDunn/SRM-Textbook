...
**In this chapter**,
you will learn about *hypothesis tests* for one proportion.
You will learn to:
...
In 1882, R. Wolf tossed a die 20,000 times (CITE) and recorded the number of times each face appeared...
Of course, one would expect that each die face would appear about one-sixth of the time (LINK TO CLASSICAL PROB).

In 20,000 rolls then, we'd expect to see a `r include_graphics("Dice/dice6.png", dpi=2000) about $20,000/6 = 3,333.3$ times;
not *exactly* 3333.3 times each because of sampling variation, but *approximately* 3333.3 times each.
And, of course, the number of times each face appears must be a whole number.

Nonetheless, we have some idea of how often each face should appear on average... but we also know that the actual number will vary, due to sampling variation.
Sometimes the proportion of rolls that show a `r include_graphics("Dice/dice6.png", dpi=2000)` will be a bit higher than $1/6 = 0.1667$, and sometimes a bit lower than $1/6 = 0.1667$.

(ANDD PROP COLUMN?)

 Die face | Number | | Die face | Number 
----------+--------+-+----------+-------
`r include_graphics("Dice/dice1.png", dpi=2000)` | 3407 | |`r include_graphics("Dice/dice4.png", dpi=2000)` | 2916
`r include_graphics("Dice/dice2.png", dpi=2000)` | 3631 | |`r include_graphics("Dice/dice5.png", dpi=2000)` | 3448 
`r include_graphics("Dice/dice3.png", dpi=2000)` | 3176 | |`r include_graphics("Dice/dice6.png", dpi=2000)` | 3422

But what spread of proportions would be likely?
Would it be reasonably to see a proportion of 0.16?
What about 0.15?
Or even a proportion of 0.10?
In other words, in $n = 20,000$ rolls, what proportion of rolls showing a `r include_graphics("Dice/dice6.png", dpi=2000)` could we expect to find just by chance (sampling variation)? 

We can use a computer to *simulate* rolling a 20,000 times (doing it for real would take a *long* time!).
We can use the computer to pretend to roll a die 20,000 times, and count how many of those rolls were 6s.
We can do this because we know that the actual proportion of 6s shoudl be $1/6 = 0.1666$.
And we can do it again, and again...
For each set of 20,000 rolls, we count the number of 6s that appear, and compute the *proportion* of rolls that were 6s.

If we do this many, many times, we have a list of *sample* proportions.
We can plot a histogram of thhese sample proportions (XREF).
...
What we see is rather interesting--it looks like a normal distribution!
...
So, if we did roll a die 20,000 time and saw the proportion of sixes was 0.155, we would have observed something 
...
* Tossing the Euro and getting P(heads)
* 
...
To test if the proportion of Korean children with the measles antibody in the *population* was at least 10%, the hypotheses are:

* $H_0$: $p = 0.10$ (assume the target is met and the difference between $p$ and $\hat{p}$ is due to sampling variation); and
* $H_0$$ $p <0.10$ (one-tailed).
...
::: {.example}
A study [@barve2017elevational] compared to types of birds (male green-backed tits; male cinereous tits) to see which was more behaviouralluy dominant over winter.
...
A study [@lee2012dark] examined how subjects responded to potential placebos.
The aim was to:

> evaluate whether a greater proportion of participants could correctly identify an authentic herbal substance when comparing to a sham substance using visual, odour and taste assessments.
>
> --- [@lee2012dark, p. viii]
:::
...
A study of Magellanic penguins found dead or stranded on the southern Brazilian coast found 73 aduts penguins.
...
At the universitry, 60.2% of students were females.
...
@article{kim2004sero,
  title={Sero-epidemiology of measles and mumps in Korea: impact of the catch-up campaign on measles immunity},
  author={Kim, Sung-Soo and Han, Hyun Woo and Go, Unyeong and Chung, Hai Won},
  journal={Vaccine},
  volume={23},
  number={3},
  pages={290--297},
...
@article{barve2017elevational,
  title={Elevational replacement of two Himalayan titmice: interspecific competition or habitat preference?},
  author={Barve, Sahas and Dhondt, Andr{\'e} A},
...
@phdthesis{lee2012dark,
  title={In the dark: an experimental study in distinguishing an authentic herbal substance from a sham substance},
  author={Lee, John Hung Yang},
  puiblisher = {{U}niversity of {T}echnology {S}ydney},
  year={2012}
}
@article{loyeung2018experimental,
  title={An experimental study in distinguishing an authentic herbal substance from sham herbal substances},
  author={Loyeung, Bertrand and Lee, John and Michaeil, Carolyn and Zaslawski, Christopher},
...
@article{vanstreels2013female,
  title={Female-biased mortality of Magellanic Penguins (Spheniscus magellanicus) on the wintering grounds},
  author={Vanstreels, Ralph Eric Thijl and Adornes, Andr{\'e}a Corrado and Canabarro, Paula Lima and Ruoppolo, Valeria and Amaku, Marcos and da Silva-Filho, Rodolfo Pinho and Cat{\~a}o-Dias, Jos{\'e} Luiz},
...
@article{avery2014invasive,
  title={Invasive black spiny-tailed iguanas (Ctenosaura similis) on Gasparilla Island, Florida, USA},
  author={Avery, Michael L and Tillman, Eric A and Spurfeld, Conny and Engeman, Richard M and Maciejewski, Kelin P and Brown, Jessica D and Fetzer, Emily A},
...
@article{boltuch2020palmaris,
  title={The Palmaris Longus and Its Association with Carpal Tunnel Syndrome},
  author={Boltuch, Andrew D and Marcotte, Michael A and Treat, Christopher M and Marcotte, Anthony L},
...
@article{siegfried2014estimating,
  title={Estimating the frequency of {Cry1F} resistance in field populations of the European corn borer ({L}epidoptera: {C}rambidae)},
  author={Siegfried, Blair D and Rangasamy, Murugesan and Wang, Haichuan and Spencer, Terence and Haridas, Chirakkal V and Tenhumberg, Brigitte and Sumerford, Douglas V and Storer, Nicholas P},
...
@book{maeda2013introducing,
  title={Introducing portable pedal machines inside a university library to reduce sedentary behavior},
  author={Maeda, Hotaka},
  year={2013},
...
<iframe src="https://learningapps.org/watch?v=p28qr801322" style="border:0px;width:100%;height:550px" allowfullscreen="true" webkitallowfullscreen="true" mozallowfullscreen="true"></iframe>
