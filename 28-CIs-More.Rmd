...
CIs are formed for an unknown *population* parameter (such as the population proportion $p$), using the best estimate of the paraeter: the *sample* statistic (such as the sample proportion $\hat{p}$).
