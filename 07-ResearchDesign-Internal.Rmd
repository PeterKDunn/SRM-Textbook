...
One of the comparison grouos is often a control group (Def.\ \@ref(def:ControlGroup))
...
For instance, coeliacs have an auto-immune disorder which results in an intolerance to gluten (found in wheat, barley and rye).
...
In a strength study study where the population is 'concrete test cylinders', cylinders with severe cracks may be *excluded*.
...
Which of the following canimprove internal validity in *observational* studies?
`r if (knitr::is_html_output()) '<!--'`
:::::: {.cols data-latex=""}
:::: {.col data-latex="{0.425\textwidth}"}
* Blinding the individuals
...
Twenty precincts were matched with $20$\ other precincts (using demographics, socio-economic characteristics, crime, and police activity).
