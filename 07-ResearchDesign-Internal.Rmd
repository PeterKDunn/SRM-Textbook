...
Perceptions often are unreliable also.
...
The cyclists also *subjectively* recorded similar data with a smartphone application.
...
That is, the subjective and objective measurements did not agree, except for heat.
...
For each student, the time spent in <span style="font-variant:small-caps;">mvpao</span> was recorded in two ways: (a)\ using a wrist-worn accelerometer, worn for seven days; and (b)\ self-reported using a questionnaire at the end of the week.
