...
During the COVID-19 lockdowns in Denmark, @olesen2021we covertly observed adults entering a large mall in Copenhagen.
...
@greier2021objective studied $36$\ Austrian $8$th\ grade students, recording the time spent performing moderate-to-vigorous physical activity (MVPA).
For each student, the time spent in MVPA was recorded in two ways: (a)\ using a wrist-worn accelerometer, worn for seven days; and (b)\ self-reported using a questionnaire at the end of the week.
