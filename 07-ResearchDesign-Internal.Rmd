...
:::{.exampleExtra  data-latex=""}
An experiment to study the effect of using gingko to enhance memory [@data:Solomon2002:Ginko] compared two groups: one using gingko ($n = 111$), and one using a fake, non-active supplement ($n = 108$).
