...
Hence, the researchers may decide to use an *inclusion criteria*,\index{Inclusion criteria} restricting the study to people aged from\ $40$ to\ $60$.
...
For instance, coeliacs have an auto-immune disorder in which an intolerance to gluten (found in wheat, barley and rye) develops.
...
For the *Himalaya\ 292* study, for example, subjects may be *paired* together (i.e., groups of two).\index{Study types!paired}
That is, pairs of people of the same sex and of a similar age are found; one of the pair is given the *Himalaya\ 292* diet, and the other is given the refined cereal diet. 
