...
Usually the best approach for *observational* and quasi-experimental studies is to record the values of any potential confounding variables, and use special analysis methods to understand the data.
...
Blinding *people* to knowing they are involved in experiments is often difficult, as ethics often requires informed consent (Sect.\ \@ref(Common-Ethical-Issues)).
...
Since all participants knew they were being assessed after brushing, they all brushed better than usual.
:::
...
This could compromise the internally validity of the study.
This is an example of the *carry-over effect*: when the influence of one treatment or condition carries over to influence the next treatment or condition.
