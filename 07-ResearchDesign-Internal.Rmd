...
```{r, fig.width=4.5, fig.height=2.25, out.width='95%'}
...
```{r RandomAllocationHimalaya, echo=FALSE, fig.cap="(ref:RandomAllocationHimalaya)", fig.align="center", fig.height=3, out.width='65%'}
...
```{r DesignConsiderations, echo=FALSE, fig.cap='(ref:DesignConsiderations-Caption)', out.width='90%', fig.align="center",  fig.width=7.0, fig.height=4.5}
...
`r if (knitr::is_html_output()) "-->"`
1. What is the most likely way to manage confounding in this study`r if(knitr::is_latex_output()) 
{' restricting, blocking, analysis, random allocation'}`?
`r if( knitr::is_html_output() ) {longmcq( c(
