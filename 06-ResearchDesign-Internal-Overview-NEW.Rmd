...
Bias may occur during study design (poor internal validity), data collection (selection bias; Sect.\ \@ref(def:SelectionBias)), analysis, or interpretation of results (Chap.\ \@ref(Interpretation)).
