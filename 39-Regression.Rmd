...
To describe the line, a *regression equation* is used.
...
The *intercept* $b_0$ has the same measurement units as the response variable.
The measurement unit for the *slope* $b_1$ is the 'measurement units of the response variable', per 'measurement units of the explanatory variable'.
