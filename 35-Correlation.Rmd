...
The sample correlation coefficient is $r = `r round(cor(RD$Age, RD$Weight), 3)`$, but the value of $r$ varies from sample to sample (there is *sampling variation*).\index{sampling variation!correlation coefficient}
...
If a rain forecast says 'there is a very high chance of rain tomorrow', it doesn't mean there will be a *lot* of rain, just a high chance of *some* rain.
