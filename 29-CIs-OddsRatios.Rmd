...
(Since all observed counts are greater than five, all the expected counts will be greater than five too.)
We write:
...
@wang2020driver recorded information about vcar crashes in a rural, mountainous county in western China
`r if (knitr::is_latex_output()) {
