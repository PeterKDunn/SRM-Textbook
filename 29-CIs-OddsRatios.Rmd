...
A two-way table of counts is appropriate (Table\ \@ref(tab:MealsDataTable)), called a *contingency table*.\index{Contingency table}
...
A graphical summary (Fig.\ \@ref(fig:TurtleNestsGraphs)) and a numerical summary table (Table\ \@ref(tab:TurtleNestsNumericalSummary)) show that the odds of natural nest being infected is $1.657$ times the odds of a relocated nest being infected.
