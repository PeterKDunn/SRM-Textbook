...
```{r UniMealsTestOutputExpectedOnlyjamovi, fig.show="hold", fig.cap="The expected counts in software, for the student-eating data", fig.align="center", out.width="70%"}
...
```{r TurtleNestsOutputjamovi, fig.show="hold", fig.cap="The software output for the turtle-nesting data", fig.align="center", out.width=c("48%", "48%")}
...
1. Interpret the CI.
1. Use the software output (Fig.\ \@ref(fig:EarInfPSSOutputCI)) to write down a $95$%\ CI for the odds ratio.
1. Interpret the CI.
...
1. Write down the $95$% CI for the difference between the proportions.
1. Interpret the CI.
1. Use the software output (Fig.\ \@ref(fig:TurbinesOutputCI)) to write down a $95$%\ CI for the odds ratio.
1. Interpret the CI.
1. Is the CI statistically valid (Fig.\ \@ref(fig:TurbinesOutputCI))?
:::


```{r TurbinesOutputCI, fig.show="hold", fig.cap="Software output for the turbine data", fig.align="center", out.width=c("49%", "44%")}
...
Using the software output in Fig.\ \@ref(fig:EmeraldRainOutputCIjamovi):
...
The software output is shown in Fig.\ \@ref(fig:SunglassesSPSSOutputCI). 
...
```{r PetBirdsCIjamovi, fig.show="hold", fig.cap="Software output for the pet-birds data", fig.align="center", out.width="50%"}
...
The data appear in Table\ \@ref(tab:B12DataCI), and the software output in Fig.\ \@ref(fig:B12SPSSOutputCIjamovi).
