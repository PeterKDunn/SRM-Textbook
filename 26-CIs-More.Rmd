...
That is, if we *repeated* the process (of selecting a sample of $290$ peanuts and compute the CI for each sample) numerous time, $95$% of those confidence intervals formed would contain the value of the parameter.
...
```{r ValiditiesCI, fig.cap="Four types of validities for studies.", fig.align="center", fig.height=4, fig.width=8.5, out.width="85%",}
