...
Using the [68--95--99.7 rule](#def:EmpiricalRule),
this $t$-score is not that small.

Using Table \@ref(tab:PvaluesInterpretation), this $P$-values only provides slight evidence of a reduction in mean speeds.

We conclude:

> Slight evidence exists in the sample 
> ($t = 1.92$; two-tailed $P < 0.001$) 
