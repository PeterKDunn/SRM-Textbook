...
$(\mu_{\text{Before}} - \mu_{\text{After}}) = 5.68$.
The table also gives
the standard error for estimating this *difference* as
$\text{s.e.}(\bar{x}_{\text{Before}} - \bar{x}_{\text{After}}) = 0.472$.

Using the summary information in Table \@ref(tab:SignageSummaryHT),
...
Using the [68--95--99.7 rule](#def:EmpiricalRule),
this $t$-score is not very small.
...
> ($t = 1.92$; two-tailed $P = 0.030$)  
> that mean speeds have reduced after the addition of extra signage
> (Before: mean speed: 98,02 km/h; $n = 38$; standard deviation: $13.18$ km/h; 
>  After:  mean speed: 92.34 km/h; $n = 41$; standard deviation: $13.13$ km/h;
> 95% CI for the difference: -0.24 to 11.6 km/h).
