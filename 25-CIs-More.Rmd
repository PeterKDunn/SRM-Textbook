...
After 14 months, the sample of ten amputees walked a mean of $122.5$\ m; the $95$% CI was computed as $96.4$\ m to $148.6$\ m.
What would be *wrong* with the following conclusions?

> * Approximate $95$% of the amputeees walked between $96.4$ and $1\ 488.6$\ m in two minutes.
> * The $95$% CI for the sample mean distance walked in two minutes was between $96.4$ and $1\ 488.6$\ m.
:::


::: {.exercise #AboutCIsInterpretationMean2}
A study of sodium intake in Thailand found the $95$%\ CI for the mean daily sodium intake for subjects with a secondary school education was $3\ 565$ to\ $3\ 903$\ mg.
What would be wrong with the following conclusions?
