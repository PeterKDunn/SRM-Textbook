...
## Hyppthesis tests of independence more generally: $\chi^2$-tests {#CompareManyProportions}
...
answer = "Two-tailed",
"There is not enough information")  )}`
1. True or false: There is *no* evidence of a difference in odds of having an in-hospital HA, comparing patients with low and high body temperatures.
`r if( knitr::is_html_output() ) {torf(answer=FALSE)}`
