...
1. Compute the *proportion* of crashes involving a pedestrian in\ 2011, and also in\ 2015.
...
1. Use the output to determine if there is evidence of a difference between the proportions.
1. Use the output to determine if there is evidence of a difference between the odds.
1. Construct an appropriate numerical summary table for the data.
1. Conduct a hypothesis test to determine if there is a difference between the proportions for\ 2011 and\ 2015.
1. Conduct a hypothesis test to determine if there is a difference between the odds for\ 2011 and\ 2015.
1. Compile a numerical summary table.
1. Are the CIs and tests are statistically valid?
:::
...
1. Compute the *proportion* of men having a smooth scar (that is, height is\ $0$\mms), and also the *proportion* of women.
...
1. Interpret what this CI means.
1. Compute the *odds* of having a smooth scar (that is, height is\ $0$\mms) for men, and also for women.
1. Write down the CI for the odds ratio of having a smooth scar, comparing men to women.
1. Conduct a hypothesis test to determine if there is a difference between the proportions for women and men.
1. Conduct a hypothesis test to determine if there is a difference between the odds for women and men.
1. Compile a numerical summary table.
1. Are the CIs and tests are statistically valid?
:::
...
1. Write down the $95$%\ CI for the difference between the proportions.
1. Interpret the CI.
1. Use the software output (Fig.\ \@ref(fig:TurbinesOutput), left panel) to write down a $95$%\ CI for the odds ratio.
1. Interpret the CI.
1. Use the software output (Fig.\ \@ref(fig:TurbinesOutput), left panel) to test for a relationship.
1. Compute, then carefully interpret, the OR.
1. Are the CIs and tests statistically valid (Fig.\ \@ref(fig:TurbinesOutput), right panel)?
:::
...
The rainfall at Emerald (Queensland) was recorded for Augusts between\ 1889 to\ 2002 inclusive [@mypapers:dunnsmyth:glms], where the monthly average\ SOI was positive, and when the SOI was non-positive (zero or negative), shown in Table\ \@ref(tab:SOItableAnalysis).
...
@data:Christensen:sandflies studied the number of sandflies caught in light traps set at\ $3$ and\ $35$ feet above ground in eastern Panama (Table\ \@ref(tab:SandfliesHT)).
They asked:
