...
\begin{align*}
\text{s.e.}(p_L) &= \sqrt{ \frac{\hat{p}\times(1 - \hat{p})}{n_L}} = \sqrt{ \frac{0.85792\times(1 - 0.85792)}{54}} = 0.047511.\\
...
* a proportion of\ $0.8579$ of the $54$\ students who *live with their parents* (i.e., $0.8579\times 54 = 46.33$ students) to eat most meals off-campus.
...
* $H_0$: $p_N - p_R =   0$ (equivalent to $p_N =   p_R$).
...
```{r BurrosChisqjamoviPlot, fig.show="hold", fig.cap="Left: a stacked bar chart for the burro-health data. Right: software output for the burro-health data.", fig.align="center", out.width=c("40%", "54%"), fig.width=c(4, 4)}
