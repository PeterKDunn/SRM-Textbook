...
## Example: body temperatures {#BodyTemperature}
...
A *sample* of people can be taken to determine whether there is evidence that the *population* mean internal body temperature is $37.0$^o^C.\index{Mean!population}
