...
A *decision* is sought about the value of the *population* mean body temperature; presumably, the population is people in general.
...
so the population for the study (and RQ) should be defined accordingly.
