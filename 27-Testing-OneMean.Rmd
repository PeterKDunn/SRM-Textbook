...
1. The standard error of the mean is $0.231$. \tightlist
...
`r if( knitr::is_html_output() ) {torf(answer=TRUE)}`
1. There is no evidence to accept the *alternative* hypothesis (that the mean headway is less than $1.9$\secs).
`r if( knitr::is_html_output() ) {torf(answer=TRUE)}`
:::
...
**1.** False: $0.231/\sqrt{28} = 0.0436$.
**2.** False: The *population* mean headway is\ $1.9$\secs.
**3.** True.
**4.** True.
**5.** True.
**6.** True.
**7.** False: very strong evidence that mean headway is *less than* $1.9$\secs.
:::
