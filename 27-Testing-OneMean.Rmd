...
A *sample* of people can be taken to determine whether there is evidence that the *population* mean internal body temperature is not $37.0$^o^C.\index{Mean!population}
...
It is not a $z$-score however; it is a $t$-score.
...
Using the summary of the data for weekend sleep-times (Table\ \@ref(tab:SleepingSummary)), do girls get *at least* $10$ hours of sleep per night, on average?
Do boys?
:::
