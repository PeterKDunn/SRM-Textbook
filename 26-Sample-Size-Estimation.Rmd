...
All other things being equal, a *larger* sample size gives a more precise estimate. 
...
Determining what sample size to use is a trade-off between cost, time, ethics and precision. 
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
The ideas in this section also work for computing sample sizes for estimating *mean differences*.
EXAMPLE
:::
