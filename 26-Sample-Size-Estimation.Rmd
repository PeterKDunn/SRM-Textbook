...
After all, that's why we would like larger samples: to get better (more [*precise*](#PrecisionAccuracy)) estimates, and hence narrower CIs.
...
Suppose we want our 95% CI for the proportion of smokers (Example \@ref(exm:NHANESSmokers)) to be
precise to give-or-take $0.01$ (rather than the $\pm 0.018$ found from the sample).
