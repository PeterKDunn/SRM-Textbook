...
All other things being equal, *larger* samples produce more [*precise*](#PrecisionAccuracy) estimates of the parameter (Sect.&nbsp;\@ref(PrecisionAccuracy)), and hence *narrower* CIs (Fig. \@ref(figSampleSizeCIWidthMean)).
