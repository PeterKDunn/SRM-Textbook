...
The sample size was determined based on the primary information obtained on FBG from a study conducted by Ebrahimi-Mameghani et al. (2014). The mean difference (SD) for serum FBG was −7.96 (8.74) in intervention group and −1.46 (3.72) in control group. Considering α value as 0.05 and a power of 80 %, the sample size was calculated as 22 patients in each group. This number has been increased to 24 per group, to accommodate the anticipated dropout rate.
