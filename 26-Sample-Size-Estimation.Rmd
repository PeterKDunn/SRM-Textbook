...
Suppose we want a $95$% CI for the proportion of smokers to be precise to give-or-take $0.01$ (that is, the margin of error is $\pm 0.01$, rather than the $\pm 0.018$ found from the sample).
...
NEED A NEW ONE: This exmaples removed

the mean *reduction* in diastolic blood pressure from the first to the second visit to a clinic was estimated [@data:Willems1997:CHD; @data:Schorling1997:smoking], using a sample of size $n = `r n.D.diff`$.
...
The sample size was determined based on the primary information obtained on FBG from a study conducted by Ebrahimi-Mameghani et al. (2014). 
The mean difference (SD) for serum FBG was $-7.96$ ($8.74$) in intervention group and $-1.46$ ($3.72$) in control group. 
Considering $\alpha = 0.05$ and a power of $80$%, the sample size was calculated as 22 patients in each group. 
This number has been increased to $24$ per group, to accommodate the anticipated dropout rate.

From: [@hosseinabadi2020effects].
