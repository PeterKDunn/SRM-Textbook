...
The aim was to estimate the mean age of residents to with $2$ years of age, and the proportion of incidents related to falls to within $0.15$.
...
\]
or at least $54$ residents.
The sample size required to meet the falls requirement is at least  
\[
  n = \frac{1}{(\text{Margin of error}^2)} = \frac{1}{0.15^2} = 44.444,
\]
or $45$.
Since the same subjects will be required for both estimates, the study should use at least $54$ residents.
