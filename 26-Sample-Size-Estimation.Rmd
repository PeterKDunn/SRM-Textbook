...
Figure \@ref(fig:SampleSizeCIWidth) shows the approximate width of the CI for estimating a proportion
...
```{r SampleSizeCIWidth, echo=FALSE, fig.align="center", out.width = "80%", fig.cap='The approximate width of a 95\\% CI when various size samples are used', fig.height = 5}
ME <- function(n, p = 0.5){
  1.96 * sqrt( p * (1 - p) / n)
}
...
par( mfrow = c(1, 1),
     mar = c(4, 4, 5, 2), # LINES on each side of plot
