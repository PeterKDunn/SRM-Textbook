...
## Estimating sample sizes: one proportion {#SampleSizeProportions}
...
```{r SampleSizeCIWidthMean, echo=FALSE, fig.align="center", out.width = "65%", fig.cap='The approximate width of a 95\\% CI for a mean, when various size samples are used. No values are given on the vertical axis, as the actual values depend on the value of the standard deviation, $s$', fig.height = 4.5}
ME <- function(n, s = 1){
  1.96 * 2 * s / sqrt( n )
}
n <- seq(5, 50, by = 1)
...
## Estimating sample sizes: mean differences {#SampleSizeMeanDifferences}
