...
Response rates from questionnaires are often very low.\index{Questionnaire!response rate}
:::
...
Data from open question are usually text-based (such as words, sentences or paragraphs of text).
...
In closed questions where respondents can select all options that apply, each option requires its own column, recording each respondent's answer for that option.
