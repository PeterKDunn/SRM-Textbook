...
Answers to open-ended questions more easily lend themselves to qualitative analysis.
...
* *Avoid leading questions*, which may lead respondents to answer a certain way.\index{Leading questions}
...
* *Response bias* (Sect. \@ref(SelectionBias)):\index{Bias!response}
  ...
  Sometimes, respondents repeatedly provide the same answer to a series of multiple-choice questions.
