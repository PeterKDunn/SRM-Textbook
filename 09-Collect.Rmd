...
* For closed questions: ensure options are *mutually exhaustive* (responses fit into only one category)\index{Mutually exclusive} and *exhaustive* (categories cover *all* options).\index{Exhaustive}
