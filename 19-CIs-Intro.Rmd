...
One type of [research question](#TwoApproaches) is the [estimation-type RQ](#TwoApproachesCI), where the precision of a *statistic* is of interest.
In this Part, answering estimation-type RQs is discussed for:

* Descriptive RQs: Chaps.&nbsp;\@ref(CIOneProportion) to \@ref(PairedCI);
* Relational or interventional RQs with a *comparison*: Chaps.&nbsp;\@ref(CITwoMeans) and \@ref(OddsRatiosCI).
