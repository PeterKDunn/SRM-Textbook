...
```{r MonsoonRubbish, fig.cap="Relative abundance of a gastropod from random quadrat surveys conducted over prevalent monsoon types in all study areas in Talim Bay. Error bars represent 95\\% confidence intervals.", fig.align="center", fig.width=4.5, fig.height=3.5}
...
```{r SignageErrorBar, fig.cap="Boxplot (left); error bar chart (right) showing the mean speed before and after the addition of extra signage, and the 95\\% CIs", fig.align="center", out.width='60%',fig.width=5.5, fig.height=3.5}
...
```{r}
if( knitr::is_latex_output() ) {
  tb1 <- cbind( Deceleration$Deceleration[Deceleration$When == "Before"][1:7],
                Deceleration$Deceleration[Deceleration$When == "Before"][8:14],
                Deceleration$Deceleration[Deceleration$When == "Before"][15:21],
                Deceleration$Deceleration[Deceleration$When == "Before"][22:28],
                Deceleration$Deceleration[Deceleration$When == "Before"][29:35],
                c(Deceleration$Deceleration[Deceleration$When == "Before"][36:38], NA, NA, NA, NA) )
  T1 <- knitr::kable( tb1,
                      format = "latex",
                      valign = 't',
                      align = "c",
  ...
  tb2 <- cbind( Deceleration$Deceleration[Deceleration$When == "After"][1:7],
                Deceleration$Deceleration[Deceleration$When == "After"][8:14], 
                Deceleration$Deceleration[Deceleration$When == "After"][15:21], 
                Deceleration$Deceleration[Deceleration$When == "After"][22:28], 
                Deceleration$Deceleration[Deceleration$When == "After"][29:35], 
                c(Deceleration$Deceleration[Deceleration$When == "After"][36:41], NA) ) 
  T2 <- knitr::kable( tb2,
                      format = "latex",
                      align = "c",
                      valign = 't',
