...
```{r PhonePlots, echo=FALSE, fig.width=3, fig.height=3.0, out.width='100%', fig.alt="Boxplot of the two groups in the reaction-time data", fig.align="center", fig.cap="A boxplot of the reaction-time data"}
