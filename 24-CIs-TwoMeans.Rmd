...
if( knitr::is_latex_output() ) {
  tb1 <- cbind( ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][1:4],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][5:8],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][9:12],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][13:16],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][17:20],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][21:24],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][25:28],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][29:32])
  T1 <- knitr::kable( tb1,
                      format = "latex",
  ...
  tb2 <- cbind( ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][1:4],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][5:8], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][9:12], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][13:16], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][17:20], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][21:24], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][25:28], 
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][29:32])
  T2 <- knitr::kable( tb2,
                      format = "latex",
                      #col.names = c("Using phone",
                      #              "Not using phone"),
