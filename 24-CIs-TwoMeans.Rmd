...
In one study, two different groups of students were used: one *used* a mobile phone, and one  *did not use* a mobile phone.
This is a [*between individuals* comparison](#Comparison), since dfifferent students are in each group.
...
```{r ReactionTimeSamplingDist, echo=FALSE, fig.cap="The sampling distribution of the difference between the reaction times in the phone and control groups (phone, minus control)", fig.align="center", fig.width=8, fig.height=2.75, out.width='90%'}
...
```{r FallFowardTTestjamovi, echo=FALSE, fig.cap="jamovi output for the face-plant data", fig.align="center", out.width='95%'}
