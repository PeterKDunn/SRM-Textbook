...
if( knitr::is_latex_output() ) {
  tb1 <- cbind( ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Phone"][1:4],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd][5:8],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd][9:12],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd][13:16],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd][17:20],
                ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd][21:24],
  ...
  tb2 <- cbind( ReactionTimePhoneInd$Reaction[ReactionTimePhoneInd$Group == "Control"][1:4],
                ...
                ReactionTimePhoneInd$Reaction[RReactionTimePhoneIndT$Group == "Control"][21:24], 
...
if( knitr::is_html_output() ) {
  RT.DataTableHTML <- cbind( "Use phone" = RReactionTimePhoneIndT$Reaction[ReactionTimePhoneInd$Group == "Phone"], 
