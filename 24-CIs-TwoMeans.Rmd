...
```{r PhonePlots, fig.show='hold', fig.cap="Plots of the reaction times (in milliseconds) for students using, and not using, mobile phones.", fig.align="center", echo=FALSE, fig.width=2, fig.height=3.5}
...
```{r ReactionTimeSamplingDist, echo=FALSE, fig.cap="The sampling distribution of the difference between the reaction times in the phone and control groups (phone, minus control)", fig.align="center", fig.width=5, fig.height=2.5, out.width='70%'}
