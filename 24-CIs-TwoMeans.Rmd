...
if( knitr::is_latex_output() ) {
  ...
  T1 <- knitr::kable( RT.DataTable[1:5, ],
                      format = "latex",
  ...
  T2 <- knitr::kable( RT.DataTable[6:10, ],
                      format = "latex",
                      col.names = c("Using phone",
                                    "Not using phone"),
                      align = c("c", "c"),
  ...
  out <- knitr::kables(list(T1, T2),
                       ...
                       caption = "Reaction times (in milliseconds) for students using, and not using, mobile phones. Only the first nine observations are shown, but 32 students are in each group") %>% 
