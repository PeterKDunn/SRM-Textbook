...
> Based on the sample, an *approximate* 95% CI for the difference between mean reaction times is from $`r round(RT.mn - 2*RT.se, 2)`$ to $`r round(RT.mn + 2*RT.se, 2)`$ milliseconds, slower for those *using* a phone compared to those *not using* a phone.
