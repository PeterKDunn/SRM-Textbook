...
* centred around a sampling mean $\mu_{\bar{x}_A - \bar{x}_B}$, whose value is $\mu_A - \mu_B$ (the *differences* between the population means);
...
=======
TwoMeansNotation[6, ] <- c("across all possible samples",
                          "with sampling mean $\\mu_{A - B}$ and standard deviation $\\text{s.e.}(\\bar{x}_A - \\bar{x}_B)$")
>>>>>>> 851675169f9c74c5b4842b95e5661e6c1a03ead4
