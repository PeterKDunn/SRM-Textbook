...
```{r SignageErrorBar, fig.cap="Boxplot (left); error bar chart (right) showing the mean speed before and after the addition of extra signage, and the 95\\% CIs", fig.align="center", out.width='70%',fig.width=6.0, fig.height=3.5}
...
> Based on the sample, the reduction in the mean speed after adding signage is $5.68$\ km/h (before mean: $98.02$; s.e.: $2.140$; $n = 38$; after mean: $92.34$; s.e.: $2.051$; $n = 41$), with an approximate $95$% CI between $-0.24$\ km/h (i.e., an increase of $0.24$\ km/h) and $11.6$\ km/h (two independent samples).
...
## Example: health promotion services: REMOVE {#BHADP}
...
```{r BHADPErrorBar, fig.cap="Error bar chart showing the mean BHADP score for people with and without a disability, and the 95\\% CIs", fig.align="center", fig.width=5.5, fig.height=3.5, out.width="55%"}
### Disability example
bit <- 0.05
