...
TwoMeansNotation[4, ] <- c("",
                          "Groip B: Vary with mean $\\bar{x}_B$ and standard deviation $s_B$")

TwoMeansNotation[5, ] <- c("Difference between sample means ($\\bar{x}_A - \\bar{x_B}$)",
                          "Vary with approx. normal distribution (under certain conditions)")
TwoMeansNotation[6, ] <- c("across all possible samples",
                          "with mean $\\mu_{A - B}$ and standard deviation $\\text{s.e.}(\\bar{x}_A - \\bar{x}_B)$")
...
if( knitr::is_latex_output() ) {
  ...
  TwoMeansNotation[3, 1] <- paste(TwoMeansNotation[3, 1], 
                                 TwoMeansNotation[4, 1])
  TwoMeansNotation[3, 2] <- paste(TwoMeansNotation[3, 2], 
                                 TwoMeansNotation[4, 2])
  TwoMeansNotation[3, 3] <- paste(TwoMeansNotation[3, 3], 
                                 TwoMeansNotation[4, 3])
  TwoMeansNotation[3, 4] <- paste(TwoMeansNotation[3, 4], 
                                 TwoMeansNotation[4, 4])
  TwoMeansNotation[4, ] <- NA
