...
```{r MatchScatter, fig.align="center", fig.cap="Four plots: estimate the correlation coefficients.", fig.height=2.5, fig.width=7, out.width="100%"}
par( mfrow = c(1, 4),
     mar = c(4, 4, 4, 1.5) )
...
```{r HeightAgeScatter, fig.cap="The age and height of South Korean females ($n = 517$). The solid line shows the linear relationship.", fig.align="center", fig.show="hold", fig.width=5, fig.height=3.5, out.width='60%'}
