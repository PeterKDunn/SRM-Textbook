...
Only the *Pearson* correlation coefficient is discussed here, but other correlation coefficients also exist (such as the *Spearman* correlation coefficient\index{Correlation coefficient!Spearman}, which may be used for increasing-only or decreasing-only *non-linear* relationships).
