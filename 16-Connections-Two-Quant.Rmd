...
```{r RedDeerScatter, fig.width=7.5, out.width='80%', fig.height=4, fig.cap="(ref:RedDeerPlotIndicate)", fig.align="center"}
data(RedDeer)
...
\index{Scatterplot!form}\index{Correlation}\index{Correlation coefficient}
...
* *Plot A*: the correlation coefficient is *positive*, and reasonably near one.
...
```{r SanddollarsPlot, fig.cap="Water temperature vs fertilization rates for sand dollars. Left: an inappropriate linear relationship. Right: a curved relationship", fig.align="center", fig.width=8, fig.height=3.25, out.width='90%'}
par(mfrow = c(1, 2))
...
We will use software to obtain values of $r$.
