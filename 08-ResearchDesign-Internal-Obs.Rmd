...
* Clinic with male doctors: 9.9%.
* Clinic with female midwives: 3.4%.

While the mortality rate may seem to be associated with the sex of the person delivering the baby, an important *lurking variable* was present.
Semmelweis had eliminated many possible lurking variables, such as over-crowding (the second clinic was actually more overcrowded) and climate (similar for both clinics).

In this era, the benefits of hand washing were not understood, nor commonplace, and Semmelweis found that many (males) doctors had performed autopsies before delivering babies.
Autopsies were not performed by (female) nurses.
...
After instituting hand washing for doctors, the mortality rate reduced in the first clinic.
::: 
