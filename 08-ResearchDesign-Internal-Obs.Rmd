...
The goal of study design is to design a study to isolate the relationship of interest, by eliminating, as far as possible, all other possible explanations.
:::
...
* [**Blocking**](#ObsConfoundingBlocking).
  ...
  @doll1954mortality, for example, could have separately analysed men aged over 35 and men aged 35 or under.
...
:::{.example #ConfoundingChildbirth name="Poor internal validty"}
...
> Observations were carried out continuously from the start to the end of work...
...
Is the Hawthorne effect only a (potential) issue for experimental studies?
Explain.
:::
