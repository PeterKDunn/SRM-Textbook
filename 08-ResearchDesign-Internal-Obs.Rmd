...
Nonetheless, since it may prove at least partially successful and is easy to implement, this strategy should form part of the study design.
...
* To improve *internal validity*, by helping to manage confounding:
  ...
  * by using special methods of analysis (Sect.\ \@ref(ObsManagingConfounding)).
