...
The smoking study above is observational, so confounding is potentially a problem for establishing a relationship between smoking and lung cancer.
...
The relationship between the response and explanatory variables depended on whether the participants were being watched, which compromises internal validity.
:::
