...
Despite low internal validity, the study still showed some promising signs of teaching IPM that need to be explored in future studies.
:::
...
The best advice for observational studies is to *record all the information that is likely to be important for understanding the data*.
...
::: {.importantBox .important data-latex="{iconmonstr-warning-8-240.png}"}
*Record* all the information that is likely to be important for understanding the data.
