...
In observational studies, allocation of treatments is not possible (otherwise, it would be an experimental study).
For this reason, confounding is often a major threat to [internal validity](#def:InternalValidity) in observational studies, as individuals who are in one group may be different, in general, to those who are in another group (Table \@ref(tab:SedentaryDemographics)).
...
> All images were randomly named and sorted, with the dates [...] removed to minimize observer expectancy bias [i.e., the observer effect].
>
> --- @zimova2020using, p. 4
:::
...
```{r DesignConsiderationsOBS, echo=FALSE, fig.cap='(ref:DesignConsiderationsOBS-Caption)', out.width='85%', fig.align="center",  fig.width=8.00} 
# fig.height=6,
...
curvedarrow(from = pos[4, ], # Placebo
            ...
            lty = 1, 
            lwd = 2)
text(x = mean( c(pos[4, 1], pos[11, 1])),
     y = c( pos[4, 2], pos[4, 2]),
     labels = "Not randomly",
     pos = 3)
text(x = mean( c(pos[4, 1], pos[11, 1])),
...
::: {.exercise #ObservationalHaveControl}
