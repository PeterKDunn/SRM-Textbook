...
For example, in the smoking study of @doll1954mortality, participants were restricted to males aged under 35 years since, at the time of the study:
...
The best advice for observational studies is to **measure, observe, assess or record all the information that is likely to be important for understanding the data**.
While this is also useful for experimental studies, it is particularly important for observational studies, as managing confounding through analysis (Sect. \@ref(ExpManagingConfoundingAnalysis)) is often one of the few practical means available.
...
In a different smoking study, @data:DollHill1950:Smoking recorded the social class and place of residence of each participant, as potential confounding variables.
:::
...
They used these variables in their analysis to manage the potential effects of confounding.
Their analysis showed that 'elevation of the orchard' and 'whether or not general fungicides were used' were important confounding variables, but 'whether or not the farm was organic' was not.
:::
...
In an observational study compared the iron levels of active and sedentary women aged 18 to 35 [@data:woolf:ironstatus].
...
In the smoking study of @doll1954mortality, doctors who chose to smoke may be inclined to undertake other risky behaviours, whereas those doctors who choose *not* to smoke may also be inclined to *not* undertake other risky behaviours.
It may be those *other* risky behaviours that lead to  lung cancer, and not the smoking itself.

In a different smoking study, @data:DollHill1950:Smoking used a control group.
The control group was chosen to be very similar to those in the lung-cancer group, in terms of age and sex.
...
Indeed, one specific type of observational study is called a [*case-control study*](https://en.wikipedia.org/wiki/Case%E2%80%93control_study). 
...
For example, in an observational study where subjects' blood pressure is measured [@verdecchia1995cigarette], subjects clearly know they are being observed.
This has the potential to alter how the subjects behave (for example, people become more tense, called 'white-coat hypertension'; @pickering2002white).
...
In this example, the observer effect could be managed if the researchers *first* measured the blood pressure, and *then* asked if the individual was a smoker or not.
...
> ... 50.4% ($n = 248$) to have potential for observer bias, but only 13.3% ($n = 33$ of $248$) of these articles 
...
> Other limitations of citizen produced data arise from observer bias; the search effort differs between observers, observers may be geographically unevenly distributed and can fail to detect the species present [...]
...
Many comments about blinding in Sect. \@ref(DescribingBlinding) apply for observational studies also. 
...
**1.** Only the second statement is true.

**1.** In case the size of the hive is a confounding variable.
:::
`r if (knitr::is_html_output()) '-->'`
