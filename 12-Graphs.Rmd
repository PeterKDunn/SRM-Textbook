...
Graphs should focusing on clear communication, not to appear fancy. 
...
```{r Bar3D2D, out.width='49%', fig.width=c(5, 3.75), fig.height=c(5, 3.5), fig.align="center", fig.cap="Two plots of the NHANES participants, divided by age group and sex. Left: A three-dimensional bar chart; right: a side-by-side bar chart", fig.show="hold"}
...
#par( mfrow = c(1, 2), mar = c(0, 0, 4, 3) + 0.1 ) # DEFAULT: c(5, 4, 4, 2) + 0.1.
par( mar = c(0, 0, 4, 3) + 0.1 ) # DEFAULT: c(5, 4, 4, 2) + 0.1.
