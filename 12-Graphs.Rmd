...
* Between-individual comparisons with a qualitative response variable (Sect.\ \@ref(TwoQualVars)).
...
The first weight, of $1.7$\ kg, is entered with the $1$ to the right of the stem, and the $7$ to the left: `1 | 7`. 
Similarly, $2.1$\ kg is entered as `2 | 1` and $2.2$\ kg is entered as `2 | 2`, sharing the same stem as for 2.1kg.
...
* Add an explanation for reading the stemplot.
  For example, the stemplot for the baby-birth data says '$2$\ |\ $6$ means $2.6$\ kg'.
  For instance, '$2$\ |\ $6$' could mean $26$\ kg, or $0.26$\ kg, or $2$\ lb $6$\ oz.
...
A histogram of the data (Fig.\ \@ref(fig:BrainFreeze), based on @data:Mages2017:BrainFreeze, Fig. 2b), shows $11$ people experience HICS symptoms less than $5$\ s in length; nine people experienced symptoms for at least $5$ but less than $10$\ s; and $1$ person experienced symptoms for at least $35$\ s but under $40$\ s.
:::
...
## Between-individual comparisons with a quantitative response {#GraphOneQualOneQuant}
...
## Between-individual comparisons with a qualitative response {#TwoQualVars}
...
## Within-individual comparisons with a quantitative response {#PlotsWithinIndividuals}
