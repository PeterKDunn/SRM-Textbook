...
The main RQ involves the *relationship* between average direct HDL cholesterol concetration and current smoking status, so a graph displaying this relationship is needed (Fig. \@ref(fig:NHANESboxplot)).
