...
```{r FriesPDF, fig.cap="Large orders of French fries: Mass measurements (left panel) and percentage of target mass (right panel)", fig.align="center", fig.width=7, fig.height=4, out.width='95%'}
if (knitr::is_latex_output()){
...
`r if (knitr::is_latex_output()) {
   'the left panel of Fig. \\@ref(fig:LCgraphsPDF).'
} else {
