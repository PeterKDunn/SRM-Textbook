...
The time between eruptions (Fig.\ \@ref(fig:BimodalFaithfulHistoChangeBins), left panel) is bimodal, with peaks near 55 minutes and 80 minutes.
:::
...
The histogram (Fig.\ \@ref(fig:NHANESHDLHistBar), left panel) shows that the direct HDL cholesterol concentration is usually around 1.5mmol/L, and varies between about 0.5 and 3 mmol/L.
