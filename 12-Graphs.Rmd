...
```{r BoxplotKrillTreatment, echo=FALSE, message=FALSE, warning=FALSE, fig.cap="A boxplot for the krill-egg data; the boxplot just for the treatment group", fig.width=7, fig.height=6.5, fig.align="center", }
...
text( 1.45, Eggs.quantiles[5], 
      "Maximum value", 
      pos = 1, 
      cex = 0.75)
text( 1.45, Eggs.quantiles[4], 
      "75% smaller than this", 
      pos = 3, 
      cex = 0.75)
text( 1.45, Eggs.quantiles[3], 
      "Middle value ('average')", 
      pos = 3, 
      cex = 0.75)
text( 1.45, Eggs.quantiles[2], 
      "25% smaller than this", 
      pos = 3, 
      cex = 0.75)
text( 1.45, Eggs.quantiles[1], 
      "Minimum value", 
      pos = 1, 
      cex = 0.75)
stripchart( list(Treatment = Eggs.T), 
            ...
            col = plot.colour0)
text( x = 2.5,
      y = c( mean(Eggs.quantiles[1:2]),
             mean(Eggs.quantiles[2:3]),
