...
* Sometimes, data might need to be suitably rounded before creating the stemplot.
...
* Add an explanation for reading the stemplot.
  For example, the caption for the stemplot for the baby-birth data in Sect. \@ref(StemAndLeafPlots) says '2 | 6 means 2.6kg', which explains what the stem plot means. 
