...
```{r FriesPDF, fig.cap="Large orders of French fries: Mass measurements (left panel) and percentage of target mass (right panel)", fig.align="center", fig.width=9, fig.height=3, out.width='95%'}
if (knitr::is_latex_output()){
...
```{r IndependencePie, fig.cap="Severity of diagnoses of participants", fig.align="center", fig.height=2.5, out.width='65%'}
