...
(Answer is here^[*Average*: Hard to be sure... maybe between 10 or 15. (More observations appear at the smaller values (as the bars are higher).) *Variation*: From about 0 to about 40. *Shape*: Slightly skewed right. *Outliers*: No outliers or unusual observations. The observation between 35 and 40 *may* be an outlier. I suspect it is *not* an outlier, as a larger sample may very well have observations between 30 and 35. Of course, I could be wrong.].)
:::
...
(Answer is here^[1. A pie chart is **not suitable**.
   ...
   Also, the three browsers are not *mutually exclusive* 
