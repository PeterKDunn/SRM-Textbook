...
But before analysis begins, understanding, describing and summarising the collected sample data are important.
...
* *Right* (or *positively*) skewed: the bulk of the data are smaller, with some larger values (to the *right*).
* *Left* (or *negatively*) skewed: the bulk of the data are larger, with some smaller values (to the *left*).
