...
plot( (Weight/1000) ~ Mins.Since.Midnight,
      data = BB,
...
Instead, sometimes graphs are constructed to appear fancy or clever, rather than focusing on clear communication.
...
Data to answer this (and other) RQs are obtained from the American *National Health and Nutrition Examination Survey* (NHANES) [@data:NHANES3:Data; @data:NHANES3].
