...
The histogram (Fig. \@ref(fig:NHANESHDLHistBar), left panel) shows that the direct HDL cholesterol is usually around 1.5mmol/L, and varies between about 0.5 and 3 mmol/L.
The data are slightly skewed right.


```{r NHANESHDLHistBar, fig.cap="Plots from the NHANES data. Left: histogram of the direct HDL cholesterol (large outliers exist but are hard to see); centre: bar chart of current smoking status for the NHANES data; right: bar chart of current smoking status, including missing data", fig.align="center", fig.height = 3.5, fig.width=3.5, out.width=c('33%', '32%', '32%'), fig.show="hold"}
