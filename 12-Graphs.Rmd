...
The histogram shows, for example, that 17 babies weighed 3.0kg or more, but under 3.5kg.\smallskip
...
```{r IndependencePie, fig.cap="Severity of diagnoses of participants", fig.align="center", fig.height=2.25, out.width='65%'}
...
However, sometimes data can be collated in a table (Fig. \@ref(fig:IndependencePie)), or a *tabular summary*.
For qualitative data, the tabular summary records the numbers (or percentages) for each level of the variable (Example \@ref(exm:NHANESdata)).
For quantitative data, the tabular summary effectively producs a histogram as a table (Example).
...
```{r KrillEggsDoubleStem, fig.cap="The number of eggs from krill, for control and treatment groups", fig.align="center", fig.width=7.0}
