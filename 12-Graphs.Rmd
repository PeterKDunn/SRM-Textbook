...
```{r animation.hook="gifski", cache=TRUE, echo=FALSE, interval=0.85, dev=if (is_latex_output()){"png"}else{"pdf"}}
  BB <- structure(list(Time = c(5L, 104L, 118L, 155L, 257L, 405L, 407L, 
                                422L, 431L, 708L, 735L, 812L, 814L, 909L, 1035L, 1049L, 1053L, 
                                1133L, 1209L, 1256L, 1305L, 1406L, 1407L, 1433L, 1446L, 1514L, 
                                1631L, 1657L, 1742L, 1807L, 1825L, 1854L, 1909L, 1947L, 1949L, 
...
```{r animation.hook="gifski", cache=TRUE, cache=TRUE, echo=FALSE, interval=0.85, dev=if (is_latex_output()){"png"}else{"pdf"}}
if (knitr::is_html_output()){
#KRILL
...
```{r animation.hook="gifski", cache=TRUE, echo=FALSE, interval=0.55, fig.height=7, dev=if (is_latex_output()){"png"}else{"pdf"}}
  BB <- structure(list(Time = c(5L, 104L, 118L, 155L, 257L, 405L, 407L, 
                                422L, 431L, 708L, 735L, 812L, 814L, 909L, 1035L, 1049L, 1053L, 
                                1133L, 1209L, 1256L, 1305L, 1406L, 1407L, 1433L, 1446L, 1514L, 
                                1631L, 1657L, 1742L, 1807L, 1825L, 1854L, 1909L, 1947L, 1949L, 
...
```{r echo=FALSE, animation.hook="gifski", cache=TRUE, interval=1, dev=if (is_latex_output()){"png"}else{"pdf"}}
library(NHANES)
data(NHANES)
...
```{r echo=FALSE, cache=TRUE, animation.hook='gifski', interval=0.2, dev=if (is_latex_output()){"png"}else{"pdf"}}
library(GLMsData)
data(danishlc)
...
```{r animation.hook="gifski", cache=TRUE, echo=FALSE, dev=if (is_latex_output()){"png"}else{"pdf"}}
library(NHANES)
data(NHANES)
