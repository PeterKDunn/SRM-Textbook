...
2.What graph would be appropriate for the *explanatory* variable?  
`r if( knitr::is_html_output(exclude = "epub") ) {longmcq( c(
	"A bar chart",
	answer = "A histogram",
	"A boxplot",
...
3. What graph could be used to graph the *relationship* between the response and explanatory variables?  
`r if( knitr::is_html_output(exclude = "epub") ) {longmcq( c(
	"A bar chart",
	"A histogram",
	"A boxplot",
...
4. What graph could be used to graph the *relationship* between the 'surface temperature' and 'bruise location'?  
`r if( knitr::is_html_output(exclude = "epub") ) {longmcq( c(
	"A bar chart",
	"A histogram",
	answer = "A boxplot",
...
**1.** Scatterplot.
**2.** Histogram of the differences.
