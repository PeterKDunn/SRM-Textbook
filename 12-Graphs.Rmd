...
However, sometimes qualitative data also can be collated and displayed in a table (Fig. \@ref(fig:IndependencePie)).
With small amounts of information, sometimes just writing the information is better ('69% of diagnoses were less severe').

Compare different ways of presenting the NHANES age data in Example \@ref(exm:ComparingGraphs):
Fig. \@ref(fig:3Dcharts) is a graphical summary of the data collated in Table \@ref(tab:SimpleTable).
Which do you think is 'best' to collate the data, and why?
