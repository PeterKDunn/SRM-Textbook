...
The two *conditions* are 'taking echinacea', and 'not taking echinacea' (Fig.\ \@ref(fig:ObsStudiesImage), left panel).
:::
...
This RQ uses a *within-individuals comparison* (before and after walking $400$\ m) so is a repeated-measures RQ.
...
```{r ObsStudiesImage, fig.cap="Observational studies. The dashed lines indicate steps not under the control of the researchers", fig.align="center", fig.show="hold", fig.width=4, fig.height=3, out.width='48%', cache=FALSE}
...
showRepeatedMStudyDesign(interventionName = "400 m walk",
                         outcomeName = "Avge heart rate",
                         stateNames = c("Before",
                                        "After"))
...
Two types of experimental studies are [*true experiments*](#TrueExperiments) and [*quasi-experiments*](#QuasiExperiments) (Table\ \@ref(tab:ExperimentalStudyDesigns)).
...
```{r TrueExpStudiesImage, fig.cap="True experimental studies: researchers allocate individuals to groups, and treatments to groups", fig.align="center", fig.show="hold", fig.width=4, fig.height=3, out.width='48%'}
...
source("R/showRepeatedMStudyDesign.R")
showRepeatedMStudyDesign(interventionName = "Echinacea")
```
...
```{r QuasiExpStudiesImage, fig.cap="Quasi-experimental studies: researchers do not allocate individuals to groups, but do allocate treatments to groups. The dashed lines indicate steps not under the control of the researchers.", fig.align="center", fig.width=7, fig.height=3, out.width='75%'}
...
Three types of research studies are: *Descriptive studies* (for descriptive RQs), *observational studies* (for RQs *without* an intervention), and *experimental* (for RQs *with* an intervention).
...
What type of study is this: descriptive, observational, quasi-experimental, or a true experiment?
Explain.
:::
