...
In the decision-making process used in statistics (Sect. \@ref(DecisionMaking)), an *assumption* is made about a parameter describing the population.
...
The values of the statistic that we can reasonable *expect* from all possible samples can be described using a *distribution*: that is, by describing what values the statistic can from all these samples, and how often.
...
We now study this distribution, as it often is the basis for describing what values of the statistic are reasonable to observe.




????The distribution is a *model* to describe how often we would see all possible values of $\hat{p}$.???
