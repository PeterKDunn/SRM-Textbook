...
# Summarising qualitative data {#NumericalQual}
...
## Introduction {#IntroQualDataSummaries}

The methods used to summarise quantitative data do not always make sense for summarising qualitative data.
Different approaches are needed, as discussed in this chapter.


## Tabulating qualitative data: Proportions and percentages {#ProportionsPercentages}
...
## Comparing qualitative data: two-way tables {#PercentagesKStones}
...
\begin{align*}
  ...
  & =
  \frac{81 + 234}{6 + 81 + 36 + 234} = \frac{315}{357} = 0.882.
\end{align*}
...
```{r SimpsonRulesStones, fig.cap="The size of the stones is related to both the success percentage and the method", fig.align="center", fig.height=2.75, out.width='55%'}
...
## Comparing qualitative data: odds and oddds ratios {#OdddsRatios}
