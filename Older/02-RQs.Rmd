...
This study examines *within*-individuals changes: the changes or differences between the left and right-leg strength *within* each individual.
In this study, *no between-individuals comparison* exists, as difference groups are not being compared.
:::
...
\index{Research question!interventional}
...
\index{Research question!descriptive}\index{Research question!relational}\index{Research question!interventional}
...
Coeliacs are individuals with an inherited auto-immune condition causing an intolerance to the gluten in wheat, rye, barley and some other grains.
