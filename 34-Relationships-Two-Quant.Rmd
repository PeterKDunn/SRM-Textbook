...
correspond to a single deer (that is, the individual deer are the units of analysis),
...
A study of onion growth [@meadplant]
...
plot(Energy ~ DryMatterDigest, 
     ...
     pch = 19)
abline( lm( Energy ~ DryMatterDigest, data = ruminant), 
        lwd = 2, 
	col = "grey")
```
