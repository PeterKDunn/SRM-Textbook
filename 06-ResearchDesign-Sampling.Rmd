...
```{r PrecisionAccuracy, fig.align="center", fig.cap="Precision and accuracy: each dot indicates where a shot at the target lands, and is like a sample estimate of the population value (shown by the central $\\times$).", fig.width=5.0, out.width='55%'}
...
The researchers *randomly* select $20$\ regions around the country, then select randomly farms within each region, then ask farmers to volunteer to be in the study.
