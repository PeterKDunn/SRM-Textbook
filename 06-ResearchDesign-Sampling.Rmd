...
Assume the study is externally valid: the sample is representative of all Californian university students.
...
`r if (knitr::is_latex_output()) {
   'Consider a fair pack of cards (the *population*), where $50$% of cards are red. The percentage of red cards is not the same in every hand (the *sample*) of ten cards.'
} else {
   'The animation below shows how samples vary. We know that $50$% of cards in a fair, shuffled pack (the *population*) are red, but each hand (the *sample*) of ten cards can produce a different percentage of red cards (and not always $50$%).'
}`
...
* *Judgement samples*:\index{Sampling!non-random!judgement}
  Individuals are selected based on the researchers' judgement (possibly unconsciously), perhaps because the individuals are (or may appear) agreeable, supportive, accessible, or helpful.
...
Sampling | Younger students | Older students | Sample size | %younger in sample
---------|----------------|----------------|-------------|-----------------------
SRS  | 26 | 14 | 40 | 65%
Systematic | 31 | 9 | 40 | 65%
Stratified: equal | 20 | 20 | 50%
Stratified: proportional | 27 | 13 | 40 | 67.5%
Cluster | 31 | 16 | 47 | 66.0%
Multi-stage | 24 | 16 | 40 | 60% 
