...
*This is not a random sample*, but this sample is likely to consist of a variety of students.
...
1. A city council wants to reports the number of homeless, so researchers record data from homeless shelters.
