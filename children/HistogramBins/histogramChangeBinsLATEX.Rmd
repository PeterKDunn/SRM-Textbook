...
```{r, BimodalFaithfulHistoChangeBins, fig.align="center", fig.width=5.0, fig.height=2.25, fig.cap="Changing the bin width can change the impression of the distribution", out.width='100%'}
par( mfrow = c(1, 3))
