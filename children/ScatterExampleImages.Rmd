...
```{r ScatterplotDescriptionExamples, name="ScatterExamples", echo=FALSE,fig.width=6, fig.height=6, fig.align="center", out.width='100%',fig.cap="Some example scatterplots"}
par( mfrow = c(2, 3),
