...
```{r SampleSizeCIWidth, echo=FALSE, fig.align="center", out.width = "95%", fig.cap='The approximate width of a $95$\\% CI for a proportion, when various size samples are used.', fig.height = 4.75, fig.width=9}
ME <- function(n, p = 0.5){
  1.96 * sqrt( p * (1 - p) / n)
}
