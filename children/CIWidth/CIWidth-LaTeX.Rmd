...
```{r CIWidthsMany, echo=FALSE, fig.height=2.5, fig.width=6.5, fig.cap="To have greater confidence that the interval will include the value of the population proportion, the interval needs to be wider, for any given sample size", fig.align="center"}
phat <- 0.5
n <- 25
