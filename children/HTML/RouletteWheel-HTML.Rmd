...
(Of course, the *sample* proportion $\hat{p}$ of odd-spins can vary after spinning the wheel 30, 50 or 100 times also.)\medskip

But, *how* does $\hat{p}$ vary from one set of 15 spins to another set of 15 spins? 
Can we describe *how* the value of $\hat{p}$ varies?
