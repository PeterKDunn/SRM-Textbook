...
```{r, CIWidthsMany2, fig.align="center", fig.width=5.5, fig.height=2.5, fig.cap="Changing the confidence level of the CI changes the width, for any given sample size"}
phat <- 0.5
n <- 25
