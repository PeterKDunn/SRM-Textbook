...
For the situations studied in this book, identifying the *type* of RQ (e.g., descriptive or correlational), the *number* of variables and the *type* of variables (qualitative or quantitative) is important (Table\ \@ref(tab:InferenceTestCI2)).
...
Since they are exploring the relationship between *pairs of quantitative variables*, the RQs are correlational RQs.
