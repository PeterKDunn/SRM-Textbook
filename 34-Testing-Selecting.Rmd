...
*7Appendix\ \@ref(StatisticsAndParameters)* may also prove useful.
...
#                      "Mean and std. error of the diff.; mean, std. dev. etc. of \\emph{each} group",
                      "$t$-test for the diff. between two means",
                      "CI of the diff. between two means")
  ...
  kable(Scenarios,
        ...
        longtable = FALSE,
        escape = FALSE,
        caption = "Five scenarios studied so far",
        format = "latex") %>%
