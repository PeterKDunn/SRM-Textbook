...
```{r QualGraphsStones, fig.align="center", fig.cap="Six plots for the small kidney-stone data", out.width='100%', fig.width=6.15, fig.height=4.25}
par( mfrow = c(2, 3),
     mar = c(5, 4, 5, 2),
     xpd = TRUE)
...
In the sample, the odds of success for Method\ A is many *times* greater than for Method\ B. In fact, in the sample, the odds of success for Method A is $13.5\div 6.5 = 2.08$ *times* the odds of a success for Method\ B. 
...
However, the odds ratio could also be computed using the odds within the columns (i.e., comparing the *columns*), rather than within the rows (as in Example\ \@ref(exm:InterpretingOdds)).
...
```{r SimpsonRulesStones, fig.cap="The size of the stones is related to both the success percentage and the method", fig.align="center", fig.height=2.15, out.width='65%'}
