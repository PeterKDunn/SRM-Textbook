...
```{r, child = if (knitr::is_html_output()) {'./introductions/13-CompareQual-HTML.Rmd'} else {'./introductions/13-CompareQual-LaTeX.Rmd'}}
```
...
\@ref(ManagingConfounding)).\index{Confounding}\index{Variables!lurking}\index{Variables!confounding}
