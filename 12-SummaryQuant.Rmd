...
Quantitative data can be collated in a *frequency table* by grouping the variables into appropriate intervals ('bins').
...
The sample standard deviation is usually calculated using software (such as jamovi) for large amounts of data, or a calculator (in *Statistics Mode*) for small amounts of data.
