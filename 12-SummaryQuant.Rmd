...
Sometimes, quantitative data with very few recorded values are best graphed using different graphs (Sect.\ \@ref(GraphsOneQual)).
...
`r if (knitr::is_latex_output()) {
   'The completed histogram is shown in Fig.\\ \\@ref(fig:BBHist44).'
} else {
...
A histogram of the data (Fig.\ \@ref(fig:BrainFreeze)), shows $11$ people experience symptoms less than $5$\ s in length; nine people experienced symptoms for at least $5$ but less than $10$\ s; and $1$ person experienced symptoms for at least $35$\ s but under $40$\ s.
:::
...
```{r MeansFigLATEX, fig.align="center", fig.width=4.25, fig.height=4.5,fig.cap="Two ways to understand the mean. Left: The mean is the balance point of the data; right: the mean is the value such that the positive and negative distances sum to zero", out.width = c('51%', '4%', '43%'), fig.show='hold' }
