...
To display the distribution, the weights can be grouped into weight intervals (Table\ \@ref(tab:BabyBoomTable)).
The percentages are also given; for example, the percentage of babies over $4.0$\ kg is $1/44 \times 100 = 2.27$%, or about $2$%. 
