...
The distribution of quantitative data can be describing using the average value, the amount of variation, the shape, and identifying outliers.
...
```{r IQRKrill, fig.align="center", fig.width=8.75, fig.height=3.5, fig.cap="A dotchart for the chest-beating data for young gorillas showing the IQR", out.width='100%' }
if (knitr::is_latex_output()){
...
Sketch the histogram for the data. 
:::
...
## Chapter summary {#Chap12-Summary}
