...
```{r BBHist44BrainFreeze, fig.align="center", fig.width=9, fig.height=3, out.width='100%', fig.cap="Left: The final histogram for the baby-birth data. Right: Duration of brain-freeze symptoms after drinking ice water" }
par( mfrow = c(1, 2))
...
```{r GorillasStem, fig.align="center", fig.width=7, fig.height=3.25, out.width='100%', fig.cap='The stemplot for the gorilla chest-beating data' }
if (knitr::is_latex_output()){
...
* *The outlier represents a different population*:
  ...
  If the next oldest student in the data is aged $39$, the outlier can be removed, since it belongs to a different population ('students aged over $40$') than the other observations  ('students aged under $40$').
