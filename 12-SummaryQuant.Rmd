...
Quantitative data can be summarised by displaying the *distribution* of the data (Def.\ \@ref(def:Distribution)): the values taken by the variable, and how often those values appear.
The distribution can be displayed using a table, or a graph.
The distribution of quantitatrive data 0can be describing using the average value, the amount of variation, the shape, and identifying outliers.
...
```{r WaterAcessQuant, fig.align="center", fig.cap="The age of the women, the number of people in the household, and the number of children in the household for the water-access study.", out.width='100%', fig.width=8, fig.height=2.75}
