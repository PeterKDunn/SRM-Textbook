...
```{r DeathAgeHist, fig.cap="Histograms of age at death for female Australians in 2012", fig.align="center", fig.width=6.75, fig.height=3.25, out.width='65%'}
...
Draw a stemplot of the data, then use your calculator (where possible) to calculate the:
