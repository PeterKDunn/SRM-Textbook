...
If the observed value of $\hat{p}$ was not exactly $1/6$, two possible reasons could explain this discrepancy between the value of the statistic and the assumed value of the parameter:
...
The process requires being able to describe what value of the *sample* proportion $\hat{p}$ could reasonably be expected from a fair die, with $p = 1/6$ (i.e., Step\ 3 of the decision-making process).
