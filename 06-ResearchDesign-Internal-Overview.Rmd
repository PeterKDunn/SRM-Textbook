...
## The concept of internal validity {#IntroInternalValidity}
\index{Internal validity}
...
Studies for which this is true have good *internally validity*: they eliminate, or account for, other explanations for the variation in the values of the response variable.
...
Studies with *high* internal validity show that changes in the response variable can confidently be related to changes in the explanatory variable in the group studied; the possibility of other explanations has been minimised.
