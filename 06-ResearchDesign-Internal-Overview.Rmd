...
Designing studies to maximise internal validity is the focus of Chap.\ \@ref(DesignExperiment) (experimental studies) and Chap.\ \@ref(DesignObservational) (observational studies).
...
* Using $30$ different females once each would tell us a lot about females in general... but we have one measurement from each.
   Since we might expect that the same person might produce similar (not necessarily identical) typing speeds, this is not really a problem.
