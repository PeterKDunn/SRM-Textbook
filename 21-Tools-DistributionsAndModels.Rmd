...
Sampling distributions represent theoretical distributions of sample statistic, not the distribution of sample data.
...
Some quantitative variables have approximate normal distributions too.
...
These properties are true for *all* normal distributions, whatever the quantity, whatever the value of the mean, and whatever the value of the standard deviation.
:::
...
<!-- } -->
Using the $68$--$95$--$99.7$ rule, approximately $68$% of Australian women will be between $162 - 7 = 155$\ cm and $162 + 7 = 169$\ cm tall using this model.
Similarly, aproximately $95$% of Australian women will be between $162 - (2\times 7) = 148$\ cm and $162 + (2\times 7) = 176$\ cm tall using this model.
:::
...
From a picture (Fig.\ \@ref(fig:HtsExer1), left panel), $162 + 7 = 169$\ cm is one standard deviation *above* the mean.
...
* \makebox[19mm]{For $5$ inches:} $\quad  z = (5 - 8.8)/2.7 = -1.41$ (i.e., below the mean).
* \makebox[19mm]{For $11$ inches:} $\quad z = (11 - 8.8)/2.7 = 0.81$ (i.e., above the mean).
...
```{r ZDBH3, fig.cap="What proportion of tree diameters are between $5$\ and $11$\ inches? The two shaded areas are what we find using the tables with $z = -1.41$ and $z = 0.81$; neither give us the area we seek directly.", fig.align="center", fig.width=9.5, fig.height = 2.75,out.width='100%'}
