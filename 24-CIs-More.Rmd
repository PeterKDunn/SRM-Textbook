...
*Confidence intervals (CIs)* tell us about the unknown *population parameter*, based on what we learn from one of the countless possible sample statistics.
:::
...
When CIs, *statistical validity conditions* must be true to ensure the mathematics behind the calculations are sound.
...
That is, if we *repeated* the process (of selecting a sample of $290$\ peanuts and computing the CI for each sample) numerous times, $95$%\ of those CIs formed would contain the value of the parameter.
...
> * There is a $95$%\ chance that our $95$%\ CI straddles the unknown value of the parameter.
