...
2. **Expectation**:
   Based on this assumption, the distribution of the possible values of the sample statistic can be described.
...
Overview[2, ] <- c("Means for one sample",
                    "(ref:CI-OneMean)",
                   "(ref:HT-OneMean)")
Overview[3, ] <- c("Mean differences (for paired data; within-individual comparisons)",
                   "(ref:CI-Paired)",
                   "(ref:HT-Paired)" )
Overview[4, ] <- c("Means for two samples (between-individuals comparisons)",
                   "(ref:CI-TwoMeans)",
                   "(ref:HT-TwoMeans)")
Overview[5, ] <- c("Odds for two samples, comparing ORs (between-individuals comparisons)", 
                   "(ref:CI-OddsR)",
                   "(ref:HT-OddsR)")
