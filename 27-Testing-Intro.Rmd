...
**Scientific hypotheses** refer to the explanations that scientists or engineers are wishing to demonstrate are true; for example, an engineer may expect that replacing sand with glass in the manufacture of concrete produces desirable characteristics [@devaraj2021exploring].\smallskip
...
These refer to the two possible statistical explanations for the difference between the proposed population parameter and the observed sample statistic.\smallskip
...
2. **Expectation**: Based on this assumption, describe the distribution of the possible values of the sample statistic.
3. **Observation**:
